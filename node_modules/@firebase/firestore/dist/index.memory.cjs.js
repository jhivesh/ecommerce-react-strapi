...
var b = /^[_a-zA-Z][_a-zA-Z0-9]*$/, E = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.prototype.$ = function(t, e, r) {
...
var V = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);

/** Extracts the backend's type order for the provided value. */ function L(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? S(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : ve();
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function O(t, e) {
    var n = L(t);
    if (n !== L(e)) return !1;
    switch (n) {
      case 0 /* NullValue */ :
      ...
      case 9 /* ArrayValue */ :
        return Ee(t.arrayValue.values || [], e.arrayValue.values || [], O);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (I(n) !== I(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !O(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function U(t, e) {
    ...
    var n = C(t), r = C(e), i = be(n.seconds, r.seconds);
...
var H = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Ee(this.elements, e.elements, O);
    }, t;
}(), X = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    t.prototype.ut = function(t) {
        ...
        return e instanceof t && O(this.ct, e.ct);
    }, t.prototype.asNumber = function(t) {
        return F(t.integerValue || t.doubleValue);
    }, t;
}();

/** Transforms an array value via a remove operation. */ function K(t) {
...
var ft, lt, pt = function(t, e) {
    ...
    return t.prototype.canonicalId = function() {
        if (null === this.Ot) {
            ...
            t += this.filters.map((function(t) {
                ...
                return t.canonicalId();
            })).join(","), R(this.limit) || (t += "|l:", t += this.limit), this.startAt && (t += "|lb:", 
        ...
        R(this.limit) || (t += ", limit: " + this.limit), this.orderBy.length > 0 && (t += ", orderBy: [" + this.orderBy.join(", ") + "]"), 
    ...
    return t.Wt = function(e) {
        ...
        get: function() {
            if (null === this.Bt) {
                ...
                t.Y() || this.Bt.push(new Tt(t)), this.Bt.push(new Tt(E.X(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.canonicalId = function() {
        ...
        return !R(this.limit) && "F" /* First */ === this.xt;
    }, t.prototype.ae = function() {
        return !R(this.limit) && "L" /* Last */ === this.xt;
    ...
    t.prototype.ee = function() {
        if (!this.Ut) if ("F" /* First */ === this.xt) this.Ut = new mt(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            ...
            // We need to swap the cursors to match the now-flipped query ordering.
                        var o = this.endAt ? new Nt(this.endAt.position, !this.endAt.before) : null, s = this.startAt ? new Nt(this.startAt.position, !this.startAt.before) : null;
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.tt(this.collectionGroup) && this.path.B(e) : _.et(this.path) ? this.path.isEqual(e) : this.path.U(e);
    }, 
    /**
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        if (t.Y()) return "in" /* IN */ === e ? new Et(t, r) : new bt(t, e, r);
        if (z(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new _t(t, r) : "in" /* IN */ === e ? new It(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new At(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && L(this.value) === L(e) && this.fe(M(e, this.value));
        ...
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && O(this.value, t.value);
    }, n.prototype.toString = function() {
    ...
    t.prototype._e = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? _.N(_.Z(o.referenceValue), e.key) : M(o, e.field(i.field)), 
        ...
        for (var e = 0; e < this.position.length; e++) if (!O(this.position[e], t.position[e])) return !1;
        return !0;
    }, t;
}(), Tt = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.de ? _.N(t.key, e.key) : function(t, e, n) {
            var r = e.field(t), i = n.field(t);
            return null !== r && null !== i ? M(r, i) : ve();
        }(this.field, t, e);
        switch (this.dir) {
          case "asc" /* ASCENDING */ :
            return n;
...
var Vt = /** @class */ function() {
    function t(t, e) {
        this.N = t, this.root = e || Ot.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.Re = function(e, n) {
        return new t(this.N, this.root.Re(e, n, this.N).Ae(null, null, Ot.Pe, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.N, this.root.remove(e, this.N).Ae(null, null, Ot.Pe, null, null));
    }, 
    ...
    t.prototype.je = function() {
        if (this.Me() && this.left.Me()) throw ve();
        if (this.right.Me()) throw ve();
        var t = this.left.je();
...
Ot.EMPTY = null, Ot.RED = !0, Ot.Pe = !1, 
// end LLRBEmptyNode
Ot.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var qt = /** @class */ function() {
    function t(t) {
        this.N = t, this.data = new Vt(this.N);
    }
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Ke = function(t) {
        ...
        return new Mt(this.data.be());
    }, t.prototype.ve = function(t) {
        return new Mt(this.data.ve(t));
    }, 
 ...
 */ var Yt = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Xe = jt(), this.Je = new Vt(this.N)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Kt.fs(e, n)), new t(m.min(), r, Wt(), Pt(), zt());
    }, t;
}(), Kt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.Js = function(t) {
        ...
        this.Os.forEach((function(r, i) {
            ...
            if (o) {
                if (r.ds && o.target.Mt()) {
                    ...
                    null !== e.Ms.get(s) || e.Zs(i, s) || e.Qs(i, s, new yt(s, t));
                }
        ...
        var i = new Jt(t, n, this.xs, this.Ms, r);
        return this.Ms = Pt(), this.qs = re(), this.xs = new qt(be), i;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.qs.get(t);
        return e || (e = new qt(be), this.qs = this.qs.Re(t, e)), e;
    }, 
    /**
 ...
 */ var oe = {
    ...
    t.prototype.oi = function(t) {
        var e;
        return R(e = "object" == typeof t ? t.value : t) ? null : e;
    }, 
    /**
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (me(void 0 === t || "string" == typeof t), T.fromBase64String(t || "")) : (me(void 0 === t || t instanceof Uint8Array), 
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ii = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            b.document;
            var E = this.Z(b.document), _ = b.removedTargetIds || [];
            e = new $t([], _, E, null);
        } else {
            ...
            var I = t.filter;
            I.targetId;
            var A = I.count || 0, N = new Dt(A), T = I.targetId;
            e = new Zt(T, N);
        }
        return e;
        ...
        if ("setToServerValue" in t) me("REQUEST_TIME" === t.setToServerValue), e = Y.instance; else if ("appendMissingElements" in t) {
            ...
            e = new X(r);
        } else "increment" in t ? e = new J(this, t.increment) : ve();
        var i = E.J(t.fieldPath);
        return new Z(i, e);
...
function(t, e, n, r, i) {
    ...
    function t() {
        ...
        this.Rn = new qt(De.An), 
        // A set of outstanding references to a document sorted by target id.
        this.Pn = new qt(De.Vn)
    ...
    t.prototype.Sn = function(t) {
        ...
        var e = _.EMPTY, n = new De(e, t), r = new De(e, t + 1), i = zt();
        return this.Pn.Ge([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Fn = function(t) {
        var e = new De(t, 0), n = this.Rn.Ke(e);
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.On && ve(), this.On = !0, this.kn ? this.error ? this.Mn(n, this.error) : this.qn(e, this.result) : new t((function(t, i) {
            r.$n = function(n) {
                r.qn(e, n).next(t, i);
            }, r.Ln = function(e) {
                r.Mn(n, e).next(t, i);
    ...
    t.prototype.er = function(t, e, n) {
        ...
        return this.Hn(t, new _(e)).next((function(t) {
            var e = jt();
        ...
        return this.Gn.rr(t, i).next((function(s) {
            return Se.forEach(s, (function(s) {
...
/** Represents the database ID a Firestore client is associated with. */ Le.wr = -1;
...
var Oe = function() {
    ...
    t.prototype.gr = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && pe("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Pr + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i) {
        this.Sr = t, this.mr = e, this.Cr = n, this.op = r, this.Dr = i, this.Fr = new Oe, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.$r && (this.clearTimeout(), this.Fr.reject(new c(h.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    t.prototype.Zr = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Yr(), this.xr ? [ 3 /*break*/ , 2 ] : (this.xr = !0, (n = he.nt().window) && n.removeEventListener("visibilitychange", this.Gr), 
                    [ 4 /*yield*/ , this.Jr(t) ]);
    ...
    t.prototype.th = function(t) {
                ...
                return e.__awaiter(n, void 0, void 0, (function() {
                    ...
                    return e.__generator(this, (function(e) {
                        switch (e.label) {
                          ...
                          case 1:
                            return e.sent(), r.resolve(), this.jr.reset(), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.Mr.then((function() {
            return e.Qr = !0, t().catch((function(t) {
                ...
                throw e.Ur = t, e.Qr = !1, de("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.Qr = !1, t;
            }));
    ...
    t.prototype.vr = function(t, e, n) {
        ...
        var i = Me.Nr(this, t, e, n, (function(t) {
            return r.eh(t);
        }));
 ...
 */ Pe.fh = -1, Pe.dh = 1048576, Pe.Th = 41943040, Pe.lh = 10, Pe._h = 1e3, Pe.wh = new Pe(Pe.Th, Pe.lh, Pe._h), 
Pe.DISABLED = new Pe(Pe.fh, 0, 0);
...
var Ce = /** @class */ function() {
    ...
    return t.prototype.Ah = function(t, e) {
        return this.Rh.add(e), Se.resolve();
    }, t.prototype.rr = function(t, e) {
        return Se.resolve(this.Rh.getEntries(e));
    }, t;
}(), je = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.M(), n = t.k(), r = this.index[e] || new qt(w.N), i = !r.has(n);
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.gh = m.min(), this.persistence.vh.bh(this.Vh), this.jn = t.Sh(n), this.Ch = t.Dh(), 
        this.Fh = t.Nh(), this.$h = new ke(this.Ch, this.jn, this.persistence.Lh()), this.Ph.kh(this.$h)
    ...
    t.prototype.Oh = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n = this.jn, r = this.$h, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(e) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.jn.Mh(e).next((function(s) {
                            return i = s, n = o.persistence.Sh(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new ke(o.Ch, n, o.persistence.Lh()), n.Mh(e);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = e.sent(), [ 2 /*return*/ , (this.jn = n, this.$h = r, this.Ph.kh(this.$h), 
                    i) ];
                }
            }));
        }));
    ...
    t.prototype.Yh = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.jn.Xh(n, t).next((function(t) {
                return me(null !== t), r = t.keys(), e.jn.Jh(n, t);
            })).next((function() {
                return e.jn.zh(n);
            })).next((function() {
                return e.$h.Jn(n, r);
    ...
    t.oo = function(t, e, n) {
        ...
        return me(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.we.C() - t.we.C() >= this.fo || n.Ts.size + n.ws.size + n.Es.size > 0);
    ...
    t.prototype.do = function(t) {
        ...
        return this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(n) {
            return Se.forEach(t, (function(t) {
                return Se.forEach(t.ur, (function(t) {
    ...
    t.prototype.mo = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Fh.Io(n, t).next((function(i) {
                ...
                r = i, Se.resolve(r)) : e.Fh.Ro(n).next((function(i) {
                    return r = new Rt(t, i, 0 /* Listen */ , n.ho), e.Fh.Ao(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.Io = function(t, e) {
        var n = this.yh.get(e);
        return void 0 !== n ? Se.resolve(this.ph.get(n)) : this.Fh.Io(t, e);
    }, 
    /**
    ...
    t.prototype.Po = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(i) {
            ...
            var o = n.Vh.Sn(t);
            return e ? Se.resolve() : Se.forEach(o, (function(t) {
    ...
    t.prototype.Vo = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.Io(o, t.ee()).next((function(t) {
                ...
                return n.Ph.er(o, t, e ? r : m.min(), e ? i : zt());
            })).next((function(t) {
                return {
                    documents: t,
                    yo: i
    ...
    t.prototype.bo = function(t) {
        ...
        var r = this, i = e.batch, o = i.keys(), s = Se.resolve();
 ...
 */
/** Helper to validate the type of a provided input. */ function $e(t, e, n, r) {
    if (!("object" === e ? Ze(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = tn(r);
...
/** Helper function to assert Base64 functions are available at runtime. */ function hn() {
    if (!he.nt().Co) throw new c(h.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
var cn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ze("Blob.fromBase64String", arguments, 1), Ye("Blob.fromBase64String", "string", 1, e), 
        hn();
        try {
        ...
        return ze("Blob.toBase64", arguments, 0), hn(), this.Do.toBase64();
    }, t.prototype.toUint8Array = function() {
        return ze("Blob.toUint8Array", arguments, 0), an(), this.Do.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    function t() {
        ...
        for (var n = 0; n < t.length; ++n) if (Ye("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new c(h.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.Fo = new E(t);
    }
...
var ln = new RegExp("[~\\*/\\[\\]]"), pn = function(t) {
    ...
    return e.__extends(n, t), n.prototype.Ci = function(t) {
        return new Z(t.path, Y.instance);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this, "FieldValue.arrayUnion") || this).Oo = e, n;
    }
    return e.__extends(n, t), n.prototype.Ci = function(t) {
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this, "FieldValue.arrayRemove") || this).Oo = e, n;
    }
    return e.__extends(n, t), n.prototype.Ci = function(t) {
        // Although array transforms are used with writes, the actual elements
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this, "FieldValue.increment") || this).xo = e, n;
    }
    return e.__extends(n, t), n.prototype.Ci = function(t) {
        t.Mo({
            methodName: this.$o
        });
        var e = Tn(this.xo, t), n = new J(t.serializer, e);
        return new Z(t.path, n);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
    ...
    function t(t, e) {
        if (ze("GeoPoint", arguments, 2), Ye("GeoPoint", "number", 1, t), Ye("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.g = function(t) {
        return be(this.Bo, t.Bo) || be(this.Uo, t.Uo);
    }, t;
}(), bn = /^__.*__$/, En = /** @class */ function() {
    function t(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var An = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (In(this.Lo) && bn.test(t)) throw this.ko('Document fields cannot begin and end with "__"');
    }, t;
}(), Nn = /** @class */ function() {
    function t(t, e) {
        this.ii = t, this.serializer = e || he.nt().zo(t)
        /** Parse document data from a non-merge set() call. */;
    }
    return t.prototype.Yo = function(t, e) {
        var n = this.Xo(0 /* Set */ , t);
        Sn("Data must be an object, but it was:", n, e);
        var r = Rn(e, n);
        return new En(new at(r), 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Jo = function(t, e, n) {
        ...
        Sn("Data must be an object, but it was:", r, e);
        var i, o, s = Rn(e, r);
        if (n) {
            for (var u = [], a = 0, f = n; a < f.length; a++) {
                var l = f[a], p = void 0;
                if (l instanceof fn) p = l.Fo; else {
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.ta = function(t, e, n, r) {
        ...
        var m = new $(a);
        return new _n(f.gt(), m, i.fieldTransforms);
    }, 
    ...
    t.prototype.ea = function(t, e, n) {
        return void 0 === n && (n = !1), Tn(e, this.Xo(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Tn(t, e) {
    if (Dn(t)) return Sn("Unsupported field value:", e, t), Rn(t, e);
    if (t instanceof pn) 
    ...
    return function(t, e) {
        ...
        if (!In(e.Lo)) throw e.ko(t.$o + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.ko("Unsupported field value: " + tn(t));
    }(t, e);
}
 ...
 */ function kn(t, e) {
    if (e instanceof fn) return e.Fo;
    if ("string" == typeof e) return Vn(t, e);
 ...
 */ var On = /** @class */ function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.ma(n) ];
    ...
    t.prototype.Ia = function(t) {
        ...
        return function(n) {
            e.Er.Or((function() {
                return e.oa === t ? n() : (pe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return e.__extends(n, t), n.prototype.Pa = function(t) {
    ...
    return e.__extends(n, t), Object.defineProperty(n.prototype, "Sa", {
        /**
    ...
    n.prototype.start = function() {
        this.va = !1, t.prototype.start.call(this);
        ...
        me(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.va) {
        ...
        // The first response is always the handshake response
                return me(!t.writeResults || 0 === t.writeResults.length), this.va = !0, 
        this.listener.Fa();
    }, 
    /**
...
}(On), Un = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).ra = e, i.credentials = n, i.serializer = r, i;
    }
    /** Gets an auth token and invokes the provided RPC. */    return e.__extends(n, t), 
    n.prototype.La = function(t, e) {
        var n = this;
    ...
    function t(t) {
        ...
        this.Ma = Gt(), this.mutations = [], this.qa = !1, 
        /**
                ...
                switch (i.label) {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , r.ka("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof yt || t instanceof dt ? r.Wa(t) : ve();
                    })), n) ];
                }
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return r.sent(), this.qa = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.set = function(t) {
        ...
        this.za ? (de(e), this.za = !1) : pe("OnlineStateTracker", e);
    ...
    n, r, i, o) {
            ...
            r.Or((function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.au() ? (pe("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.lu = function(t, e, n) {
            var r = ge(t);
            return new qn(e, r.ra, r.credentials, r.serializer, n);
        }(this.Oa, r, {
            ...
            var r = ge(t);
            return new Mn(e, r.ra, r.credentials, r.serializer, n);
        }(this.Oa, r, {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.su.length > 0 && (pe("RemoteStore", "Stopping write stream with " + this.su.length + " pending writes"), 
    ...
    t.prototype.vu = function(t) {
        ...
        this.nu = new ne(this), this.lu.start(), this.cu.Ya();
    }, 
    /**
    ...
    t.prototype.Ru = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (this.cu.set("Online" /* Online */), !(t instanceof te && 2 /* Removed */ === t.state && t.cause)) 
                  ...
                  case 6:
                    if (t instanceof $t ? this.nu.Bs(t) : t instanceof Zt ? this.nu.zs(t) : this.nu.Ws(t), 
                    n.isEqual(m.min())) return [ 3 /*break*/ , 13 ];
                    e.label = 7;

                  case 7:
                    return e.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.eu.so() ];
                  ...
                  case 11:
                    return pe("RemoteStore", "Failed to raise snapshot:", o = e.sent()), [ 4 /*yield*/ , this.Du(o) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    // Disable network and raise offline snapshots
                    return r.sent(), this.cu.set("Offline" /* Offline */), 
                            ...
                            return e.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    ...
                                    return pe("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , this.eu.so() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.iu.has(o) ? [ 4 /*yield*/ , this.Su.Nu(o, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return null !== (n = e.sent()) ? [ 3 /*break*/ , 2 ] : (0 === this.su.length && this.Tu.fa(), 
                    [ 3 /*break*/ , 4 ]);

                  case 2:
                    return this.Lu(n), [ 4 /*yield*/ , this.Pu() ];
    ...
    t.prototype.Lu = function(t) {
        ...
        var n = this, r = this.su.shift(), i = Te.from(r, t, e, this.Tu.lastStreamToken);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(e) {
                ...
                return St(t.code) ? [ 2 /*return*/ , (pe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.Tu.lastStreamToken), 
                this.Tu.lastStreamToken = T.ht, this.eu.eo(T.ht).catch(Ge)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                // logic kick in.
                return St(r = t.code) && r !== h.ABORTED ? (n = this.su.shift(), [ 2 /*return*/ , (this.Tu._a(), 
                this.Su.Uu(n.batchId, t).then((function() {
                    return i.Pu();
                }))) ]) : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Qu = function() {
        return new Pn(this.Oa);
            ...
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    pe("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.uu() ]) : [ 3 /*break*/ , 2 ];
    ...
    function t() {
        this.zu = new jn, this.Yu = {}, this.Su = null, this.Ga = null, this.lr = null;
    }
    return t.prototype.Xu = function(t) {
        ...
        return this.zu = new jn, Promise.resolve();
    ...
    e) {
        ...
        this.ns = zt(), this.cc = new Yt(t.se.bind(t));
    }
    ...
    t.prototype.wc = function(t, e, n) {
        ...
        return this.ac = u, 0 !== o.length || a ? {
            snapshot: new Xt(this.query, t.cc, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Ic: s
        } : {
            Ic: s
    ...
    t.prototype.Ec = function(t) {
        ...
        // updating many documents.
                var e = this.uc;
        this.uc = zt(), this.cc.forEach((function(e) {
            t.Ac(e.key) && (t.uc = t.uc.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.uc.has(e) || n.push(new Bn(e));
    ...
    t.prototype.Vc = function() {
        return Xt.os(this.query, this.cc, this.ns, 0 /* Local */ === this.ac);
    }, t;
}(), Qn = /** @class */ function() {
    function t(t, e, n, r) {
        this.Sr = t, this.pc = e, this.updateFunction = n, this.Fr = r, this.yc = 5, this.jr = new qe(this.Sr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.gc = function() {
        ...
        this.jr.gr((function() {
            return e.__awaiter(t, void 0, void 0, (function() {
                var t, n, r = this;
                return e.__generator(this, (function(e) {
                    return t = this.pc.Qu(), (n = this.vc(t)) && n.then((function(e) {
                        r.Sr.Or((function() {
        ...
        try {
            ...
            return !R(e) && e.catch && e.then ? e : (this.Fr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    n, r, i) {
        ...
        /**
             ...
             */
        this.qc = new Map, this.xc = new Re, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Bc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Uc = new Map, this.Qc = Ce.Ih(), this.onlineState = "Unknown" /* Unknown */;
    }
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 3:
                    r = e.sent(), this.Wc && this.pc.listen(o), e.label = 4;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return i = e.sent(), o = new zn(t, i.yo), s = o._c(i.documents), u = Kt.fs(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.wc(s, 
                    /* updateLimboDocuments= */ this.Wc, u), this.Hc(n, a.Ic), h = new Wn(t, n, o), 
                    [ 2 /*return*/ , (this.Lc.set(t, h), this.kc.has(n) ? this.kc.get(n).push(t) : this.kc.set(n, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.jc("unlisten()"), n = this.Lc.get(t), (r = this.kc.get(n.targetId)).length > 1 ? [ 2 /*return*/ , (this.kc.set(n.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.Lc.delete(t)) ] : this.Wc ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Fc.ec(n.targetId), this.Fc.rc(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.eu.Po(n.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Fc.ic(n.targetId), i.pc.bu(n.targetId), i.Kc(n.targetId);
                    })).catch(Ge) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Kc(n.targetId), [ 4 /*yield*/ , this.eu.Po(n.targetId, 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.eu.Uh(t) ];
                  ...
                  case 4:
                    return this.Fc.Xu(r.batchId), this.zc(r.batchId, n), [ 4 /*yield*/ , this.Yc(r.Wh) ];

                  case 5:
                    return e.sent(), [ 4 /*yield*/ , this.pc.Pu() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.eu.io(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        me(t.Ts.size + t.ws.size + t.Es.size <= 1), t.Ts.size > 0 ? n.Dc = !0 : t.ws.size > 0 ? me(n.Dc) : t.Es.size > 0 && (me(n.Dc), 
                        n.Dc = !1));
                    })), [ 4 /*yield*/ , this.Yc(n, t) ];
    ...
    t.prototype.Rc = function(t, e) {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Fc.tc(t, "rejected", n), r = this.qc.get(t), (i = r && r.key) ? (
                    // Since this query failed, we won't want to manually unlisten to it.
                    // So go ahead and remove it from bookkeeping.
                    this.Mc = this.Mc.remove(i), this.qc.delete(t), this.Jc(), o = (o = new Vt(_.N)).Re(i, new yt(i, m.min())), 
                    s = zt().add(i), u = new Jt(m.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new qt(be), o, s), [ 2 /*return*/ , this.io(u) ]) : [ 4 /*yield*/ , this.eu.Po(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.Kc(t, n);
                    })).catch(Ge) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.jc("applySuccessfulWrite()"), n = t.batch.batchId, 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught
                    // up), so we raise user callbacks first so that they consistently happen
                    // before listen events.
                    this.Zc(n, /*error=*/ null), this.tl(n), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.eu.jh(t) ];

                  case 2:
                    return r = e.sent(), this.Fc.Ju(n, "acknowledged"), [ 4 /*yield*/ , this.Yc(r) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // listen events.
                    this.Zc(t, n), this.tl(t), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.eu.Yh(t) ];

                  case 2:
                    return r = e.sent(), this.Fc.Ju(t, "rejected", n), [ 4 /*yield*/ , this.Yc(r) ];
    ...
    t.prototype.el = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.pc.au() || pe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    [ 4 /*yield*/ , this.eu.Zh() ];

                  case 1:
                    return -1 === (n = e.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Uc.get(n) || []).push(t), 
                    this.Uc.set(n, r), [ 2 /*return*/ ]);
                }
            }));
        }));
    }, 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.sl = function(t) {
        ...
        n || (n = new Vt(be)), n = n.Re(t, e), this.Bc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Zc = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Gn ? (this.xc.pn(i.key, t), this.rl(i)) : i instanceof Bn ? (pe("SyncEngine", "Document no longer in limbo: " + i.key), 
    ...
    t.prototype.Jc = function() {
        for (;this.Oc.length > 0 && this.Mc.size < this.Nc; ) {
            ...
            this.qc.set(e, new Yn(t)), this.Mc = this.Mc.Re(t, e), this.pc.listen(new Rt(gt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Le.wr));
        }
    }, 
    // Visible for testing
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = [], i = [], o = [], this.Lc.forEach((function(e, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var e = n && n.as.get(u.targetId), o = u.view.wc(t, 
                            ...
                            if (s.Hc(u.targetId, o.Ic), o.snapshot) {
                                ...
                                var a = Ve.cr(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return e.sent(), this.$c.ya(r), [ 4 /*yield*/ , this.eu.do(i) ];
    ...
    function t(t) {
        this.Su = t, this.cl = new Ae((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.cl.get(n)) || (r = !0, i = new Xn), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Rc = function(t) {
        ...
        t = Xt.os(t.query, t.docs, t.ns, t.fromCache), this.El = !0, this.wl.next(t);
    }, t;
}(), $n = /** @class */ function() {
    function t() {}
    return t.prototype.kh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(m.min()) ? this.pl(t, e) : this.Vl.Jn(t, i).next((function(s) {
            var u = o.yl(e, s);
            return (e.oe() || e.ae()) && o.Tc(e.xt, u, i, n) ? o.pl(t, e) : (fe() <= r.LogLevel.DEBUG && pe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            o.Vl.er(t, e, n).next((function(t) {
    ...
    function t(t, e) {
        ...
        /** The last received stream token from the server, used to acknowledge which
             ...
             * markers whose only real value is their inclusion in the next request.
             */
        this.lastStreamToken = T.ht, 
        /** An ordered mapping between documents and the mutations batch IDs. */
        this.bl = new qt(De.An);
    }
    return t.prototype.vl = function(t) {
        return Se.resolve(0 === this.jn.length);
    }, t.prototype.jh = function(t, e, n) {
        var r = e.batchId, i = this.Sl(r, "acknowledged");
        return me(0 === i), 
        // Verify that the batch in the queue is the one to be acknowledged.
        this.jn[i], this.lastStreamToken = n, Se.resolve();
    }, t.prototype.to = function(t) {
        return Se.resolve(this.lastStreamToken);
    }, t.prototype.eo = function(t, e) {
        return this.lastStreamToken = e, Se.resolve();
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.bl = this.bl.add(new De(a.key, i)), this.Gn.Ah(t, a.key.path.k());
        }
        return Se.resolve(o);
    }, t.prototype.Xh = function(t, e) {
        return Se.resolve(this.Cl(e));
    }, t.prototype.wo = function(t, e) {
        var n = e + 1, r = this.Dl(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Se.resolve(this.jn.length > i ? this.jn[i] : null);
    }, t.prototype.Zh = function() {
        return Se.resolve(0 === this.jn.length ? -1 : this.gl - 1);
    }, t.prototype.Mh = function(t) {
        return Se.resolve(this.jn.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                _.et(i) || (i = i.child(""));
        var o = new De(new _(i), 0), s = new qt(be);
        ...
        var n = this;
        me(0 === this.Sl(e.batchId, "removed")), this.jn.shift();
        var r = this.bl;
        return Se.forEach(e.mutations, (function(i) {
        ...
        var n = new De(e, 0), r = this.bl.Ke(n);
        return Se.resolve(e.isEqual(r && r.key));
    }, t.prototype.zh = function(t) {
        return this.jn.length, Se.resolve();
    }, 
    /**
    ...
    t.prototype.uo = function(t) {
        ...
        return Se.forEach(this.docs, (function(t) {
            return e(t);
        }));
 ...
 */
tr.Ml = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).jl = e, n;
    }
    return e.__extends(n, t), n.prototype.wc = function(t) {
        var e = this, n = [];
    ...
    t.prototype.Yn = function(t, e) {
        this.Ul();
        var n = this.Wh.get(e);
        return void 0 !== n ? Se.resolve(n) : this.Ql(t, e);
    }, 
    /**
...
var er = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Kl = new Re, this.targetCount = 0, this.zl = Ce.mh();
    }
    return t.prototype.js = function(t, e) {
        ...
        return Se.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.Yl = function(t) {
        return Se.resolve(this.Hl);
    }, t.prototype.Ro = function(t) {
        return this.highestTargetId = this.zl.next(), Se.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.zl = new Ce(e), this.highestTargetId = e), t.sequenceNumber > this.Hl && (this.Hl = t.sequenceNumber);
    }, t.prototype.Ao = function(t, e) {
        return this.Xl(e), this.targetCount += 1, Se.resolve();
    }, t.prototype.ao = function(t, e) {
        return this.Xl(e), Se.resolve();
        ...
        return this.Gl.forEach((function(s, u) {
            ...
            i++);
        })), Se.Un(o).next((function() {
            return i;
        }));
    }, t.prototype.e_ = function(t) {
        return Se.resolve(this.targetCount);
    }, t.prototype.Io = function(t, e) {
        ...
        return this.Kl.Sn(e), Se.resolve();
    }, t.prototype.po = function(t, e) {
        var n = this.Kl.Dn(e);
        return Se.resolve(n);
    }, t.prototype.Fn = function(t, e) {
        return Se.resolve(this.Kl.Fn(e));
    }, t;
}(), nr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.s_ = {}, this.i_ = new Le(0), this.n_ = !1, this.n_ = !0, this.vh = t(this), 
        this.Fh = new er(this), this.Gn = new Fe, this.Wn = new tr(this.Gn, (function(t) {
            return e.vh.r_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.s_[t.s()];
        return e || (e = new Zn(this.Gn, this.vh), this.s_[t.s()] = e), e;
        ...
        return Se.Qn(Object.values(this.s_).map((function(n) {
            return function() {
                return n.Fn(t, e);
            };
        })));
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).ho = e, n;
    }
    /**
    ...
    return t.w_ = function(e) {
        ...
        return this.E_.delete(e), Se.resolve();
    }, t.prototype.gn = function(t, e) {
        return this.E_.add(e), Se.resolve();
        ...
        // Remove newly orphaned documents.
                return Se.forEach(this.E_, (function(r) {
    ...
    return t.prototype.initialize = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.sent(), this.A_ = this.P_(t), this.eu = this.V_(t), this.pc = this.p_(t), 
                    this.Su = this.y_(t), this.g_ = this.b_(t), this.Fc.Ga = function(t) {
                        return n.Su.Rc(t, 1 /* SharedClientState */);
                  ...
                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.pc.start() ];

                  case 4:
                    return e.sent(), [ 4 /*yield*/ , this.pc.ju(this.Su.Wc) ];
        ...
        return new Jn(this.Su);
    }, t.prototype.P_ = function(t) {
        return null;
    }, t.prototype.V_ = function(t) {
        return new xe(this.persistence, new $n, t.v_);
    }, t.prototype.R_ = function(t) {
        return new nr(ir.w_);
    }, t.prototype.p_ = function(t) {
        var e = this;
        return new Fn(this.eu, t.Oa, t.Sr, (function(t) {
            return e.Su.Rc(t, 0 /* RemoteStore */);
        }), t.platform.S_());
    }, t.prototype.I_ = function(t) {
        return new xn;
    }, t.prototype.y_ = function(t) {
        return new Hn(this.eu, this.pc, this.Fc, t.v_, t.Nc);
     ...
     */
    r) {
        this.platform = t, this.C_ = e, this.credentials = n, this.Sr = r, this.clientId = we.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials._((function(s) {
            if (!o) return o = !0, pe("FirestoreClient", "Initializing. user=", s.uid), n.F_(t, e, s, i).then(r.resolve, r.reject);
            n.Sr.Or((function() {
                return n.Wu(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.F_ = function(t, n, r, i) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var o, s, u, a, h = this;
            return e.__generator(this, (function(c) {
                switch (c.label) {
                  case 0:
                    return c.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.N_(this.C_) ];

                  case 1:
                    return o = c.sent(), s = this.platform.zo(this.C_.ii), u = function(t, e, n) {
                        return new Un(t, e, n);
    ...
    t.prototype.D_ = function() {
        if (this.Sr.Kr) throw new c(h.FAILED_PRECONDITION, "The client has already been terminated.");
            ...
            return e.__awaiter(n, void 0, void 0, (function() {
                ...
                return e.__generator(this, (function(e) {
                    switch (e.label) {
                      ...
                      case 1:
                        return n = e.sent(), r = new zn(t, n.yo), i = r._c(n.documents), [ 2 /*return*/ , r.wc(i, 
...
var hr = /** @class */ function() {
    ...
    return t.prototype.j_ = function(t) {
        ...
        return new wn(F(t.latitude), F(t.longitude));
    }, t.prototype.Y_ = function(t) {
        var e = this;
        ...
        var e = w.G(t);
        me(ae(e));
        var n = new Ie(e.get(1), e.get(3)), r = new _(e.L(5));
        return n.isEqual(this.firestore.sa) || 
        // TODO(b/64130202): Somehow support foreign references.
        de("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.firestore.sa.projectId + "/" + this.firestore.sa.database + ") instead."), 
        new yr(r, this.firestore, this.converter);
    }, t;
}(), cr = Pe.fh, fr = /** @class */ function() {
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new c(h.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Xe("settings", "non-empty string", "host", t.host), this.host = t.host, Je("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (nn("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling" ]), 
        Je("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        Je("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), 
        ...
        Je("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Pe.Th; else {
            if (t.cacheSizeBytes !== cr && t.cacheSizeBytes < Pe.dh) throw new c(h.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Pe.dh);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        Je("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(n, r, i) {
        var o = this;
        if (void 0 === i && (i = new or), this.J_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Z_ = new Ue, this.INTERNAL = {
            delete: function() {
            ...
            var s = n;
            this.J_ = s, this.sa = t.sf(s), this.if = s.name, this.nf = new p(r);
        } else {
            var u = n;
            if (!u.projectId) throw new c(h.INVALID_ARGUMENT, "Must provide projectId");
            this.sa = new Ie(u.projectId, u.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.if = "[DEFAULT]", this.nf = new l;
        }
        this.rf = i, this.hf = new fr({}), this.af = new Nn(this.sa);
    }
    return t.prototype.settings = function(t) {
        ze("Firestore.settings", arguments, 1), Ye("Firestore.settings", "object", 1, t);
        var e = new fr(t);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                ...
                return t = new Oe, [ 2 /*return*/ , (this.Z_.zr((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n, r;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return e.trys.push([ 0, 2, , 3 ]), n = this.lf(), [ 4 /*yield*/ , this.rf.clearPersistence(n) ];
        ...
        if (this.tf(), ar(t)) return this.ff(t);
        Ye("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return this.ff(e);
        ...
        return new _e(this.sa, this.if, this.hf.host, this.hf.ssl, this.hf.forceLongPolling);
    }, t.prototype.cf = function(t, e) {
        var n = this.lf();
        return this.ef = new sr(he.nt(), n, this.nf, this.Z_), this.ef.start(t, e);
    }, t.sf = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new c(h.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return ze("Firestore.collection", arguments, 1), Ye("Firestore.collection", "non-empty string", 1, t), 
        this.tf(), new Er(w.G(t), this);
    }, t.prototype.doc = function(t) {
        return ze("Firestore.doc", arguments, 1), Ye("Firestore.doc", "non-empty string", 1, t), 
        this.tf(), yr.df(w.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (ze("Firestore.collectionGroup", arguments, 1), Ye("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.tf(), new wr(new gt(w.H, t), this);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return ze("Firestore.runTransaction", arguments, 1), Ye("Firestore.runTransaction", "function", 1, t), 
        this.tf().transaction((function(n) {
            return t(new pr(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.tf(), new dr(this);
        ...
        switch (ze("Firestore.setLogLevel", arguments, 1), Ye("Firestore.setLogLevel", "non-empty string", 1, t), 
        t) {
          case "debug":
            le(r.LogLevel.DEBUG);
            break;
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Nr("Transaction.get", t, this.wf);
        return this.Ef.Ua([ n.ia ]).then((function(t) {
            if (!t || 1 !== t.length) return ve();
            var r = t[0];
            if (r instanceof yt) return new mr(e.wf, n.ia, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.mf);
            if (r instanceof dt) return new mr(e.wf, n.ia, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.mf);
            throw ve();
        }));
        ...
        var r = Nr("Transaction.set", t, this.wf);
        n = _r("Transaction.set", n);
        var i = Rr(r.mf, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.wf.af.Jo(s, o, n.mergeFields) : this.wf.af.Yo(s, o);
        ...
        r = Nr("Transaction.update", t, this.wf), i = this.wf.af.ta("Transaction.update", e, n, o)) : (ze("Transaction.update", arguments, 2), 
        r = Nr("Transaction.update", t, this.wf), i = this.wf.af.Zo("Transaction.update", e)), 
        this.Ef.update(r.ia, i), this;
    }, t.prototype.delete = function(t) {
        ze("Transaction.delete", arguments, 1);
        var e = Nr("Transaction.delete", t, this.wf);
    ...
    return t.prototype.set = function(t, e, n) {
        We("WriteBatch.set", arguments, 2, 3), this.Af();
        var r = Nr("WriteBatch.set", t, this.wf);
        n = _r("WriteBatch.set", n);
        var i = Rr(r.mf, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.wf.af.Jo(s, o, n.mergeFields) : this.wf.af.Yo(s, o);
        return this.If = this.If.concat(u.Qo(r.ia, et.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Af(), "string" == typeof e || e instanceof fn ? (Qe("WriteBatch.update", arguments, 3), 
        r = Nr("WriteBatch.update", t, this.wf), i = this.wf.af.ta("WriteBatch.update", e, n, o)) : (ze("WriteBatch.update", arguments, 2), 
        r = Nr("WriteBatch.update", t, this.wf), i = this.wf.af.Zo("WriteBatch.update", e)), 
        this.If = this.If.concat(i.Qo(r.ia, et.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        ze("WriteBatch.delete", arguments, 1), this.Af();
        var e = Nr("WriteBatch.delete", t, this.wf);
        return this.If = this.If.concat(new st(e.ia, et.dt())), this;
    }, t.prototype.commit = function() {
        return this.Af(), this.Rf = !0, this.If.length > 0 ? this.wf.tf().write(this.If) : Promise.resolve();
    }, t.prototype.Af = function() {
        if (this.Rf) throw new c(h.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), yr = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.df = function(e, n, r) {
        ...
        get: function() {
            return new Er(this.ia.path.k(), this.firestore, this.mf);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (ze("DocumentReference.collection", arguments, 1), Ye("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new c(h.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = w.G(t);
        return new Er(this.ia.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        ...
        We("DocumentReference.set", arguments, 1, 2), e = _r("DocumentReference.set", e);
        var n = Rr(this.mf, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.af.Jo(i, r, e.mergeFields) : this.firestore.af.Yo(i, r);
        return this.ef.write(o.Qo(this.ia, et.dt()));
    }, t.prototype.update = function(t, e) {
        ...
        n = this.firestore.af.Zo("DocumentReference.update", t)), this.ef.write(n.Qo(this.ia, et.exists(!0)));
    }, t.prototype.delete = function() {
        return ze("DocumentReference.delete", arguments, 0), this.ef.write([ new st(this.ia, et.dt()) ]);
        ...
        Je("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return ar(t[i]) ? n = t[i] : (Ye("DocumentReference.onSnapshot", "function", i, t[i]), 
        ...
        var i = new ur({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new mr(n.firestore, n.ia, r, t.fromCache, t.hasPendingWrites, n.mf));
                }
            },
            error: r
        }), o = this.ef.listen(gt.Wt(this.ia.path), i, t);
        return function() {
            i.Q_(), n.ef.bu(o);
        };
    }, t.prototype.get = function(t) {
        ...
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().x_(e.ia).then((function(t) {
                n(new mr(e.firestore, e.ia, t, 
                /*fromCache=*/ !0, t instanceof dt && t.At, e.mf));
            }), r) : e.Vf(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        if (We("DocumentSnapshot.data", arguments, 0, 1), t = Ir("DocumentSnapshot.data", t), 
        this.pf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.mf) {
                var e = new gr(this.wf, this.ia, this.pf, this.yf, this.gf);
                return this.mf.fromFirestore(e, t);
            }
            return new hr(this.wf, this.wf.Tf(), t.serverTimestamps, 
            /* converter= */ void 0).j_(this.pf.kt());
        }
    }, t.prototype.get = function(t, e) {
        if (We("DocumentSnapshot.get", arguments, 1, 2), e = Ir("DocumentSnapshot.get", e), 
        this.pf) {
            var n = this.pf.data().field(kn("DocumentSnapshot.get", t));
            if (null !== n) return new hr(this.wf, this.wf.Tf(), e.serverTimestamps, this.mf).j_(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.ia.path.M();
        ...
        get: function() {
            return new yr(this.ia, this.wf, this.mf);
        },
        enumerable: !0,
        configurable: !0
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        return this.Cf(p), new t(this.bf.Ht(p), this.firestore, this.mf);
        ...
        if (null !== this.bf.startAt) throw new c(h.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.bf.endAt) throw new c(h.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = kn("Query.orderBy", e), o = new Tt(i, r);
        return this.Df(o), new t(this.bf.Kt(o), this.firestore, this.mf);
    }, t.prototype.limit = function(e) {
        return ze("Query.limit", arguments, 1), Ye("Query.limit", "number", 1, e), on("Query.limit", 1, e), 
        new t(this.bf.zt(e), this.firestore, this.mf);
    }, t.prototype.limitToLast = function(e) {
        return ze("Query.limitToLast", arguments, 1), Ye("Query.limitToLast", "number", 1, e), 
        on("Query.limitToLast", 1, e), new t(this.bf.Yt(e), this.firestore, this.mf);
    ...
    t.prototype.Nf = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.bf.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(x(this.firestore.sa, t.key)); else {
    ...
    t.prototype.$f = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.bf.le() && -1 !== s.indexOf("/")) throw new c(h.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.bf.path.child(w.G(s));
                ...
                var a = new _(u);
                i.push(x(this.firestore.sa, a));
            } else {
                var f = this.firestore.af.ea(t, s);
                i.push(f);
            }
        }
        return new Nt(i, n);
        ...
        Je("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), ar(t[i]) ? n = t[i] : (Ye("Query.onSnapshot", "function", i, t[i]), He("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        ...
        var i = new ur({
            next: function(t) {
                e.next && e.next(new br(n.firestore, n.bf, t, n.mf));
            },
            error: r
        ...
        if (t.ae() && 0 === t.qt.length) throw new c(h.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        return We("Query.get", arguments, 0, 1), Ar("Query.get", t), this.Lf(this.bf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().B_(e.bf).then((function(t) {
                n(new br(e.firestore, e.bf, t, e.mf));
            }), r) : e.Vf(n, r, t);
        }));
    }, t.prototype.Vf = function(t, e, n) {
        var r = this.Pf({
    ...
    t.prototype.Sf = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.bf.le() && -1 !== t.indexOf("/")) throw new c(h.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.bf.path.child(w.G(t));
            ...
            return x(this.firestore.sa, new _(e));
        }
        if (t instanceof yr) {
            var n = t;
            return x(this.firestore.sa, n.ia);
        }
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        We("QuerySnapshot.forEach", arguments, 1, 2), Ye("QuerySnapshot.forEach", "function", 1, t), 
        this.Mf.docs.forEach((function(r) {
            t.call(e, n.Bf(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new wr(this.Of, this.wf, this.mf);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (nn("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Je("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.Mf.hs) throw new c(h.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new gr(this.wf, t.key, t, this.metadata.fromCache, this.Mf.ns.has(t.key), this.mf);
    }, t;
}(), Er = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        if ((i = t.call(this, gt.Wt(e), n, r) || this).Uf = e, e.length % 2 != 1) throw new c(h.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + e.j() + " has " + e.length);
        return i;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.q() ? null : new yr(new _(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = we.cn()), Ye("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new c(h.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = w.G(t);
        return yr.df(this.bf.path.child(e), this.firestore, this.mf);
    }, n.prototype.add = function(t) {
        ze("CollectionReference.add", arguments, 1), Ye("CollectionReference.add", "object", 1, this.mf ? this.mf.toFirestore(t) : t);
        var e = this.doc();
...
function _r(t, e) {
    ...
    if (nn(t, e, [ "merge", "mergeFields" ]), Je(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
...
function Ir(t, e) {
    return void 0 === e ? {} : (nn(t, e, [ "serverTimestamps" ]), Ke(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Ar(t, e) {
    He(t, "object", 1, e), e && (nn(t, e, [ "source" ]), Ke(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var Sr = Dr(lr, "Use firebase.firestore() instead."), kr = Dr(pr, "Use firebase.firestore().runTransaction() instead."), Vr = Dr(dr, "Use firebase.firestore().batch() instead."), Lr = Dr(yr, "Use firebase.firestore().doc() instead."), Or = Dr(mr), qr = Dr(gr), Mr = Dr(wr), Ur = Dr(br), Pr = Dr(Er, "Use firebase.firestore().collection() instead."), Cr = Dr(/** @class */ function() {
    function t() {}
    return t.delete = function() {
        ...
        return Ye("FieldValue.increment", "number", 1, t), ze("FieldValue.increment", arguments, 1), 
        new gn(t);
    }, t.prototype.isEqual = function(t) {
        return this === t;
    }, t;
}(), "Use FieldValue.<field>() instead."), Fr = Dr(cn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), jr = {
    Firestore: Sr,
    GeoPoint: wn,
    Timestamp: v,
    Blob: Fr,
     ...
     */    return t.prototype.hd = function(t, e) {
        ...
        var n = [ this.rd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = s.createWebChannelTransport(), o = {
        ...
        this.hd(o.initMessageHeaders, e), 
        ...
        return d(s.WebChannel.EventType.OPEN, (function() {
            ...
            l || (l = !0, pe("Connection", "WebChannel transport closed"), p.sd());
        })), d(s.WebChannel.EventType.ERROR, (function(t) {
            l || (l = !0, pe("Connection", "WebChannel transport errored:", t), p.sd(new c(h.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!l) {
                ...
                if (i) {
                    ...
                    l = !0, p.sd(new c(s, u)), a.close();
                } else pe("Connection", "WebChannel received:", n), p.nd(n);
            }
        })), setTimeout((function() {
...
}())), Yr(n), exports.__PRIVATE_registerFirestore = Yr;
