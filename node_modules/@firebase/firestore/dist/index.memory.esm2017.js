 ...
 */ class yt {
    ...
    constructor(t, e = null, s = [], i = [], n = null, r = "F" /* First */ , h = null, o = null) {
        this.path = t, this.collectionGroup = e, this.qt = s, this.filters = i, this.limit = n, 
    ...
    get orderBy() {
        if (null === this.Bt) {
            ...
            t.Y() || this.Bt.push(new Nt(t)), this.Bt.push(new Nt(S.X(), "asc" /* ASCENDING */)); else {
                let t = !1;
                for (const e of this.qt) this.Bt.push(e), e.field.Y() && (t = !0);
                if (!t) {
                    // The order of the implicit key ordering always matches the last
                    // explicit order by
                    const t = this.qt.length > 0 ? this.qt[this.qt.length - 1].dir : "asc" /* ASCENDING */;
    ...
    Ht(t) {
        ...
        return new yt(this.path, this.collectionGroup, this.qt.slice(), e, this.limit, this.xt, this.startAt, this.endAt);
    }
    Kt(t) {
        // TODO(dimond): validate that orderBy does not list the same key twice.
        const e = this.qt.concat([ t ]);
        return new yt(this.path, this.collectionGroup, e, this.filters.slice(), this.limit, this.xt, this.startAt, this.endAt);
    }
    zt(t) {
        return new yt(this.path, this.collectionGroup, this.qt.slice(), this.filters.slice(), t, "F" /* First */ , this.startAt, this.endAt);
    }
    Yt(t) {
        return new yt(this.path, this.collectionGroup, this.qt.slice(), this.filters.slice(), t, "L" /* Last */ , this.startAt, this.endAt);
    }
    Xt(t) {
        return new yt(this.path, this.collectionGroup, this.qt.slice(), this.filters.slice(), this.limit, this.xt, t, this.endAt);
    }
    Jt(t) {
        return new yt(this.path, this.collectionGroup, this.qt.slice(), this.filters.slice(), this.limit, this.xt, this.startAt, t);
    }
    /**
...
class Ut {
    ...
    Oe() {
        if (this.left.q()) return Ut.EMPTY;
        let t = this;
        return t.left.Me() || t.left.left.Me() || (t = t.qe()), t = t.Ae(null, null, null, t.left.Oe(), null), 
        t.ke();
    }
    // Returns new tree, with the specified item removed.
    remove(t, e) {
        let s, i = this;
        if (e(t, i.key) < 0) i.left.q() || i.left.Me() || i.left.left.Me() || (i = i.qe()), 
        i = i.Ae(null, null, null, i.left.remove(t, e), null); else {
            if (i.left.Me() && (i = i.xe()), i.right.q() || i.right.Me() || i.right.left.Me() || (i = i.Be()), 
            0 === e(t, i.key)) {
                if (i.right.q()) return Ut.EMPTY;
    ...
    qe() {
        let t = this.Qe();
        return t.right.left.Me() && (t = t.Ae(null, null, null, null, t.right.xe()), t = t.Ue(), 
        t = t.Qe()), t;
    }
    Be() {
        let t = this.Qe();
        return t.left.left.Me() && (t = t.xe(), t = t.Qe()), t;
    }
    Ue() {
    ...
    je() {
        if (this.Me() && this.left.Me()) throw ye();
        if (this.right.Me()) throw ye();
...
class le {
     ...
     */    Js(t) {
        ...
        this.Os.forEach((s, i) => {
            ...
            if (n) {
                if (s.ds && n.target.Mt()) {
                    ...
                    null !== this.Ms.get(e) || this.Zs(i, e) || this.Qs(i, e, new Pt(e, t));
                }
        ...
        const i = new re(t, e, this.xs, this.Ms, s);
        return this.Ms = Gt(), this.qs = _e(), this.xs = new Qt(Se), i;
    }
    /**
    ...
    Us(t, e) {
        ...
        this.Gs(t).Ds(e.key, s), this.Ms = this.Ms.Re(e.key, e), this.qs = this.qs.Re(e.key, this.ti(e.key).add(t));
    }
    /**
    ...
    Qs(t, e, s) {
        ...
        i.Fs(e), this.qs = this.qs.Re(e, this.ti(e).delete(t)), s && (this.Ms = this.Ms.Re(e, s));
    }
    removeTarget(t) {
        this.Os.delete(t);
    }
    ...
    ti(t) {
        let e = this.qs.get(t);
        return e || (e = new Qt(Se), this.qs = this.qs.Re(t, e)), e;
    }
    /**
...
class we {
    ...
    ni(t) {
        const e = void 0 === t.code ? E.UNKNOWN : qt(t.code);
 ...
 */ class ke {
    constructor() {
        ...
        this.Rn = new Qt(Oe.An), 
        // A set of outstanding references to a document sorted by target id.
        this.Pn = new Qt(Oe.Vn);
    }
    /** Returns true if the reference set contains no references. */    q() {
        return this.Rn.q();
    }
    /** Adds a reference to the given document key for the given ID. */    pn(t, e) {
        const s = new Oe(t, e);
        this.Rn = this.Rn.add(s), this.Pn = this.Pn.add(s);
    }
    /** Add references to the given document keys for the given ID. */    yn(t, e) {
        t.forEach(t => this.pn(t, e));
    }
    /**
     ...
     * removed.
     */    Sn(t) {
        const e = C.EMPTY, s = new Oe(e, t), i = new Oe(e, t + 1), n = [];
        return this.Pn.Ge([ s, i ], t => {
            this.bn(t), n.push(t.key);
        }), n;
    }
    Cn() {
        this.Rn.forEach(t => this.bn(t));
    }
    bn(t) {
        this.Rn = this.Rn.delete(t), this.Pn = this.Pn.delete(t);
    }
    Dn(t) {
        const e = C.EMPTY, s = new Oe(e, t), i = new Oe(e, t + 1);
        let n = Zt();
        return this.Pn.Ge([ s, i ], t => {
            n = n.add(t.key);
        }), n;
    ...
    Fn(t) {
        const e = new Oe(t, 0), s = this.Rn.Ke(e);
...
class Oe {
    ...
    /** Compare by key then by ID */    static An(t, e) {
        return C.N(t.key, e.key) || Se(t.Nn, e.Nn);
    }
    /** Compare by ID then by key */    static Vn(t, e) {
        return Se(t.Nn, e.Nn) || C.N(t.key, e.key);
    }
}
 ...
 */ class Me {
    constructor(t) {
        ...
        // chaining.
        this.On = !1, t(t => {
            this.kn = !0, this.result = t, this.$n && 
            // value should be defined unless T is Void, but we can't express
            // that in the type system.
            this.$n(t);
        }, t => {
            this.kn = !0, this.error = t, this.Ln && this.Ln(t);
        });
    }
    catch(t) {
    ...
    next(t, e) {
        return this.On && ye(), this.On = !0, this.kn ? this.error ? this.Mn(e, this.error) : this.qn(t, this.result) : new Me((s, i) => {
            this.$n = e => {
                this.qn(t, e).next(s, i);
            }, this.Ln = t => {
                this.Mn(e, t).next(s, i);
            };
        });
    }
    xn() {
    ...
    Bn(t) {
        try {
            const e = t();
            return e instanceof Me ? e : Me.resolve(e);
        } catch (t) {
            return Me.reject(t);
        }
    }
    qn(t, e) {
        return t ? this.Bn(() => t(e)) : Me.resolve(e);
    }
    Mn(t, e) {
        return t ? this.Bn(() => t(e)) : Me.reject(e);
    }
    static resolve(t) {
        return new Me((e, s) => {
            e(t);
     ...
     */    static Qn(t) {
        let e = Me.resolve(!1);
        for (const s of t) e = e.next(t => t ? Me.resolve(t) : s());
        return e;
    }
    static forEach(t, e) {
        const s = [];
...
class qe {
     ...
     * state for it.
     */    Hn(t, e) {
        return this.jn.Kn(t, e).next(s => this.zn(t, e, s));
    }
    /** Internal version of `getDocument` that allows reusing batches. */    zn(t, e, s) {
        return this.Wn.Yn(t, e).next(t => {
     ...
     */    Jn(t, e) {
        return this.Wn.getEntries(t, e).next(e => this.Zn(t, e));
    }
    /**
     * Similar to `getDocuments`, but creates the local view from the given
     * `baseDocs` without retrieving documents from the local store.
     */    Zn(t, e) {
        return this.jn.tr(t, e).next(s => {
            const i = this.Xn(t, e, s);
            let n = Gt();
     ...
     */    er(t, e, s) {
        return e.Mt() ? this.sr(t, e.path) : e.le() ? this.ir(t, e, s) : this.nr(t, e, s);
    }
    sr(t, e) {
        // Just do a simple document lookup.
        return this.Hn(t, new C(e)).next(t => {
            let e = zt();
    ...
    ir(t, e, s) {
        ...
        let n = zt();
        return this.Gn.rr(t, i).next(r => Me.forEach(r, r => {
            const h = e.Zt(r.child(i));
            return this.nr(t, h, s).next(t => {
                t.forEach((t, e) => {
                    n = n.Re(t, e);
                });
            });
    ...
    nr(t, e, s) {
        ...
        let i, n;
        return this.Wn.er(t, e, s).next(s => (i = s, this.jn.hr(t, e))).next(e => (n = e, 
        this.or(t, n, i).next(t => {
            i = t;
    ...
    or(t, e, s) {
        ...
        let n = s;
        return this.Wn.getEntries(t, i).next(t => (t.forEach((t, e) => {
 ...
 */ class xe {
    constructor(t, e, s, i) {
        this.targetId = t, this.fromCache = e, this.ar = s, this.ur = i;
    }
    static cr(t, e) {
        let s = Zt(), i = Zt();
 ...
 */ class Be {
    constructor(t, e) {
        this.previousValue = t, e && (e.lr = t => this._r(t), this.dr = t => e.Tr(t));
    }
    _r(t) {
...
class Qe {
     ...
     */ , n = 6e4) {
        this.Er = t, this.mr = e, this.Ir = s, this.Rr = i, this.Ar = n, this.Pr = 0, this.Vr = null, 
     ...
     */    gr(t) {
        ...
        // honored as such).
        const e = Math.floor(this.Pr + this.br()), s = Math.max(0, Date.now() - this.pr), i = Math.max(0, e - s);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && Pe("ExponentialBackoff", `Backing off for ${i} ms ` + `(base delay: ${this.Pr} ms, ` + `delay with jitter: ${e} ms, ` + `last attempt: ${s} ms ago)`), 
        this.Vr = this.Er.vr(this.mr, i, () => (this.pr = Date.now(), t())), 
    ...
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */    br() {
...
class We {
    constructor(t, e, s, i, n) {
        this.Sr = t, this.mr = e, this.Cr = s, this.op = i, this.Dr = n, this.Fr = new Ue, 
     ...
     */    cancel(t) {
        null !== this.$r && (this.clearTimeout(), this.Fr.reject(new m(E.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Lr() {
        this.Sr.Or(() => null !== this.$r ? (this.clearTimeout(), this.op().then(t => this.Fr.resolve(t))) : Promise.resolve());
    }
    clearTimeout() {
...
class je {
    constructor() {
        ...
        this.jr = new Qe(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Gr = () => {
            // eslint-disable-next-line @typescript-eslint/no-floating-promises
            this.Hr("async_queue_retry" /* AsyncQueueRetry */);
        };
        const t = me.nt().window;
        t && "function" == typeof t.addEventListener && t.addEventListener("visibilitychange", this.Gr);
    }
     ...
     */    async Zr(t) {
        if (this.Yr(), !this.xr) {
            ...
            e && e.removeEventListener("visibilitychange", this.Gr), await this.Jr(t);
        }
    }
    /**
     ...
     */    enqueue(t) {
        return this.Yr(), this.xr ? new Promise(t => {}) : this.Xr(t);
    }
    /**
     ...
     */    th(t) {
        this.Yr(), this.xr || (this.qr = this.qr.then(() => {
            const e = new Ue, s = async () => {
                try {
                    await t(), e.resolve(), this.jr.reset();
                } catch (t) {
 ...
 // Failure will be handled by AsyncQueue
    ...
    Xr(t) {
        const e = this.Mr.then(() => (this.Qr = !0, t().catch(t => {
            ...
            throw this.Ur = t, this.Qr = !1, Ve("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
            t;
        }).then(t => (this.Qr = !1, t))));
        return this.Mr = e, e;
    }
     ...
     */    vr(t, e, s) {
        ...
        const i = We.Nr(this, t, e, s, t => this.eh(t));
     ...
     * exists.
     */    nh(t) {
        for (const e of this.Br) if (e.mr === t) return !0;
        return !1;
    }
    /**
     ...
     */    Hr(t) {
        ...
        return this.ih().then(() => {
            ...
            this.Br.sort((t, e) => t.Cr - e.Cr);
            for (const e of this.Br) if (e.kr(), "all" /* All */ !== t && e.mr === t) break;
            return this.ih();
        });
    }
    /**
    ...
    /** Called once a DelayedOperation is run or canceled. */    eh(t) {
 ...
 */ class Ge {
    ...
    s) {
        this.hh = t, this.oh = e, this.ah = s;
    }
    static uh(t) {
        return new Ge(t, Ge.lh, Ge._h);
    }
}

Ge.fh = -1, Ge.dh = 1048576, Ge.Th = 41943040, Ge.lh = 10, Ge._h = 1e3, Ge.wh = new Ge(Ge.Th, Ge.lh, Ge._h), 
Ge.DISABLED = new Ge(Ge.fh, 0, 0);
 ...
 */ class Ke {
    ...
    Ah(t, e) {
        return this.Rh.add(e), Me.resolve();
    }
    rr(t, e) {
        return Me.resolve(this.Rh.getEntries(e));
    }
}
 ...
 */ class ze {
    ...
    add(t) {
        const e = t.M(), s = t.k(), i = this.index[e] || new Qt(b.N), n = !i.has(s);
        return this.index[e] = i.add(s), n;
    }
    has(t) {
        const e = t.M(), s = t.k(), i = this.index[e];
        return i && i.has(s);
    }
    getEntries(t) {
...
class Ye {
    ...
    t, e, s) {
        ...
        this.yh = new Ne(t => t.canonicalId()), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.gh = y.min(), this.persistence.vh.bh(this.Vh), this.jn = t.Sh(s), this.Ch = t.Dh(), 
        this.Fh = t.Nh(), this.$h = new qe(this.Ch, this.jn, this.persistence.Lh()), this.Ph.kh(this.$h);
    }
    ...
    // change.
    async Oh(t) {
        let e = this.jn, s = this.$h;
        const i = await this.persistence.runTransaction("Handle user change", "readonly", i => {
            // Swap out the mutation queue, grabbing the pending mutation batches
            // before and after.
            let n;
            return this.jn.Mh(i).next(r => (n = r, e = this.persistence.Sh(t), 
            // Recreate our LocalDocumentsView using the new
            // MutationQueue.
            s = new qe(this.Ch, e, this.persistence.Lh()), e.Mh(i))).next(t => {
                const e = [], r = [];
        ...
        return this.jn = e, this.$h = s, this.Ph.kh(this.$h), i;
    }
    /* Accept locally generated Mutations and commit them to storage. */    Uh(t) {
        const e = p.now(), s = t.reduce((t, e) => t.add(e.key), Zt());
        let i;
        return this.persistence.runTransaction("Locally write mutations", "readwrite", n => this.$h.Jn(n, s).next(s => {
            i = s;
     ...
     */    jh(t) {
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", e => {
            const s = t.batch.keys(), i = this.Ch.Gh({
                Hh: !0
            });
            return this.jn.jh(e, t.batch, t.streamToken).next(() => this.Kh(e, t, i)).next(() => i.apply(e)).next(() => this.jn.zh(e)).next(() => this.$h.Jn(e, s));
        });
    }
    /**
     ...
     */    Yh(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let s;
            return this.jn.Xh(e, t).next(t => (ge(null !== t), s = t.keys(), this.jn.Jh(e, t))).next(() => this.jn.zh(e)).next(() => this.$h.Jn(e, s));
        });
    }
    /**
     ...
     */    Zh() {
        return this.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", t => this.jn.Zh(t));
    }
    /** Returns the last recorded stream token for the current user. */    to() {
        return this.persistence.runTransaction("Get last stream token", "readonly", t => this.jn.to(t));
    }
    /**
     ...
     */    eo(t) {
        return this.persistence.runTransaction("Set last stream token", "readwrite-primary", e => this.jn.eo(e, t));
    }
    /**
     * Returns the last consistent snapshot processed (used by the RemoteStore to
     * determine whether to buffer incoming snapshots from the backend).
     */    so() {
        return this.persistence.runTransaction("Get last remote snapshot version", "readonly", t => this.Fh.so(t));
    }
    /**
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", i => {
            ...
            t.as.forEach((t, n) => {
                ...
                // the updated assignment.
                                r.push(this.Fh.no(i, t.Es, n).next(() => this.Fh.ro(i, t.Ts, n)));
                const o = t.resumeToken;
                // Update the resume token if the change includes one.
                                if (o.rt() > 0) {
                    const a = h.me(o, e).Ee(i.ho);
                    s = s.Re(n, a), 
                    // Update the target data if there are target changes (or if
                    // sufficient time has passed since the last update).
                    Ye.oo(h, a, t) && r.push(this.Fh.ao(i, a));
                }
            });
            let h = Gt(), o = Zt();
            ...
            r.push(n.getEntries(i, o).next(s => {
                t.cs.forEach((o, a) => {
                    ...
                    // access.
                    n.uo(o, e), h = h.Re(o, a)) : null == u || a.version.S(u.version) > 0 || 0 === a.version.S(u.version) && u.hasPendingWrites ? (n.co(a, e), 
                    h = h.Re(o, a)) : Pe("LocalStore", "Ignoring outdated watch update for ", o, ". Current version:", u.version, " Watch version:", a.version), 
                    t.ls.has(o) && r.push(this.persistence.vh.lo(i, o));
                });
            })), !e.isEqual(y.min())) {
                const t = this.Fh.so(i).next(t => this.Fh._o(i, i.ho, e));
                r.push(t);
            }
            return Me.Un(r).next(() => n.apply(i)).next(() => this.$h.Zn(i, h));
        }).then(t => (this.ph = s, t));
    }
    /**
     ...
     */    static oo(t, e, s) {
        ...
        // closing.
                return e.we.C() - t.we.C() >= this.fo || s.Ts.size + s.ws.size + s.Es.size > 0;
     ...
     */    do(t) {
        for (const e of t) {
            const t = e.targetId;
            if (this.Vh.yn(e.ar, t), this.Vh.vn(e.ur, t), !e.fromCache) {
                const e = this.ph.get(t), s = e.we, i = e.Ie(s);
                // Advance the last limbo free snapshot version
                                this.ph = this.ph.Re(t, i);
            }
        }
        return this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => Me.forEach(t, t => Me.forEach(t.ur, t => this.persistence.vh.gn(e, t))));
    }
    /**
     ...
     */    Eo(t) {
        return this.persistence.runTransaction("read document", "readonly", e => this.$h.Hn(e, t));
    }
    /**
     ...
     */    mo(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            let s;
            return this.Fh.Io(e, t).next(i => i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            s = i, Me.resolve(s)) : this.Fh.Ro(e).next(i => (s = new $t(t, i, 0 /* Listen */ , e.ho), 
            this.Fh.Ao(e, s).next(() => s))));
        }).then(e => (null === this.ph.get(e.targetId) && (this.ph = this.ph.Re(e.targetId, e), 
        this.yh.set(t, e.targetId)), e));
    }
    /**
    ...
    // Visible for testing.
    Io(t, e) {
        const s = this.yh.get(e);
        return void 0 !== s ? Me.resolve(this.ph.get(s)) : this.Fh.Io(t, e);
    }
    /**
    ...
    Po(t, e) {
        const s = this.ph.get(t), i = e ? "readwrite" : "readwrite-primary";
        return this.persistence.runTransaction("Release target", i, i => {
            ...
            const n = this.Vh.Sn(t);
            return e ? Me.resolve() : Me.forEach(n, t => this.persistence.vh.gn(i, t)).next(() => {
                this.persistence.vh.removeTarget(i, s);
            });
        }).then(() => {
            this.ph = this.ph.remove(t), this.yh.delete(s.target);
        });
    }
    /**
     ...
     */    Vo(t, e) {
        let s = y.min(), i = Zt();
        return this.persistence.runTransaction("Execute query", "readonly", n => this.Io(n, t.ee()).next(t => {
            if (t) return s = t.lastLimboFreeSnapshotVersion, this.Fh.po(n, t.targetId).next(t => {
                i = t;
            });
        }).next(() => this.Ph.er(n, t, e ? s : y.min(), e ? i : Zt())).next(t => ({
            documents: t,
            yo: i
        })));
    }
     ...
     */    bo(t) {
        return this.persistence.runTransaction("Remote document keys", "readonly", e => this.Fh.po(e, t));
    }
    Kh(t, e, s) {
        ...
        }), r.next(() => this.jn.Jh(t, i));
    }
    vo(t) {
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", e => t.So(e, this.ph));
    }
}
...
/** Helper function to assert Base64 functions are available at runtime. */ function ms() {
    if (!me.nt().Co) throw new m(E.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
class Is {
    ...
    toBase64() {
        return Ze("Blob.toBase64", arguments, 0), ms(), this.Do.toBase64();
    }
    toUint8Array() {
        return Ze("Blob.toUint8Array", arguments, 0), Es(), this.Do.toUint8Array();
    }
    toString() {
...
class ys extends Ps {
    constructor(t) {
        super("FieldValue.arrayUnion"), this.Oo = t;
    }
    Ci(t) {
        ...
        const e = t.Mo({
            Lo: 3 /* Argument */ ,
            methodName: this.$o
        }), s = this.Oo.map((t, s) => Ls(t, e.qo(s))), i = new it(s);
...
class gs extends Ps {
    constructor(t) {
        super("FieldValue.arrayRemove"), this.Oo = t;
    }
    Ci(t) {
        // Although array transforms are used with writes, the actual elements
        ...
        const e = t.Mo({
            Lo: 3 /* Argument */ ,
            methodName: this.$o
        }), s = this.Oo.map((t, s) => Ls(t, e.qo(s))), i = new nt(s);
        return new at(t.path, i);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class bs extends Ps {
    constructor(t) {
        super("FieldValue.increment"), this.xo = t;
    }
    Ci(t) {
        t.Mo({
            methodName: this.$o
        });
        const e = Ls(this.xo, t), s = new rt(t.serializer, e);
        return new at(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
...
class vs {
     ...
     * with an underscore.
     */    g(t) {
        return Se(this.Bo, t.Bo) || Se(this.Uo, t.Uo);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Ns {
    ...
    constructor(t, e, s, i, n) {
        ...
        void 0 === i && this.Wo(), this.fieldTransforms = i || [], this.Vt = n || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    Mo(t) {
        return new Ns(Object.assign(Object.assign({}, this.settings), t), this.ii, this.serializer, this.fieldTransforms, this.Vt);
    }
    jo(t) {
        const e = null == this.path ? null : this.path.child(t), s = this.Mo({
            path: e,
            Go: !1
        });
        return s.Ho(t), s;
    ...
    Ho(t) {
        ...
        if (Fs(this.Lo) && Ss.test(t)) throw this.ko('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class $s {
    constructor(t, e) {
        this.ii = t, this.serializer = e || me.nt().zo(t);
    }
    /** Parse document data from a non-merge set() call. */    Yo(t, e) {
        const s = this.Xo(0 /* Set */ , t);
        Ms("Data must be an object, but it was:", s, e);
        const i = ks(e, s);
        return new Cs(new Et(i), 
        /* fieldMask= */ null, s.fieldTransforms);
    }
    /** Parse document data from a set() call with '{merge:true}'. */    Jo(t, e, s) {
        const i = this.Xo(2 /* MergeSet */ , t);
        ...
        if (s) {
            ...
            for (const n of s) {
                let s;
                if (n instanceof Rs) s = n.Fo; else {
    ...
    /** Parse update data from an update() call. */    Zo(t, e) {
        const s = this.Xo(1 /* Update */ , t);
        Ms("Data must be an object, but it was:", s, e);
        const i = [], n = new mt;
        F(e, (e, r) => {
            const h = xs(t, e), o = s.Ko(h);
            if (r instanceof Vs) 
    ...
    /** Parse update data from a list of field/value arguments. */    ta(t, e, s, i) {
        const n = this.Xo(1 /* Update */ , t), r = [ qs(t, e) ], h = [ s ];
    ...
    /** Creates a new top-level parse context. */    Xo(t, e) {
        return new Ns({
            Lo: t,
            methodName: e,
            path: S.H,
     ...
     */    ea(t, e, s = !1) {
        return Ls(e, this.Xo(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }
}
 ...
 */ function Ls(t, e) {
    if (Os(t)) return Ms("Unsupported field value:", e, t), ks(t, e);
    if (t instanceof Ps) 
 ...
 */
    return function(t, e) {
        ...
        if (!Fs(e.Lo)) throw e.ko(`${t.$o}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof pi) {
            const s = e.ii, i = t.firestore.sa;
            if (!i.isEqual(s)) throw e.ko("Document reference is for database " + `${i.projectId}/${i.database} but should be ` + `for database ${s.projectId}/${s.database}`);
            return {
                referenceValue: e.serializer.li(t.ia.path, t.firestore.sa)
            };
        }
        throw e.ko(`Unsupported field value: ${cs(t)}`);
    }
    /**
...
function Ms(t, e, s) {
    if (!Os(s) || !us(s)) {
        const i = cs(s);
        throw "an object" === i ? e.ko(t + " a custom object") : e.ko(t + " " + i);
    }
}
 ...
 */ function qs(t, e) {
    if (e instanceof Rs) return e.Fo;
...
class Us {
    constructor(t, e, s, i, n, r) {
        this.Er = t, this.na = s, this.ra = i, this.ha = n, this.listener = r, this.state = 0 /* Initial */ , 
        /**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */
        this.oa = 0, this.aa = null, this.stream = null, this.jr = new Qe(t, e);
    }
    /**
     ...
     */    async stop() {
        this.ua() && await this.close(0 /* Initial */);
    }
    /**
     ...
     */    fa() {
        ...
        this.ca() && null === this.aa && (this.aa = this.Er.vr(this.na, 6e4, () => this.da()));
    }
    /** Sends a message to the underlying stream. */    Ta(t) {
        this.wa(), this.stream.send(t);
    }
    /** Called by the idle timer when the stream should close due to inactivity. */    async da() {
        if (this.ca()) 
    ...
    auth() {
        ...
        const t = this.Ia(this.oa), e = this.oa;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.ha.getToken().then(t => {
    ...
    Ra(t) {
        const e = this.Ia(this.oa);
        this.stream = this.Pa(t), this.stream.Va(() => {
            e(() => (this.state = 2 /* Open */ , this.listener.Va()));
        }), this.stream.ma(t => {
            e(() => this.Aa(t));
    ...
    la() {
        this.state = 4 /* Backoff */ , this.jr.gr(async () => {
     ...
     */    Ia(t) {
        return e => {
            this.Er.Or(() => this.oa === t ? e() : (Pe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class Ws extends Us {
    ...
    onMessage(t) {
        ...
        ge(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.va) {
            ...
            return this.listener.Da(s, e);
        }
        // The first response is always the handshake response
        return ge(!t.writeResults || 0 === t.writeResults.length), this.va = !0, this.listener.Fa();
    }
    /**
    ...
    /** Sends a group of mutations to the Firestore backend to apply. */    Ca(t) {
        const e = {
...
class js extends class {
    ...
    constructor(t, e, s) {
        super(), this.ra = t, this.credentials = e, this.serializer = s;
    }
    /** Gets an auth token and invokes the provided RPC. */    La(t, e) {
        return this.credentials.getToken().then(s => this.ra.La(t, e, s)).catch(t => {
    ...
    /** Gets an auth token and invokes the provided RPC with streamed results. */    ka(t, e) {
        return this.credentials.getToken().then(s => this.ra.ka(t, e, s)).catch(t => {
            throw t.code === E.UNAUTHENTICATED && this.credentials.l(), t;
        });
    }
}
...
class Gs {
    constructor(t) {
        ...
        this.Ma = Xt(), this.mutations = [], this.qa = !1, 
        /**
    ...
    async Ua(t) {
        if (this.Qa(), this.mutations.length > 0) throw new m(E.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const s = be(t), i = {
                database: s.serializer.mi,
                documents: e.map(t => s.serializer.di(t))
            }, n = await s.ka("BatchGetDocuments", i), r = new Map;
            n.forEach(t => {
        ...
        return e.forEach(t => {
            t instanceof Pt || t instanceof At ? this.Wa(t) : ye();
        }), e;
    }
    set(t, e) {
    ...
    async commit() {
        ...
        t.forEach((t, e) => {
            ...
            }, n = await s.La("Commit", i);
            return s.serializer.Oi(n.writeResults, n.commitTime);
        }(this.Oa, this.mutations), this.qa = !0;
    }
    Wa(t) {
        let e;
...
class Hs {
     ...
     */    Ya() {
        0 === this.Ha && (this.Xa("Unknown" /* Unknown */), this.Ka = this.Sr.vr("online_state_timeout" /* OnlineStateTimeout */ , 1e4, () => (this.Ka = null, 
    ...
    Ja(t) {
        ...
        this.za ? (Ve(e), this.za = !1) : Pe("OnlineStateTracker", e);
    }
    tu() {
...
class Ks {
    ...
    e, s, i, n) {
        ...
        this.ru = !1, this.hu = n, this.hu.ou(t => {
            s.Or(async () => {
                this.au() && (Pe("RemoteStore", "Restarting streams for network reachability change."), 
                await this.uu());
            });
        }), this.cu = new Hs(s, i), 
        ...
        this.lu = function(t, e, s) {
            const i = be(t);
            return new Qs(e, i.ra, i.credentials, i.serializer, s);
        }(this.Oa, s, {
            Va: this._u.bind(this),
            ma: this.fu.bind(this),
            ya: this.du.bind(this)
        }), this.Tu = function(t, e, s) {
            const i = be(t);
            return new Ws(e, i.ra, i.credentials, i.serializer, s);
        }(this.Oa, s, {
    ...
    async Iu() {
        this.au() && (this.Tu.lastStreamToken = await this.eu.to(), this.Ru() ? this.Au() : this.cu.set("Unknown" /* Unknown */), 
    ...
    async Vu() {
        await this.Tu.stop(), await this.lu.stop(), this.su.length > 0 && (Pe("RemoteStore", `Stopping write stream with ${this.su.length} pending writes`), 
        this.su = []), this.pu();
    }
    async yu() {
        Pe("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, await this.Vu(), 
        this.hu.yu(), 
    ...
    async du(t, e) {
        ...
        !e.isEqual(y.min())) try {
            const t = await this.eu.so();
            e.S(t) >= 0 && 
            // We have received a target change with a global snapshot if the snapshot
            // version is not equal to SnapshotVersion.min().
            await this.Fu(e);
        } catch (t) {
            Pe("RemoteStore", "Failed to raise snapshot:", t), await this.Du(t);
        }
    }
    /**
     ...
     */    async Du(t) {
        ...
        await this.Vu(), this.cu.set("Offline" /* Offline */), 
        ...
        this.Sr.th(async () => {
            ...
            await this.eu.so(), this.ru = !1, await this.Iu();
        });
    }
    /**
        ...
        return e.as.forEach((e, s) => {
            if (e.resumeToken.rt() > 0) {
                ...
                // A watched target might have been removed already.
                                i && this.iu.set(s, i.me(e.resumeToken, t));
            }
        }), 
    ...
    /** Handles an error on a target */    async Cu(t) {
        ...
        // A watched target might have been removed already.
        this.iu.has(s) && (await this.Su.Nu(s, e), this.iu.delete(s), this.nu.removeTarget(s));
    }
    /**
     ...
     */    async Pu() {
        if (this.$u()) {
            const t = this.su.length > 0 ? this.su[this.su.length - 1].batchId : -1, e = await this.eu.To(t);
            null === e ? 0 === this.su.length && this.Tu.fa() : (this.Lu(e), await this.Pu());
        }
        this.ku() && this.Ou();
    }
    /**
    ...
    mu() {
        ...
        return this.eu.eo(this.Tu.lastStreamToken).then(() => {
            // Send the write pipeline now that the stream is established.
            for (const t of this.su) this.Tu.Ca(t.mutations);
        }).catch(Xe);
    }
    Da(t, e) {
        const s = this.su.shift(), i = Le.from(s, t, e, this.Tu.lastStreamToken);
        return this.Su.qu(i).then(() => this.Pu());
    }
    async Eu(t) {
        // If the write stream closed due to an error, invoke the error callbacks if
        // there are pending writes.
        t && this.su.length > 0 && (this.Tu.Sa ? 
    ...
    async Bu(t) {
        ...
        if (Mt(t.code)) return Pe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.Tu.lastStreamToken), 
        this.Tu.lastStreamToken = $.ht, this.eu.eo($.ht).catch(Xe);
    }
    async xu(t) {
        // Only handle permanent errors here. If it's transient, just let the retry
        // logic kick in.
        if (Mt(e = t.code) && e !== E.ABORTED) {
            ...
            // restart.
                        return this.Tu._a(), this.Su.Uu(e.batchId, t).then(() => this.Pu());
        }
        var e;
        /**
 ...
 */    }
    ...
    async Wu() {
        ...
        Pe("RemoteStore", "RemoteStore restarting streams for new credential"), await this.uu());
    }
    /**
 ...
 */ class Ys {
    constructor() {
        this.zu = new zs, this.Yu = {}, this.Su = null, this.Ga = null, this.lr = null;
    }
    Xu(t) {
        // No op.
    }
    ...
    start() {
        return this.zu = new zs, Promise.resolve();
    }
    Oh(t, e, s) {
        // No op.
    }
 ...
 */ (t.type, e.type) || this.query.se(t.doc, e.doc)), this.Ec(s);
        const r = e ? this.mc() : [], h = 0 === this.uc.size && this.ds ? 1 /* Synced */ : 0 /* Local */ , o = h !== this.ac;
     ...
     */    Ec(t) {
        t && (t.Ts.forEach(t => this.oc = this.oc.add(t)), t.ws.forEach(t => {}), t.Es.forEach(t => this.oc = this.oc.delete(t)), 
        this.ds = t.ds);
    }
    mc() {
...
class ti {
    constructor(t, e, s, i) {
        this.Sr = t, this.pc = e, this.updateFunction = s, this.Fr = i, this.yc = 5, this.jr = new Qe(this.Sr, "transaction_retry" /* TransactionRetry */);
    }
    /** Runs the transaction and sets the result on deferred. */    gc() {
        this.bc();
    }
    bc() {
        this.jr.gr(async () => {
            const t = this.pc.Qu(), e = this.vc(t);
            e && e.then(e => {
                this.Sr.Or(() => t.commit().then(() => {
                    this.Fr.resolve(e);
                }).catch(t => {
                    this.Sc(t);
                }));
    ...
    vc(t) {
        try {
            ...
            return !L(e) && e.catch && e.then ? e : (this.Fr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
    ...
    Sc(t) {
        this.yc > 0 && this.Cc(t) ? (this.yc -= 1, this.Sr.Or(() => (this.bc(), Promise.resolve()))) : this.Fr.reject(t);
    }
    Cc(t) {
 ...
 */ class ii {
    ...
    s, i, n) {
        this.eu = t, this.pc = e, this.Fc = s, this.currentUser = i, this.Nc = n, this.$c = null, 
        this.Lc = new Ne(t => t.canonicalId()), this.kc = new Map, 
        /**
         ...
         */
        this.qc = new Map, this.xc = new ke, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Bc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Uc = new Map, this.Qc = He.Ih(), this.onlineState = "Unknown" /* Unknown */;
    }
    get Wc() {
        return !0;
    }
     ...
     */    async listen(t) {
        ...
        e = i.targetId, this.Fc.Zu(e), s = i.view.Vc(); else {
            const i = await this.eu.mo(t.ee()), n = this.Fc.Zu(i.targetId);
            e = i.targetId, s = await this.Gc(t, e, "current" === n), this.Wc && this.pc.listen(i);
        }
        return s;
    }
    /**
     ...
     * snapshot.
     */    async Gc(t, e, s) {
        const i = await this.eu.Vo(t, 
        /* usePreviousResults= */ !0), n = new Zs(t, i.yo), r = n._c(i.documents), h = he.fs(e, s && "Offline" /* Offline */ !== this.onlineState), o = n.wc(r, 
        /* updateLimboDocuments= */ this.Wc, h);
        this.Hc(e, o.Ic);
        const a = new ei(t, e, n);
        return this.Lc.set(t, a), this.kc.has(e) ? this.kc.get(e).push(t) : this.kc.set(e, [ t ]), 
        o.snapshot;
    }
    /** Stops listening to the query. */    async bu(t) {
        this.jc("unlisten()");
        const e = this.Lc.get(t), s = this.kc.get(e.targetId);
        // Only clean up the query view and target if this is the only query mapped
        // to the target.
                if (s.length > 1) return this.kc.set(e.targetId, s.filter(e => !e.isEqual(t))), 
        void this.Lc.delete(t);
        // No other queries are mapped to the target, clean up the query and the target.
                if (this.Wc) {
            // We need to remove the local query target first to allow us to verify
            // whether any other client is still interested in this target.
            this.Fc.ec(e.targetId), this.Fc.rc(e.targetId) || await this.eu.Po(e.targetId, /*keepPersistedTargetData=*/ !1).then(() => {
                this.Fc.ic(e.targetId), this.pc.bu(e.targetId), this.Kc(e.targetId);
            }).catch(Xe);
        } else this.Kc(e.targetId), await this.eu.Po(e.targetId, 
     ...
     */    async write(t, e) {
        ...
        this.Fc.Xu(s.batchId), this.zc(s.batchId, e), await this.Yc(s.Wh), await this.pc.Pu();
    }
    /**
     ...
     */    runTransaction(t, e, s) {
        new ti(t, this.pc, e, s).gc();
    }
    async io(t) {
        this.jc("applyRemoteEvent()");
        try {
            const e = await this.eu.io(t);
            // Update `receivedDocument` as appropriate for any limbo targets.
                        t.as.forEach((t, e) => {
                const s = this.qc.get(e);
                s && (
                // Since this is a limbo resolution lookup, it's for a single document
                // and it could be added, modified, or removed, but not a combination.
                ge(t.Ts.size + t.ws.size + t.Es.size <= 1), t.Ts.size > 0 ? s.Dc = !0 : t.ws.size > 0 ? ge(s.Dc) : t.Es.size > 0 && (ge(s.Dc), 
                s.Dc = !1));
            }), await this.Yc(e, t);
        } catch (t) {
            await Xe(t);
     ...
     */    Rc(t, e) {
        ...
        }), this.$c.Xc(t), this.$c.ya(s), this.onlineState = t;
    }
    async Nu(t, e) {
        this.jc("rejectListens()"), 
        // PORTING NOTE: Multi-tab only.
        this.Fc.tc(t, "rejected", e);
        const s = this.qc.get(t), i = s && s.key;
        if (i) {
            // Since this query failed, we won't want to manually unlisten to it.
            // So go ahead and remove it from bookkeeping.
            this.Mc = this.Mc.remove(i), this.qc.delete(t), this.Jc();
        ...
        await this.eu.Po(t, /* keepPersistedTargetData */ !1).then(() => this.Kc(t, e)).catch(Xe);
    }
    async qu(t) {
        ...
        // before listen events.
                this.Zc(e, /*error=*/ null), this.tl(e);
        try {
            const s = await this.eu.jh(t);
            this.Fc.Ju(e, "acknowledged"), await this.Yc(s);
        } catch (t) {
            await Xe(t);
        }
    }
    async Uu(t, e) {
        ...
        // listen events.
        this.Zc(t, e), this.tl(t);
        try {
            const s = await this.eu.Yh(t);
            this.Fc.Ju(t, "rejected", e), await this.Yc(s);
        } catch (e) {
            await Xe(e);
        }
    }
     ...
     * are acknowledged .
     */    async el(t) {
        this.pc.au() || Pe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        const e = await this.eu.Zh();
        if (-1 === e) 
    ...
    zc(t, e) {
        ...
        s || (s = new xt(Se)), s = s.Re(t, e), this.Bc[this.currentUser.s()] = s;
    }
    /**
    ...
    Kc(t, e = null) {
        this.Fc.ec(t);
        for (const s of this.kc.get(t)) this.Lc.delete(s), e && this.$c.il(s, e);
        if (this.kc.delete(t), this.Wc) {
            const e = this.xc.Dn(t);
            this.xc.Sn(t), e.forEach(t => {
                this.xc.Fn(t) || 
    ...
    Hc(t, e) {
        for (const s of e) if (s instanceof Xs) this.xc.pn(s.key, t), this.rl(s); else if (s instanceof Js) {
            Pe("SyncEngine", "Document no longer in limbo: " + s.key), this.xc.gn(s.key, t), 
            this.xc.Fn(s.key) || 
            // We removed the last reference for this key
            this.nl(s.key);
        } else ye();
    ...
    rl(t) {
        const e = t.key;
        this.Mc.get(e) || (Pe("SyncEngine", "New document in limbo: " + e), this.Oc.push(e), 
        this.Jc());
    }
    /**
     ...
     */    Jc() {
        for (;this.Oc.length > 0 && this.Mc.size < this.Nc; ) {
            const t = this.Oc.shift(), e = this.Qc.next();
            this.qc.set(e, new si(t)), this.Mc = this.Mc.Re(t, e), this.pc.listen(new $t(yt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Be.wr));
        }
    }
    // Visible for testing
    hl() {
    ...
    async Yc(t, e) {
        ...
        this.Lc.forEach((r, h) => {
            n.push(Promise.resolve().then(() => {
                const e = h.view._c(t);
                return e.Tc ? this.eu.Vo(h.query, /* usePreviousResults= */ !1).then(({documents: t}) => h.view._c(t, e)) : e;
                // The query has a limit and some docs were removed, so we need
                // to re-run the query against the local store to make sure we
                // didn't lose any good docs that had been past the limit.
                        }).then(t => {
                const n = e && e.as.get(h.targetId), r = h.view.wc(t, 
                /* updateLimboDocuments= */ this.Wc, n);
                if (this.Hc(h.targetId, r.Ic), r.snapshot) {
                    this.Wc && this.Fc.tc(h.targetId, r.snapshot.fromCache ? "not-current" : "current"), 
                    s.push(r.snapshot);
                    const t = xe.cr(h.targetId, r.snapshot);
                    i.push(t);
                }
            }));
        }), await Promise.all(n), this.$c.ya(s), await this.eu.do(i);
    }
    jc(t) {}
    async Wu(t) {
        ...
        if (this.currentUser = t, e) {
            ...
            const e = await this.eu.Oh(t);
            // TODO(b/114226417): Consider calling this only in the primary tab.
                        this.Fc.Oh(t, e.xh, e.Bh), await this.Yc(e.qh);
        }
        await this.pc.Wu();
    }
    enableNetwork() {
    ...
    ei(t) {
        ...
        if (e && e.Dc) return Zt().add(e.key);
        {
            let e = Zt();
            const s = this.kc.get(t);
            if (!s) return e;
            for (const t of s) {
 ...
 */ class ri {
    constructor(t) {
        this.Su = t, this.cl = new Ne(t => t.canonicalId()), this.onlineState = "Unknown" /* Unknown */ , 
 ...
 */ class hi {
    constructor(t, e, s) {
         ...
         */
        this.El = !1, this.ml = null, this.onlineState = "Unknown" /* Unknown */ , this.options = s || {};
    }
    /**
     ...
     */    _l(t) {
        ...
        let e = !1;
        return this.El ? this.Il(t) && (this.wl.next(t), e = !0) : this.Rl(t, this.onlineState) && (this.Al(t), 
        e = !0), this.ml = t, e;
    }
    onError(t) {
        this.wl.error(t);
    }
    /** Returns whether a snapshot was raised. */    Rc(t) {
        this.onlineState = t;
        let e = !1;
    ...
    Rl(t, e) {
        ...
        // above) and are waiting for a sync.
                return (!this.options.Pl || !s) && (!t.docs.q() || "Offline" /* Offline */ === e);
    ...
    Il(t) {
        ...
        const e = this.ml && this.ml.hasPendingWrites !== t.hasPendingWrites;
    ...
    Al(t) {
        t = ne.os(t.query, t.docs, t.ns, t.fromCache), this.El = !0, this.wl.next(t);
    }
}
 ...
 */ class oi {
    ...
    er(t, e, i, n) {
        ...
        return e.te() || i.isEqual(y.min()) ? this.pl(t, e) : this.Vl.Jn(t, n).next(r => {
            const h = this.yl(e, r);
            return (e.oe() || e.ae()) && this.Tc(e.xt, h, n, i) ? this.pl(t, e) : (Re() <= s.DEBUG && Pe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", i.toString(), e.toString()), 
            this.Vl.er(t, e, i).next(t => (
 ...
 */ class ai {
    constructor(t, e) {
        ...
        this.bl = new Qt(Oe.An);
    }
    vl(t) {
        return Me.resolve(0 === this.jn.length);
    }
    jh(t, e, s) {
        const i = e.batchId, n = this.Sl(i, "acknowledged");
        ge(0 === n);
        // Verify that the batch in the queue is the one to be acknowledged.
        this.jn[n];
        return this.lastStreamToken = s, Me.resolve();
    }
    to(t) {
        return Me.resolve(this.lastStreamToken);
    }
    eo(t, e) {
        return this.lastStreamToken = e, Me.resolve();
    }
    Qh(t, e, s, i) {
        const n = this.gl;
        if (this.gl++, this.jn.length > 0) {
            this.jn[this.jn.length - 1];
        }
        const r = new $e(n, e, s, i);
        this.jn.push(r);
        // Track references by document key and index collection parents.
        for (const e of i) this.bl = this.bl.add(new Oe(e.key, n)), this.Gn.Ah(t, e.key.path.k());
        return Me.resolve(r);
    }
    Xh(t, e) {
        return Me.resolve(this.Cl(e));
    }
    wo(t, e) {
        const s = e + 1, i = this.Dl(s), n = i < 0 ? 0 : i;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Me.resolve(this.jn.length > n ? this.jn[n] : null);
    }
    Zh() {
        return Me.resolve(0 === this.jn.length ? -1 : this.gl - 1);
    }
    Mh(t) {
        return Me.resolve(this.jn.slice());
    }
    Kn(t, e) {
        const s = new Oe(e, 0), i = new Oe(e, Number.POSITIVE_INFINITY), n = [];
        return this.bl.Ge([ s, i ], t => {
            const e = this.Cl(t.Nn);
            n.push(e);
        }), Me.resolve(n);
    }
    tr(t, e) {
        let s = new Qt(Se);
        return e.forEach(t => {
            const e = new Oe(t, 0), i = new Oe(t, Number.POSITIVE_INFINITY);
            this.bl.Ge([ e, i ], t => {
                s = s.add(t.Nn);
            });
        }), Me.resolve(this.Fl(s));
    }
    hr(t, e) {
    ...
    Jh(t, e) {
        ge(0 === this.Sl(e.batchId, "removed")), this.jn.shift();
        let s = this.bl;
        return Me.forEach(e.mutations, i => {
            const n = new Oe(i.key, e.batchId);
            return s = s.delete(n), this.vh.Nl(t, i.key);
        }).next(() => {
            this.bl = s;
        });
    }
    ...
    Fn(t, e) {
        const s = new Oe(e, 0), i = this.bl.Ke(s);
        return Me.resolve(e.isEqual(i && i.key));
    }
    zh(t) {
        return this.jn.length, Me.resolve();
    }
    /**
 ...
 */ class ui {
     ...
     */    co(t, e, s) {
        ...
        return this.docs = this.docs.Re(i, {
            ...
            size: h,
            readTime: s
        }), this.size += h - r, this.Gn.Ah(t, i.path.k());
    }
    /**
    ...
    Yn(t, e) {
        ...
        return Me.resolve(s ? s.kl : null);
    }
    getEntries(t, e) {
        let s = Ht();
        return e.forEach(t => {
            const e = this.docs.get(t);
            s = s.Re(t, e ? e.kl : null);
        }), Me.resolve(s);
    }
    er(t, e, s) {
        let i = zt();
        ...
        for (;r.$e(); ) {
            const {key: t, value: {kl: n, readTime: h}} = r.Ne();
    ...
    Ol(t, e) {
        return Me.forEach(this.docs, t => e(t));
    }
    Gh(t) {
        // `trackRemovals` is ignores since the MemoryRemoteDocumentCache keeps
        // a separate changelog and does not need special handling for removals.
        return new ui.Ml(this);
    }
    ql(t) {
 ...
 */ ui.Ml = class extends class {
    constructor() {
        // A mapping of document key to the new cache entry that should be written (or null if any
        // existing cache entry should be removed).
        this.Wh = new Ne(t => t.toString()), this.xl = !1;
    }
    set readTime(t) {
        this.Bl = t;
    }
     ...
     */    Yn(t, e) {
        this.Ul();
        const s = this.Wh.get(e);
        return void 0 !== s ? Me.resolve(s) : this.Ql(t, e);
    }
    /**
 ...
 */ {
    ...
    wc(t) {
        const e = [];
        return this.Wh.forEach((s, i) => {
            i ? e.push(this.jl.co(t, i, this.readTime)) : this.jl.uo(s);
        }), Me.Un(e);
    }
    Ql(t, e) {
...
class ci {
    constructor(t) {
         ...
         */
        this.Gl = new Ne(t => t.canonicalId()), 
         ...
         * IDs.
         */
        this.Kl = new ke, this.targetCount = 0, this.zl = He.mh();
    }
    js(t, e) {
        return this.Gl.forEach((t, s) => e(s)), Me.resolve();
    }
    so(t) {
    ...
    Xl(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.zl = new He(e), this.highestTargetId = e), t.sequenceNumber > this.Hl && (this.Hl = t.sequenceNumber);
    }
    Ao(t, e) {
    ...
    t_(t, e) {
        return this.Kl.Sn(e), Me.resolve();
    }
    po(t, e) {
        const s = this.Kl.Dn(e);
        return Me.resolve(s);
    }
    Fn(t, e) {
        return Me.resolve(this.Kl.Fn(e));
    }
}
...
class li {
     ...
     */
    constructor(t) {
        this.s_ = {}, this.i_ = new Be(0), this.n_ = !1, this.n_ = !0, this.vh = t(this), 
        this.Fh = new ci(this);
        this.Gn = new Ke, this.Wn = new ui(this.Gn, t => this.vh.r_(t));
    }
    start() {
        return Promise.resolve();
    }
    ...
    Sh(t) {
        let e = this.s_[t.s()];
        return e || (e = new ai(this.Gn, this.vh), this.s_[t.s()] = e), e;
    }
    Nh() {
        return this.Fh;
    }
    ...
    runTransaction(t, e, s) {
        ...
        const i = new _i(this.i_.next());
        return this.vh.a_(), s(i).next(t => this.vh.u_(i).next(() => t)).xn().then(t => (i.c_(), 
        t));
    }
    l_(t, e) {
        return Me.Qn(Object.values(this.s_).map(s => () => s.Fn(t, e)));
    }
}
...
class fi {
    ...
    pn(t, e) {
        return this.E_.delete(e), Me.resolve();
    }
    gn(t, e) {
    ...
    removeTarget(t, e) {
        const s = this.persistence.Nh();
        return s.po(t, e.targetId).next(t => {
    ...
    u_(t) {
        ...
        const e = this.persistence.Dh().Gh();
        return Me.forEach(this.E_, s => this.m_(t, s).next(t => {
            t || e.uo(s);
        })).next(() => (this.T_ = null, e.apply(t)));
    }
    lo(t, e) {
        return this.m_(t, e).next(t => {
    ...
    m_(t, e) {
        return Me.Qn([ () => this.persistence.Nh().Fn(t, e), () => this.persistence.l_(t, e), () => Me.resolve(this.d_.Fn(e)) ]);
    }
}
...
class di {
    async initialize(t) {
        this.Fc = this.I_(t), this.persistence = this.R_(t), await this.persistence.start(), 
        this.A_ = this.P_(t), this.eu = this.V_(t), this.pc = this.p_(t), this.Su = this.y_(t), 
        this.g_ = this.b_(t), this.Fc.Ga = t => this.Su.Rc(t, 1 /* SharedClientState */), 
        this.pc.Su = this.Su, await this.eu.start(), await this.Fc.start(), await this.pc.start(), 
        await this.pc.ju(this.Su.Wc);
    }
    b_(t) {
        return new ri(this.Su);
    }
    P_(t) {
        return null;
    }
    V_(t) {
        return new Ye(this.persistence, new oi, t.v_);
    }
    R_(t) {
        return new li(fi.w_);
    }
    p_(t) {
        return new Ks(this.eu, t.Oa, t.Sr, t => this.Su.Rc(t, 0 /* RemoteStore */), t.platform.S_());
    }
    I_(t) {
        return new Ys;
    }
    y_(t) {
        return new ii(this.eu, this.pc, this.Fc, t.v_, t.Nc);
    }
    clearPersistence(t) {
...
class Ti {
     ...
     */
    i) {
        this.platform = t, this.C_ = e, this.credentials = s, this.Sr = i, this.clientId = ve.cn();
    }
    /**
     ...
     */    start(t, e) {
        ...
        return this.credentials._(r => {
            if (!n) return n = !0, Pe("FirestoreClient", "Initializing. user=", r.uid), this.F_(t, e, r, i).then(s.resolve, s.reject);
            this.Sr.Or(() => this.Wu(r));
        }), 
        // Block the async queue until initialization is done
        this.Sr.Or(() => s.promise), i.promise;
    }
    /** Enables the network connection and requeues all pending operations. */    enableNetwork() {
        return this.D_(), this.Sr.enqueue(() => this.Su.enableNetwork());
    }
    /**
     ...
     */    async F_(t, e, s, i) {
        try {
            ...
            // provider).
            const n = await this.platform.N_(this.C_), r = this.platform.zo(this.C_.ii), h = function(t, e, s) {
                return new js(t, e, s);
            ...
            await t.initialize({
                ...
                Nc: 100,
                L_: e
            }), this.persistence = t.persistence, this.Fc = t.Fc, this.eu = t.eu, this.pc = t.pc, 
            this.Su = t.Su, this.A_ = t.A_, this.k_ = t.g_, 
     ...
     */    D_() {
        if (this.Sr.Kr) throw new m(E.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    Wu(t) {
        return this.Sr.sh(), Pe("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.Su.Wu(t);
    }
    /** Disables the network connection. Pending operations will not complete. */    disableNetwork() {
        return this.D_(), this.Sr.enqueue(() => this.Su.disableNetwork());
    }
    terminate() {
        return this.Sr.Zr(async () => {
            // PORTING NOTE: LocalStore does not need an explicit shutdown on web.
            this.A_ && this.A_.stop(), await this.pc.yu(), await this.Fc.yu(), await this.persistence.yu(), 
     ...
     */    waitForPendingWrites() {
        this.D_();
        const t = new Ue;
        return this.Sr.Or(() => this.Su.el(t)), t.promise;
    }
    listen(t, e, s) {
        this.D_();
        const i = new hi(t, e, s);
        return this.Sr.Or(() => this.k_.listen(i)), i;
    }
    bu(t) {
        // Checks for termination but does not raise error, allowing unlisten after
        // termination to be a no-op.
        this.q_ || this.Sr.Or(() => this.k_.bu(t));
    }
    x_(t) {
        return this.D_(), this.Sr.enqueue(() => this.eu.Eo(t)).then(t => {
    ...
    B_(t) {
        return this.D_(), this.Sr.enqueue(async () => {
            const e = await this.eu.Vo(t, 
            /* usePreviousResults= */ !0), s = new Zs(t, e.yo), i = s._c(e.documents);
            return s.wc(i, 
    ...
    write(t) {
        this.D_();
        const e = new Ue;
        return this.Sr.Or(() => this.Su.write(t, e)), e.promise;
    }
    ii() {
        return this.C_.ii;
    }
    dl(t) {
        this.D_(), this.Sr.Or(() => (this.k_.dl(t), Promise.resolve()));
    }
    Tl(t) {
    ...
    transaction(t) {
        this.D_();
        const e = new Ue;
        return this.Sr.Or(() => (this.Su.runTransaction(this.Sr, t, e), Promise.resolve())), 
        e.promise;
    }
}
...
class mi {
    constructor(t, e, s, i) {
        this.firestore = t, this.timestampsInSnapshots = e, this.W_ = s, this.converter = i;
    }
    j_(t) {
        switch (x(t)) {
          case 0 /* NullValue */ :
    ...
    K_(t) {
        ...
        return s.isEqual(this.firestore.sa) || 
        // TODO(b/64130202): Somehow support foreign references.
        Ve(`Document ${i} contains a document ` + "reference within a different database (" + `${s.projectId}/${s.database}) which is not ` + "supported. It will be treated as a reference in the current " + `database (${this.firestore.sa.projectId}/${this.firestore.sa.database}) ` + "instead."), 
...
class Ri {
    constructor(t) {
        ...
        rs("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Ge.Th; else {
            if (t.cacheSizeBytes !== Ii && t.cacheSizeBytes < Ge.dh) throw new m(E.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${Ge.dh}`);
 ...
 */ class Ai {
    ...
    constructor(t, e, s = new di) {
        ...
        this.Z_ = new je, this.INTERNAL = {
            ...
            const s = t;
            this.J_ = s, this.sa = Ai.sf(s), this.if = s.name, this.nf = new A(e);
        } else {
            const e = t;
            if (!e.projectId) throw new m(E.INVALID_ARGUMENT, "Must provide projectId");
            this.sa = new Fe(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.if = "[DEFAULT]", this.nf = new R;
        }
        this.rf = s, this.hf = new Ri({}), this.af = new $s(this.sa);
    }
    settings(t) {
        Ze("Firestore.settings", arguments, 1), ss("Firestore.settings", "object", 1, t);
        const e = new Ri(t);
        if (this.ef && !this.hf.isEqual(e)) throw new m(E.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */
    ...
    enablePersistence(t) {
        var e, s;
        if (this.ef) throw new m(E.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.ef && !this.ef.q_) throw new m(E.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        const t = new Ue;
        return this.Z_.zr(async () => {
            try {
                const e = this.lf();
    ...
    onSnapshotsInSync(t) {
        if (this.tf(), Ei(t)) return this.ff(t);
        {
    ...
    lf() {
        return new De(this.sa, this.if, this.hf.host, this.hf.ssl, this.hf.forceLongPolling);
    }
    cf(t, e) {
        const s = this.lf();
        return this.ef = new Ti(me.nt(), s, this.nf, this.Z_), this.ef.start(t, e);
    }
    static sf(t) {
 ...
 */        const i = t.options.projectId;
    ...
    get app() {
        if (!this.J_) throw new m(E.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.J_;
    }
    collection(t) {
        return Ze("Firestore.collection", arguments, 1), ss("Firestore.collection", "non-empty string", 1, t), 
        this.tf(), new Ci(b.G(t), this);
    }
    doc(t) {
        return Ze("Firestore.doc", arguments, 1), ss("Firestore.doc", "non-empty string", 1, t), 
        this.tf(), pi.df(b.G(t), this);
    }
    collectionGroup(t) {
        ...
        return this.tf(), new vi(new yt(b.H, t), this);
    }
    runTransaction(t) {
        return Ze("Firestore.runTransaction", arguments, 1), ss("Firestore.runTransaction", "function", 1, t), 
        this.tf().transaction(e => t(new Pi(this, e)));
    }
    batch() {
        return this.tf(), new Vi(this);
    }
    static get logLevel() {
        switch (Re()) {
          case s.DEBUG:
 ...
 */ class Pi {
    ...
    get(t) {
        ...
        const e = $i("Transaction.get", t, this.wf);
        return this.Ef.Ua([ e.ia ]).then(t => {
            if (!t || 1 !== t.length) return ye();
            const s = t[0];
            if (s instanceof Pt) return new gi(this.wf, e.ia, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.mf);
            if (s instanceof At) return new gi(this.wf, e.ia, s, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.mf);
            throw ye();
        });
    ...
    set(t, e, s) {
        ...
        const i = $i("Transaction.set", t, this.wf);
        s = Di("Transaction.set", s);
        const [n, r] = ki(i.mf, e, "Transaction.set"), h = s.merge || s.mergeFields ? this.wf.af.Jo(r, n, s.mergeFields) : this.wf.af.Yo(r, n);
        return this.Ef.set(i.ia, h), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return "string" == typeof e || e instanceof Rs ? (ts("Transaction.update", arguments, 3), 
        n = $i("Transaction.update", t, this.wf), r = this.wf.af.ta("Transaction.update", e, s, i)) : (Ze("Transaction.update", arguments, 2), 
        n = $i("Transaction.update", t, this.wf), r = this.wf.af.Zo("Transaction.update", e)), 
        this.Ef.update(n.ia, r), this;
    }
    delete(t) {
        Ze("Transaction.delete", arguments, 1);
        const e = $i("Transaction.delete", t, this.wf);
...
class Vi {
    ...
    set(t, e, s) {
        es("WriteBatch.set", arguments, 2, 3), this.Af();
        const i = $i("WriteBatch.set", t, this.wf);
        s = Di("WriteBatch.set", s);
        const [n, r] = ki(i.mf, e, "WriteBatch.set"), h = s.merge || s.mergeFields ? this.wf.af.Jo(r, n, s.mergeFields) : this.wf.af.Yo(r, n);
        return this.If = this.If.concat(h.Qo(i.ia, ct.dt())), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return this.Af(), "string" == typeof e || e instanceof Rs ? (ts("WriteBatch.update", arguments, 3), 
        n = $i("WriteBatch.update", t, this.wf), r = this.wf.af.ta("WriteBatch.update", e, s, i)) : (Ze("WriteBatch.update", arguments, 2), 
        n = $i("WriteBatch.update", t, this.wf), r = this.wf.af.Zo("WriteBatch.update", e)), 
        this.If = this.If.concat(r.Qo(n.ia, ct.exists(!0))), this;
    }
    delete(t) {
        Ze("WriteBatch.delete", arguments, 1), this.Af();
        const e = $i("WriteBatch.delete", t, this.wf);
        return this.If = this.If.concat(new Tt(e.ia, ct.dt())), this;
    }
    commit() {
        return this.Af(), this.Rf = !0, this.If.length > 0 ? this.wf.tf().write(this.If) : Promise.resolve();
    }
    Af() {
        if (this.Rf) throw new m(E.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class pi {
    constructor(t, e, s) {
        this.ia = t, this.firestore = e, this.mf = s, this.ef = this.firestore.tf();
    }
    static df(t, e, s) {
    ...
    get parent() {
        return new Ci(this.ia.path.k(), this.firestore, this.mf);
    }
    get path() {
    ...
    collection(t) {
        ...
        const e = b.G(t);
        return new Ci(this.ia.path.child(e), this.firestore);
    }
    isEqual(t) {
        if (!(t instanceof pi)) throw fs("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.ia.isEqual(t.ia) && this.mf === t.mf;
    }
    set(t, e) {
        es("DocumentReference.set", arguments, 1, 2), e = Di("DocumentReference.set", e);
        const [s, i] = ki(this.mf, t, "DocumentReference.set"), n = e.merge || e.mergeFields ? this.firestore.af.Jo(i, s, e.mergeFields) : this.firestore.af.Yo(i, s);
        return this.ef.write(n.Qo(this.ia, ct.dt()));
    }
    update(t, e, ...s) {
        let i;
        ...
        i = this.firestore.af.Zo("DocumentReference.update", t)), this.ef.write(i.Qo(this.ia, ct.exists(!0)));
    }
    delete() {
        return Ze("DocumentReference.delete", arguments, 0), this.ef.write([ new Tt(this.ia, ct.dt()) ]);
    }
    onSnapshot(...t) {
    ...
    Pf(t, e) {
        ...
        const i = new wi({
            next: t => {
                if (e.next) {
                    const s = t.docs.get(this.ia);
                    e.next(new gi(this.firestore, this.ia, s, t.fromCache, t.hasPendingWrites, this.mf));
                }
            },
            error: s
        }), n = this.ef.listen(yt.Wt(this.ia.path), i, t);
        return () => {
            i.Q_(), this.ef.bu(n);
        };
    }
    get(t) {
        ...
        new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.tf().x_(this.ia).then(t => {
                e(new gi(this.firestore, this.ia, t, 
                /*fromCache=*/ !0, t instanceof At && t.At, this.mf));
            }, s) : this.Vf(e, s, t);
        });
    }
    Vf(t, e, s) {
    ...
    withConverter(t) {
        return new pi(this.ia, this.firestore, t);
    }
}
...
class gi {
    constructor(t, e, s, i, n, r) {
        this.wf = t, this.ia = e, this.pf = s, this.yf = i, this.gf = n, this.mf = r;
    }
    data(t) {
        ...
        this.pf) {
            ...
            if (this.mf) {
                const e = new bi(this.wf, this.ia, this.pf, this.yf, this.gf);
                return this.mf.fromFirestore(e, t);
            }
            return new mi(this.wf, this.wf.Tf(), t.serverTimestamps, 
    ...
    get(t, e) {
        ...
        this.pf) {
            const s = this.pf.data().field(qs("DocumentSnapshot.get", t));
            if (null !== s) {
                return new mi(this.wf, this.wf.Tf(), e.serverTimestamps, this.mf).j_(s);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new pi(this.ia, this.wf, this.mf);
    }
    get exists() {
        return null !== this.pf;
    }
    get metadata() {
        return new yi(this.gf, this.yf);
    }
    isEqual(t) {
        if (!(t instanceof gi)) throw fs("isEqual", "DocumentSnapshot", 1, t);
        return this.wf === t.wf && this.yf === t.yf && this.ia.isEqual(t.ia) && (null === this.pf ? null === t.pf : this.pf.isEqual(t.pf)) && this.mf === t.mf;
    }
}
...
class vi {
    constructor(t, e, s) {
        this.bf = t, this.firestore = e, this.mf = s;
    }
    where(t, e, s) {
        ...
        if (r.Y()) {
            ...
            if ("in" /* IN */ === i) {
                this.vf(s, i);
                const t = [];
                for (const e of s) t.push(this.Sf(e));
                n = {
                    arrayValue: {
                        values: t
                    }
        ...
        } else "in" /* IN */ !== i && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== i || this.vf(s, i), 
        n = this.firestore.af.ea("Query.where", s, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === i);
        const h = gt.create(r, i, n);
        return this.Cf(h), new vi(this.bf.Ht(h), this.firestore, this.mf);
    }
    orderBy(t, e) {
        let s;
        ...
        if (null !== this.bf.startAt) throw new m(E.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.bf.endAt) throw new m(E.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        const i = qs("Query.orderBy", t), n = new Nt(i, s);
        return this.Df(n), new vi(this.bf.Kt(n), this.firestore, this.mf);
    }
    limit(t) {
        return Ze("Query.limit", arguments, 1), ss("Query.limit", "number", 1, t), ds("Query.limit", 1, t), 
        new vi(this.bf.zt(t), this.firestore, this.mf);
    }
    limitToLast(t) {
        return Ze("Query.limitToLast", arguments, 1), ss("Query.limitToLast", "number", 1, t), 
        ds("Query.limitToLast", 1, t), new vi(this.bf.Yt(t), this.firestore, this.mf);
    }
    startAt(t, ...e) {
        ts("Query.startAt", arguments, 1);
        const s = this.Ff("Query.startAt", t, e, 
        /*before=*/ !0);
        return new vi(this.bf.Xt(s), this.firestore, this.mf);
    }
    startAfter(t, ...e) {
        ts("Query.startAfter", arguments, 1);
        const s = this.Ff("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new vi(this.bf.Xt(s), this.firestore, this.mf);
    }
    endBefore(t, ...e) {
        ts("Query.endBefore", arguments, 1);
        const s = this.Ff("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new vi(this.bf.Jt(s), this.firestore, this.mf);
    }
    endAt(t, ...e) {
        ts("Query.endAt", arguments, 1);
        const s = this.Ff("Query.endAt", t, e, 
        /*before=*/ !1);
        return new vi(this.bf.Jt(s), this.firestore, this.mf);
    }
    isEqual(t) {
        if (!(t instanceof vi)) throw fs("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && this.bf.isEqual(t.bf);
    }
    withConverter(t) {
        return new vi(this.bf, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    Ff(t, e, s, i) {
     ...
     */    Nf(t, e) {
        ...
        // results.
                for (const e of this.bf.orderBy) if (e.field.Y()) s.push(Y(this.firestore.sa, t.key)); else {
     ...
     */    $f(t, e, s) {
        ...
        for (let s = 0; s < e.length; s++) {
            ...
            if (i[s].field.Y()) {
                ...
                if (!this.bf.le() && -1 !== r.indexOf("/")) throw new m(E.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), " + `the value passed to ${t}() must be a plain document ID, but ` + `'${r}' contains a slash.`);
                const e = this.bf.path.child(b.G(r));
                ...
                const s = new C(e);
                n.push(Y(this.firestore.sa, s));
            } else {
                const e = this.firestore.af.ea(t, r);
                n.push(e);
            }
        }
        return new Ft(n, s);
    ...
    Pf(t, e) {
        ...
        const i = new wi({
            next: t => {
                e.next && e.next(new Si(this.firestore, this.bf, t, this.mf));
            },
            error: s
        }), n = this.firestore.tf(), r = n.listen(this.bf, i, t);
        return () => {
            i.Q_(), n.bu(r);
        };
    }
    Lf(t) {
        if (t.ae() && 0 === t.qt.length) throw new m(E.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }
    get(t) {
        return es("Query.get", arguments, 0, 1), Ni("Query.get", t), this.Lf(this.bf), new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.tf().B_(this.bf).then(t => {
                e(new Si(this.firestore, this.bf, t, this.mf));
            }, s) : this.Vf(e, s, t);
        });
    }
    Vf(t, e, s) {
     ...
     */    Sf(t) {
        if ("string" == typeof t) {
            ...
            if (!this.bf.le() && -1 !== t.indexOf("/")) throw new m(E.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but " + `'${t}' contains a '/' character.`);
            const e = this.bf.path.child(b.G(t));
            ...
            return Y(this.firestore.sa, new C(e));
        }
        if (t instanceof pi) {
            const e = t;
            return Y(this.firestore.sa, e.ia);
        }
    ...
    Cf(t) {
        if (t instanceof gt) {
            ...
            if (t.ue()) {
                ...
                let r = null;
                if (n && (r = this.bf.ce(s)), null === r && i && (r = this.bf.ce(e)), null != r) 
...
class Si {
    constructor(t, e, s, i) {
        this.wf = t, this.Of = e, this.Mf = s, this.mf = i, this.qf = null, this.xf = null, 
    ...
    forEach(t, e) {
        ...
        this.Mf.docs.forEach(s => {
            t.call(e, this.Bf(s));
        });
    }
    get query() {
        return new vi(this.Of, this.wf, this.mf);
    }
    docChanges(t) {
        ...
        if (e && this.Mf.hs) throw new m(E.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        ...
        return this.wf === t.wf && this.Of.isEqual(t.Of) && this.Mf.isEqual(t.Mf) && this.mf === t.mf;
    }
    Bf(t) {
        return new bi(this.wf, t.key, t, this.metadata.fromCache, this.Mf.ns.has(t.key), this.mf);
    }
}

class Ci extends vi {
    constructor(t, e, s) {
        if (super(yt.Wt(t), e, s), this.Uf = t, t.length % 2 != 1) throw new m(E.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + `${t.j()} has ${t.length}`);
    }
    get id() {
        return this.bf.path.M();
    }
    get parent() {
        const t = this.bf.path.k();
        return t.q() ? null : new pi(new C(t), this.firestore);
    }
    get path() {
    ...
    doc(t) {
        ...
        const e = b.G(t);
        return pi.df(this.bf.path.child(e), this.firestore, this.mf);
    }
    add(t) {
        Ze("CollectionReference.add", arguments, 1), ss("CollectionReference.add", "object", 1, this.mf ? this.mf.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new Ci(this.Uf, this.firestore, t);
    }
}
...
const Mi = Oi(Ai, "Use firebase.firestore() instead."), qi = Oi(Pi, "Use firebase.firestore().runTransaction() instead."), xi = Oi(Vi, "Use firebase.firestore().batch() instead."), Bi = Oi(pi, "Use firebase.firestore().doc() instead."), Ui = Oi(gi), Qi = Oi(bi), Wi = Oi(vi), ji = Oi(Si), Gi = Oi(Ci, "Use firebase.firestore().collection() instead."), Hi = Oi(class {
    static delete() {
...
class Xi {
    constructor() {
        this.Qf = () => this.Wf(), this.jf = () => this.Gf(), this.Hf = [], this.Kf();
    }
    ou(t) {
        this.Hf.push(t);
    }
    ...
    Wf() {
        ...
        for (const t of this.Hf) t(0 /* AVAILABLE */);
    }
    Gf() {
        Pe("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (const t of this.Hf) t(1 /* UNAVAILABLE */);
    }
...
class en {
    ...
    La(t, e, s) {
        ...
        return new Promise((n, r) => {
            ...
            this.hd(u, s), h.send(i, "POST", a, u, 15);
        });
    }
    ka(t, e, s) {
    ...
    pa(t, e) {
        const s = [ this.rd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], u = f(), c = {
        ...
        this.hd(c.initMessageHeaders, e), 
        ...
        // enough the code is exception free.
            ...
            w || (w = !0, Pe("Connection", "WebChannel transport closed"), I.sd());
        }), R(d.EventType.ERROR, t => {
            w || (w = !0, Pe("Connection", "WebChannel transport errored:", t), I.sd(new m(E.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!w) {
                ...
                if (n) {
                    ...
                    w = !0, I.sd(new m(e, s)), _.close();
                } else Pe("Connection", "WebChannel received:", s), I.nd(s);
            }
        }), setTimeout(() => {
 ...
 */
    ...
    }(t, (t, e) => new Ai(t, e, new di)), t.registerVersion("@firebase/firestore", "1.14.3");
}
