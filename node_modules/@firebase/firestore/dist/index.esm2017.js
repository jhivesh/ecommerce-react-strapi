...
/** Extracts the backend's type order for the provided value. */ function U(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? O(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : be();
}
 ...
 */ class bt {
    ...
    constructor(t, e = null, s = [], i = [], n = null, r = "F" /* First */ , h = null, o = null) {
        this.path = t, this.collectionGroup = e, this.Ot = s, this.filters = i, this.limit = n, 
    ...
    get orderBy() {
        if (null === this.qt) {
            ...
            t.Y() || this.qt.push(new $t(t)), this.qt.push(new $t(D.J(), "asc" /* ASCENDING */)); else {
                let t = !1;
                for (const e of this.Ot) this.qt.push(e), e.field.Y() && (t = !0);
                if (!t) {
                    // The order of the implicit key ordering always matches the last
                    // explicit order by
                    const t = this.Ot.length > 0 ? this.Ot[this.Ot.length - 1].dir : "asc" /* ASCENDING */;
    ...
    Gt(t) {
        ...
        return new bt(this.path, this.collectionGroup, this.Ot.slice(), e, this.limit, this.Bt, this.startAt, this.endAt);
    }
    zt(t) {
        // TODO(dimond): validate that orderBy does not list the same key twice.
        const e = this.Ot.concat([ t ]);
        return new bt(this.path, this.collectionGroup, e, this.filters.slice(), this.limit, this.Bt, this.startAt, this.endAt);
    }
    Ht(t) {
        return new bt(this.path, this.collectionGroup, this.Ot.slice(), this.filters.slice(), t, "F" /* First */ , this.startAt, this.endAt);
    }
    Yt(t) {
        return new bt(this.path, this.collectionGroup, this.Ot.slice(), this.filters.slice(), t, "L" /* Last */ , this.startAt, this.endAt);
    }
    Jt(t) {
        return new bt(this.path, this.collectionGroup, this.Ot.slice(), this.filters.slice(), this.limit, this.Bt, t, this.endAt);
    }
    Xt(t) {
        return new bt(this.path, this.collectionGroup, this.Ot.slice(), this.filters.slice(), this.limit, this.Bt, this.startAt, t);
    }
    /**
 ...
 *     Code.UNKNOWN.
 */ (Ot = xt || (xt = {}))[Ot.OK = 0] = "OK", Ot[Ot.CANCELLED = 1] = "CANCELLED", 
...
class Wt {
    ...
    Le() {
        ...
        let t = this;
        return t.left.xe() || t.left.left.xe() || (t = t.Oe()), t = t.Ae(null, null, null, t.left.Le(), null), 
        t.Me();
    }
    // Returns new tree, with the specified item removed.
    remove(t, e) {
        let s, i = this;
        if (e(t, i.key) < 0) i.left.B() || i.left.xe() || i.left.left.xe() || (i = i.Oe()), 
    ...
    Oe() {
        let t = this.Qe();
        return t.right.left.xe() && (t = t.Ae(null, null, null, null, t.right.Be()), t = t.Ue(), 
        t = t.Qe()), t;
    }
    qe() {
        let t = this.Qe();
        return t.left.left.xe() && (t = t.Be(), t = t.Qe()), t;
    }
    Ue() {
    ...
    je() {
        if (this.xe() && this.left.xe()) throw be();
        if (this.right.xe()) throw be();
...
class de {
     ...
     */    Xs(t) {
        ...
        this.Ls.forEach((s, i) => {
            ...
            if (n) {
                if (s.fs && n.target.xt()) {
                    ...
                    null !== this.xs.get(e) || this.Zs(i, e) || this.Qs(i, e, new gt(e, t));
                }
        ...
        const i = new oe(t, e, this.Bs, this.xs, s);
        return this.xs = zt(), this.Os = fe(), this.Bs = new jt(Ce), i;
    }
    /**
    ...
    Us(t, e) {
        ...
        this.Ks(t).Cs(e.key, s), this.xs = this.xs.me(e.key, e), this.Os = this.Os.me(e.key, this.ti(e.key).add(t));
    }
    /**
    ...
    Qs(t, e, s) {
        ...
        i.Fs(e), this.Os = this.Os.me(e, this.ti(e).delete(t)), s && (this.xs = this.xs.me(e, s));
    }
    removeTarget(t) {
        this.Ls.delete(t);
    }
    ...
    ti(t) {
        let e = this.Os.get(t);
        return e || (e = new jt(Ce), this.Os = this.Os.me(t, e)), e;
    }
    /**
 ...
 */ class Oe {
    constructor() {
        ...
        this.mn = new jt(Be.An), 
        // A set of outstanding references to a document sorted by target id.
        this.Pn = new jt(Be.Vn);
    }
    /** Returns true if the reference set contains no references. */    B() {
        return this.mn.B();
    }
    /** Adds a reference to the given document key for the given ID. */    gn(t, e) {
        const s = new Be(t, e);
        this.mn = this.mn.add(s), this.Pn = this.Pn.add(s);
    }
    /** Add references to the given document keys for the given ID. */    pn(t, e) {
        t.forEach(t => this.gn(t, e));
    }
    /**
    ...
    vn(t, e) {
        t.forEach(t => this.yn(t, e));
    }
    /**
     * Clears all references with a given ID. Calls removeRef() for each key
     * removed.
     */    Sn(t) {
        const e = C.EMPTY, s = new Be(e, t), i = new Be(e, t + 1), n = [];
        return this.Pn.Ke([ s, i ], t => {
            this.bn(t), n.push(t.key);
        }), n;
    }
    Dn() {
        this.mn.forEach(t => this.bn(t));
    }
    bn(t) {
        this.mn = this.mn.delete(t), this.Pn = this.Pn.delete(t);
    }
    Cn(t) {
        const e = C.EMPTY, s = new Be(e, t), i = new Be(e, t + 1);
        let n = ee();
        return this.Pn.Ke([ s, i ], t => {
            n = n.add(t.key);
        }), n;
    ...
    Fn(t) {
        const e = new Be(t, 0), s = this.mn.ze(e);
...
class Be {
    ...
    /** Compare by key then by ID */    static An(t, e) {
        return C.N(t.key, e.key) || Ce(t.Nn, e.Nn);
    }
    /** Compare by ID then by key */    static Vn(t, e) {
        return Ce(t.Nn, e.Nn) || C.N(t.key, e.key);
    }
}
 ...
 */ class qe {
    constructor(t) {
        ...
        // chaining.
        this.Ln = !1, t(t => {
            this.Mn = !0, this.result = t, this.kn && 
            // value should be defined unless T is Void, but we can't express
            // that in the type system.
            this.kn(t);
        }, t => {
            this.Mn = !0, this.error = t, this.$n && this.$n(t);
        });
    }
    catch(t) {
    ...
    next(t, e) {
        return this.Ln && be(), this.Ln = !0, this.Mn ? this.error ? this.xn(e, this.error) : this.On(t, this.result) : new qe((s, i) => {
            this.kn = e => {
                this.On(t, e).next(s, i);
            }, this.$n = t => {
    ...
    On(t, e) {
        return t ? this.qn(() => t(e)) : qe.resolve(e);
    }
    xn(t, e) {
        return t ? this.qn(() => t(e)) : qe.reject(e);
    }
    static resolve(t) {
        return new qe((e, s) => {
            e(t);
 ...
 */ class Ue {
    constructor() {
        ...
        this.Wn = new Me(t => t.toString()), this.jn = !1;
    }
    set readTime(t) {
        this.Kn = t;
    }
     ...
     */    Yn(t, e) {
        ...
        return void 0 !== s ? qe.resolve(s) : this.Jn(t, e);
    }
    /**
    ...
    /** Helper to assert this.changes is not null  */    zn() {}
}
 ...
 */ class je {
     ...
     * state for it.
     */    hr(t, e) {
        return this.nr.or(t, e).next(s => this.ar(t, e, s));
    }
    /** Internal version of `getDocument` that allows reusing batches. */    ar(t, e, s) {
        return this.ir.Yn(t, e).next(t => {
     ...
     */    cr(t, e) {
        return this.ir.getEntries(t, e).next(e => this._r(t, e));
    }
    /**
     * Similar to `getDocuments`, but creates the local view from the given
     * `baseDocs` without retrieving documents from the local store.
     */    _r(t, e) {
        return this.nr.lr(t, e).next(s => {
            const i = this.ur(t, e, s);
            let n = zt();
     ...
     */    dr(t, e, s) {
        return e.xt() ? this.Tr(t, e.path) : e._e() ? this.Er(t, e, s) : this.Ir(t, e, s);
    }
    Tr(t, e) {
        // Just do a simple document lookup.
        return this.hr(t, new C(e)).next(t => {
            let e = Jt();
    ...
    Er(t, e, s) {
        ...
        let n = Jt();
        return this.rr.wr(t, i).next(r => qe.forEach(r, r => {
            const h = e.Zt(r.child(i));
            return this.Ir(t, h, s).next(t => {
                t.forEach((t, e) => {
                    n = n.me(t, e);
                });
            });
    ...
    Ir(t, e, s) {
        ...
        let i, n;
        return this.ir.dr(t, e, s).next(s => (i = s, this.nr.Rr(t, e))).next(e => (n = e, 
        this.mr(t, n, i).next(t => {
            i = t;
    ...
    mr(t, e, s) {
        ...
        let n = s;
        return this.ir.getEntries(t, i).next(t => (t.forEach((t, e) => {
 ...
 */ class Ke {
    constructor(t, e, s, i) {
        this.targetId = t, this.fromCache = e, this.Ar = s, this.Pr = i;
    }
    static Vr(t, e) {
        let s = ee(), i = ee();
 ...
 */ class Ge {
    constructor(t, e) {
        this.previousValue = t, e && (e.gr = t => this.pr(t), this.yr = t => e.br(t));
    }
    pr(t) {
...
class He {
     ...
     */ , n = 6e4) {
        this.Sr = t, this.Dr = e, this.Cr = s, this.Fr = i, this.Nr = n, this.kr = 0, this.$r = null, 
     ...
     */    xr(t) {
        ...
        // honored as such).
        const e = Math.floor(this.kr + this.Or()), s = Math.max(0, Date.now() - this.Mr), i = Math.max(0, e - s);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && ge("ExponentialBackoff", `Backing off for ${i} ms ` + `(base delay: ${this.kr} ms, ` + `delay with jitter: ${e} ms, ` + `last attempt: ${s} ms ago)`), 
        this.$r = this.Sr.Br(this.Dr, i, () => (this.Mr = Date.now(), t())), 
    ...
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */    Or() {
...
class Ye {
    constructor(t, e, s, i, n) {
        this.qr = t, this.Dr = e, this.Ur = s, this.op = i, this.Qr = n, this.Wr = new ze, 
     ...
     */    static jr(t, e, s, i, n) {
        const r = Date.now() + s, h = new Ye(t, e, r, i, n);
        return h.start(s), h;
    }
    /**
     ...
     */    cancel(t) {
        null !== this.Kr && (this.clearTimeout(), this.Wr.reject(new R(w.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Gr() {
        this.qr.Hr(() => null !== this.Kr ? (this.clearTimeout(), this.op().then(t => this.Wr.resolve(t))) : Promise.resolve());
    }
    clearTimeout() {
...
class Je {
    constructor() {
        ...
        this.ih = new He(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.nh = () => {
            // eslint-disable-next-line @typescript-eslint/no-floating-promises
            this.rh("async_queue_retry" /* AsyncQueueRetry */);
        };
        const t = me.nt().window;
        t && "function" == typeof t.addEventListener && t.addEventListener("visibilitychange", this.nh);
    }
     ...
     */    async lh(t) {
        if (this.ah(), !this.Xr) {
            ...
            e && e.removeEventListener("visibilitychange", this.nh), await this._h(t);
        }
    }
    /**
     ...
     */    enqueue(t) {
        return this.ah(), this.Xr ? new Promise(t => {}) : this.uh(t);
    }
    /**
     ...
     */    dh(t) {
        this.ah(), this.Xr || (this.Jr = this.Jr.then(() => {
            const e = new ze, s = async () => {
                try {
                    await t(), e.resolve(), this.ih.reset();
                } catch (t) {
 ...
 // Failure will be handled by AsyncQueue
            ...
            return this.Hr(s), e.promise;
        }));
    }
    uh(t) {
        const e = this.Yr.then(() => (this.eh = !0, t().catch(t => {
            // Re-throw the error so that this.tail becomes a rejected Promise and
            // all further attempts to chain (via .then) will just short-circuit
            // and return the rejected Promise.
            throw this.th = t, this.eh = !1, pe("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
            t;
        }).then(t => (this.eh = !1, t))));
        return this.Yr = e, e;
    }
     ...
     */    Br(t, e, s) {
        ...
        const i = Ye.jr(this, t, e, s, t => this.fh(t));
     ...
     * exists.
     */    Ih(t) {
        for (const e of this.Zr) if (e.Dr === t) return !0;
        return !1;
    }
    /**
     ...
     */    rh(t) {
        ...
        return this.Eh().then(() => {
            ...
            this.Zr.sort((t, e) => t.Ur - e.Ur);
            for (const e of this.Zr) if (e.zr(), "all" /* All */ !== t && e.Dr === t) break;
            return this.Eh();
        });
    }
    /**
    ...
    /** Called once a DelayedOperation is run or canceled. */    fh(t) {
 ...
 */ class Ze {
    constructor(t) {
        this.Rh = t, this.buffer = new jt(Xe), this.mh = 0;
    }
    Ah() {
        return ++this.mh;
    }
    Ph(t) {
        ...
        if (this.buffer.size < this.Rh) this.buffer = this.buffer.add(e); else {
            ...
            Xe(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
...
class es {
    ...
    s) {
        this.bh = t, this.vh = e, this.Sh = s;
    }
    static Dh(t) {
        return new es(t, es.Ch, es.Fh);
    }
}

es.Nh = -1, es.kh = 1048576, es.$h = 41943040, es.Ch = 10, es.Fh = 1e3, es.Mh = new es(es.$h, es.Ch, es.Fh), 
es.DISABLED = new es(es.Nh, 0, 0);
...
class ss {
    ...
    qh(t) {
        const e = this.xh ? 3e5 : 6e4;
        ge("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Oh = this.qr.Br("lru_garbage_collection" /* LruGarbageCollection */ , e, async () => {
            this.Oh = null, this.xh = !0;
            try {
                await t.Qh(this.Lh);
            } catch (t) {
                "IndexedDbTransactionError" === t.name ? ge("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await _i(t);
            }
            await this.qh(t);
        });
    }
...
/** Implements the steps for LRU garbage collection. */ class is {
    ...
    /** Given a percentile of target to collect, returns the number of targets to collect. */    jh(t, e) {
        return this.Wh.Kh(t).next(t => Math.floor(e / 100 * t));
    }
    /** Returns the nth sequence number, counting in order from the smallest. */    Gh(t, e) {
        if (0 === e) return qe.resolve(Ge.vr);
        const s = new Ze(e);
        return this.Wh.js(t, t => s.Ph(t.sequenceNumber)).next(() => this.Wh.zh(t, t => s.Ph(t))).next(() => s.maxValue);
    }
    /**
     * Removes targets with a sequence number equal to or less than the given upper bound, and removes
     * document associations with those targets.
     */    Hh(t, e, s) {
        return this.Wh.Hh(t, e, s);
    }
    /**
    ...
    Jh(t, e) {
        return this.Bh.bh === es.Nh ? (ge("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        qe.resolve(ts)) : this.Xh(t).next(s => s < this.Bh.bh ? (ge("LruGarbageCollector", `Garbage collection skipped; Cache size ${s} ` + `is lower than threshold ${this.Bh.bh}`), 
        ts) : this.Zh(t, e));
    }
    Xh(t) {
        return this.Wh.Xh(t);
    ...
    Zh(t, e) {
        let i, n, r, h, o, a, u;
        const c = Date.now();
        return this.jh(t, this.Bh.vh).next(e => (
        // Cap at the configured max
        e > this.Bh.Sh ? (ge("LruGarbageCollector", "Capping sequence numbers to collect down " + `to the maximum of ${this.Bh.Sh} ` + `from ${e}`), 
        n = this.Bh.Sh) : n = e, h = Date.now(), this.Gh(t, n))).next(s => (i = s, o = Date.now(), 
        this.Hh(t, i, e))).next(e => (r = e, a = Date.now(), this.Yh(t, i))).next(t => {
...
function ns(t) {
    let e = "";
    for (let s = 0; s < t.length; s++) e.length > 0 && (e = hs(e)), e = rs(t.get(s), e);
    return hs(e);
}
...
class as {
    constructor(t) {
        ...
        // log on 12.2.
        12.2 === as.to(i()) && pe("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /**
     ...
     * objectstores.
     */    static eo(t, e, s) {
        return ge("SimpleDb", "Opening database:", t), new qe((i, n) => {
            ...
            r.onsuccess = t => {
                ...
                s.createOrUpgrade(i, r.transaction, e.oldVersion, $s).next(() => {
                    ge("SimpleDb", "Database upgrade to version " + $s + " complete");
                });
            };
        }).Bn();
    }
    /** Deletes the specified database. */    static delete(t) {
        return ge("SimpleDb", "Removing database:", t), ds(window.indexedDB.deleteDatabase(t)).Bn();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static so() {
        ...
        // Check the UA string to find out the browser.
                const t = i(), e = as.to(t), s = 0 < e && e < 10, n = as.no(t), r = 0 < n && n < 4.5;
        // IE 10
    ...
    /** Helper to get a typed SimpleDbStore from a transaction. */    static ho(t, e) {
        return t.store(e);
    }
    // visible for testing
    ...
    async runTransaction(t, e, s) {
        ...
        for (;;) {
            ++n;
            const t = _s.open(this.db, i ? "readonly" : "readwrite", e);
            try {
                const e = s(t).catch(e => (
                // Abort the transaction if there was an error.
                t.abort(e), qe.reject(e))).Bn();
 ...
 */ class us {
     ...
     */    delete() {
        return ds(this.uo.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class cs extends R {
    constructor(t) {
 ...
 */ class _s {
    constructor(t) {
         ...
         */
        this.fo = new ze, this.transaction.oncomplete = () => {
            this.fo.resolve();
        }, this.transaction.onabort = () => {
            t.error ? this.fo.reject(new cs(t.error)) : this.fo.resolve();
        }, this.transaction.onerror = t => {
            const e = Ts(t.target.error);
            this.fo.reject(new cs(e));
        };
    }
    static open(t, e, s) {
        return new _s(t.transaction(s, e));
    }
    get ao() {
        return this.fo.promise;
    }
    abort(t) {
        t && this.fo.reject(t), this.aborted || (ge("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class ls {
     ...
     */    add(t) {
        return ge("SimpleDb", "ADD", this.store.name, t, t), ds(this.store.add(t));
    }
    /**
    ...
    delete(t) {
        return ge("SimpleDb", "DELETE", this.store.name, t), ds(this.store.delete(t));
    }
    /**
     ...
     */    count() {
        return ge("SimpleDb", "COUNT", this.store.name), ds(this.store.count());
    }
    To(t, e) {
        const s = this.cursor(this.options(t, e)), i = [];
        return this.Eo(s, (t, e) => {
            i.push(e);
        }).next(() => i);
    }
    Io(t, e) {
        ...
        return this.Eo(i, (t, e, s) => s.delete());
    }
    Ro(t, e) {
        let s;
        e ? s = t : (s = {}, e = t);
    ...
    Eo(t, e) {
        ...
        return new qe((i, n) => {
            t.onerror = t => {
                ...
                if (!n) return void i();
                const r = new us(n), h = e(n.primaryKey, n.value, r);
                if (h instanceof qe) {
                    const t = h.catch(t => (r.done(), qe.reject(t)));
                    s.push(t);
                }
                r.Mn ? i() : null === r.lo ? n.continue() : n.continue(r.lo);
            };
        }).next(() => qe.Un(s));
    }
    options(t, e) {
    ...
    cursor(t) {
        ...
        if (t.reverse && (e = "prev"), t.index) {
            ...
            return t.wo ? s.openKeyCursor(t.range, e) : s.openCursor(t.range, e);
        }
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ class Es {
    constructor(
    /**
     ...
     */
    t, e, s, i) {
        this.userId = t, this.serializer = e, this.rr = s, this.Ao = i, 
        /**
    ...
    yo(t, e, s) {
        return this.bo(t).next(e => (
        // We can't store the resumeToken as a ByteString in IndexedDB, so we
        // convert it to a Base64 string for storage.
        e.lastStreamToken = s.toBase64(), As(t).put(e)));
    }
    vo(t) {
        return this.bo(t).next(t => $.fromBase64String(t.lastStreamToken));
    }
    So(t, e) {
        return this.bo(t).next(s => (
        // We can't store the resumeToken as a ByteString in IndexedDB, so we
        // convert it to a Base64 string for storage.
        s.lastStreamToken = e.toBase64(), As(t).put(s)));
    }
    Do(t, e, s, i) {
        const n = ms(t), r = Rs(t);
        ...
        return r.add({}).next(h => {
            ve("number" == typeof h);
            const o = new Le(h, e, s, i), a = this.serializer.Co(this.userId, o), u = [];
            let c = new jt((t, e) => Ce(t.j(), e.j()));
            for (const t of i) {
                const e = qs.key(this.userId, t.key.path, h);
                c = c.add(t.key.path.M()), u.push(r.put(a)), u.push(n.put(e, qs.PLACEHOLDER));
            }
            return c.forEach(e => {
                u.push(this.rr.Fo(t, e));
            }), t.er(() => {
                this.Po[h] = o.keys();
            }), qe.Un(u).next(() => o);
        });
    ...
    No(t, e) {
        return Rs(t).get(e).next(t => t ? (ve(t.userId === this.userId), this.serializer.ko(t)) : null);
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    $o(t, e) {
        return this.Po[e] ? qe.resolve(this.Po[e]) : this.No(t, e).next(t => {
            if (t) {
                const s = t.keys();
                return this.Po[e] = s, s;
            }
            return null;
        });
    }
    Mo(t, e) {
        ...
        return Rs(t).Ro({
            ...
            e.userId === this.userId && (ve(e.batchId >= s), n = this.serializer.ko(e)), i.done();
        }).next(() => n);
    }
    Lo(t) {
    ...
    xo(t) {
        ...
        return Rs(t).To(Bs.userMutationsIndex, e).next(t => t.map(t => this.serializer.ko(t)));
    }
    or(t, e) {
        ...
        return ms(t).Ro({
            ...
            return Rs(t).get(a).next(t => {
                if (!t) throw be();
                ve(t.userId === this.userId), n.push(this.serializer.ko(t));
            });
            r.done();
        }).next(() => n);
    }
    lr(t, e) {
        ...
        const i = [];
        return e.forEach(e => {
            const n = qs.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(n), h = ms(t).Ro({
                range: r
            }, (t, i, n) => {
                const [r, h, o] = t, a = os(h);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
    ...
    Oo(t, e) {
        ...
        return e.forEach(e => {
            i.push(Rs(t).get(e).next(t => {
                if (null === t) throw be();
                ve(t.userId === this.userId), s.push(this.serializer.ko(t));
            }));
        }), qe.Un(i).next(() => s);
    }
    Bo(t, e) {
        return ws(t.qo, this.userId, e).next(s => (t.er(() => {
            this.Uo(e.batchId);
        }), qe.forEach(s, e => this.Ao.Qo(t, e))));
    }
    /**
    ...
    Fn(t, e) {
        return Is(t, this.userId, e);
    }
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    bo(t) {
        return As(t).get(this.userId).next(t => t || new Os(this.userId, -1, 
        /*lastStreamToken=*/ ""));
    }
}
 ...
 */
function ws(t, e, s) {
    const i = t.store(Bs.store), n = t.store(qs.store), r = [], h = IDBKeyRange.only(s.batchId);
    let o = 0;
    const a = i.Ro({
        range: h
    }, (t, e, s) => (o++, s.delete()));
    ...
    return qe.Un(r).next(() => u);
}

/**
 * Helper to get a typed SimpleDbStore for the mutations object store.
 */ function Rs(t) {
    return ni.ho(t, Bs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function ms(t) {
    return ni.ho(t, qs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function As(t) {
    return ni.ho(t, Os.store);
}
 ...
 */ class Vs {
    ...
    zo(t) {
        return this.Ho(t).next(e => {
            const s = new Ps(e.highestTargetId);
            return e.highestTargetId = s.next(), this.Yo(t, e).next(() => e.highestTargetId);
        });
    }
    Jo(t) {
        return this.Ho(t).next(t => y.v(new p(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds)));
    }
    Xo(t) {
        return ys(t.qo);
    }
    Zo(t, e, s) {
        return this.Ho(t).next(i => (i.highestListenSequenceNumber = e, s && (i.lastRemoteSnapshotVersion = s.C()), 
        e > i.highestListenSequenceNumber && (i.highestListenSequenceNumber = e), this.Yo(t, i)));
    }
    ta(t, e) {
        return this.ea(t, e).next(() => this.Ho(t).next(s => (s.targetCount += 1, this.sa(e, s), 
        this.Yo(t, s))));
    }
    ia(t, e) {
        return this.ea(t, e);
    ...
    na(t, e) {
        return this.ra(t, e.targetId).next(() => gs(t).delete(e.targetId)).next(() => this.Ho(t)).next(e => (ve(e.targetCount > 0), 
        e.targetCount -= 1, this.Yo(t, e)));
    }
    /**
     ...
     */    Hh(t, e, s) {
        ...
        const n = [];
        return gs(t).Ro((r, h) => {
            const o = this.serializer.ha(h);
            o.sequenceNumber <= e && null === s.get(o.targetId) && (i++, n.push(this.na(t, o)));
        }).next(() => qe.Un(n)).next(() => i);
    }
    /**
    ...
    Yo(t, e) {
        return (s = t, ni.ho(s, zs.store)).put(zs.key, e);
        /**
 ...
 */
    ...
    ea(t, e) {
        return gs(t).put(this.serializer.oa(e));
    }
    /**
    ...
    aa(t) {
        return this.Ho(t).next(t => t.targetCount);
    }
    ua(t, e) {
    ...
    ca(t, e, s) {
        ...
        return e.forEach(e => {
            const r = ns(e.path);
            i.push(n.put(new Gs(s, r))), i.push(this.Ao.gn(t, e));
        }), qe.Un(i);
    }
    _a(t, e, s) {
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        ...
        return qe.forEach(e, e => {
            const n = ns(e.path);
            return qe.Un([ i.delete([ s, n ]), this.Ao.yn(t, e) ]);
        });
    }
    ra(t, e) {
        const s = bs(t), i = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return s.delete(i);
    }
    la(t, e) {
        ...
        return i.Ro({
            ...
            const i = os(t[1]), r = new C(i);
            n = n.add(r);
        }).next(() => n);
    }
    Fn(t, e) {
        const s = ns(e.path), i = IDBKeyRange.bound([ s ], [ Ne(s) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let n = 0;
        return bs(t).Ro({
    ...
    // PORTING NOTE: Multi-tab only.
    si(t, e) {
        return gs(t).get(e).next(t => t ? this.serializer.ha(t) : null);
    }
}
 ...
 */ function gs(t) {
    return ni.ho(t, Ks.store);
}

function ps(t) {
    return as.ho(t, zs.store).get(zs.key).next(t => (ve(null !== t), t));
}

function ys(t) {
    return ps(t).next(t => t.highestListenSequenceNumber);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function bs(t) {
    return ni.ho(t, Gs.store);
}
 ...
 */ class vs {
     ...
     * cache's metadata.
     */    updateMetadata(t, e) {
        return this.getMetadata(t).next(s => (s.byteSize += e, this.da(t, s)));
    }
    Yn(t, e) {
        return Ds(t).get(Cs(e)).next(t => this.fa(t));
    }
    /**
     ...
     */    wa(t, e) {
        ...
        return this.Ia(t, e, (t, e) => {
            const n = this.fa(e);
            n ? (s = s.me(t, n), i = i.me(t, Fs(e))) : (s = s.me(t, null), i = i.me(t, 0));
        }).next(() => ({
            Ra: s,
            ma: i
        }));
    ...
    Va(t, e) {
        let s = zt(), i = this.serializer.Aa(e);
        const n = Ds(t), r = IDBKeyRange.lowerBound(i, !0);
        return n.Ro({
            ...
            const n = this.serializer.Pa(e);
            s = s.me(n.key, n), i = e.readTime;
        }).next(() => ({
            ga: s,
            readTime: this.serializer.pa(i)
        }));
    }
    /**
    ...
    ya(t) {
        ...
        return e.Ro({
            ...
            e.readTime && (s = this.serializer.pa(e.readTime)), i.done();
        }).next(() => s);
    }
    ba(t) {
        return new vs.va(this, !!t && t.Sa);
    }
    Da(t) {
        return this.getMetadata(t).next(t => t.byteSize);
    }
    getMetadata(t) {
        return Ss(t).get(js.key).next(t => (ve(!!t), t));
    }
    da(t, e) {
        return Ss(t).put(js.key, e);
    }
    /**
 ...
 */ function Ss(t) {
    return ni.ho(t, js.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Ds(t) {
    return ni.ho(t, Ws.store);
}
 ...
 */ vs.va = class extends Ue {
     ...
     */
    constructor(t, e) {
        super(), this.Ca = t, this.Sa = e, 
        // A map of document sizes prior to applying the changes in this buffer.
        this.Fa = new Me(t => t.toString());
    }
    Zn(t) {
        const e = [];
        let s = 0, i = new jt((t, e) => Ce(t.j(), e.j()));
        return this.Wn.forEach((n, r) => {
            const h = this.Fa.get(n);
            if (r) {
                const o = this.Ca.serializer.Na(r, this.readTime);
                i = i.add(n.path.M());
                const a = Fs(o);
                s += a - h, e.push(this.Ca.Gn(t, n, o));
            } else if (s -= h, this.Sa) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                const s = this.Ca.serializer.Na(new gt(n, y.min()), this.readTime);
                e.push(this.Ca.Gn(t, n, s));
            } else e.push(this.Ca.Hn(t, n));
        }), i.forEach(s => {
            e.push(this.Ca.rr.Fo(t, s));
        }), e.push(this.Ca.updateMetadata(t, s)), qe.Un(e);
    }
    Jn(t, e) {
        // Record the size of everything we load from the cache so we can compute a delta later.
        return this.Ca.Ta(t, e).next(t => null === t ? (this.Fa.set(e, 0), null) : (this.Fa.set(e, t.size), 
        t.Ea));
    }
    Xn(t, e) {
        // Record the size of everything we load from the cache so we can compute
        // a delta later.
        return this.Ca.wa(t, e).next(({Ra: t, ma: e}) => (
...
class Ns {
    ...
    Fo(t, e) {
        return this.ka.add(e), qe.resolve();
    }
    wr(t, e) {
        return qe.resolve(this.ka.getEntries(e));
    }
}
...
/** Performs database creation and schema upgrades. */ class Ms {
    constructor(t) {
        this.serializer = t;
    }
    /**
 ...
 */ (t));
        ...
        0 !== s && (!function(t) {
            t.deleteObjectStore(Gs.store), t.deleteObjectStore(Ks.store), t.deleteObjectStore(zs.store);
        }(t), Ys(t)), r = r.next(() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(zs.store), s = new zs(
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, y.min().C(), 
            /*targetCount=*/ 0);
            return e.put(zs.key, s);
        }
        /**
 ...
 */ (n))), s < 4 && i >= 4 && (0 !== s && (
        ...
        r = r.next(() => function(t, e) {
            return e.store(Bs.store).To().next(s => {
                t.deleteObjectStore(Bs.store), t.createObjectStore(Bs.store, {
                    keyPath: Bs.keyPath,
                    autoIncrement: !0
                }).createIndex(Bs.userMutationsIndex, Bs.userMutationsKeyPath, {
                    unique: !0
                });
                const i = e.store(Bs.store), n = s.map(t => i.put(t));
                return qe.Un(n);
            });
        }
        /**
 ...
 */ (e);
    ...
    addDocumentGlobal(t) {
        let e = 0;
        return t.store(Ws.store).Ro((t, s) => {
            e += Fs(s);
        }).next(() => {
            const s = new js(e);
            return t.store(js.store).put(js.key, s);
        });
    }
    removeAcknowledgedMutations(t) {
        const e = t.store(Os.store), s = t.store(Bs.store);
        return e.To().next(e => qe.forEach(e, e => {
            const i = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return s.To(Bs.userMutationsIndex, i).next(s => qe.forEach(s, s => {
                ve(s.userId === e.userId);
                const i = this.serializer.ko(s);
                return ws(t, e.userId, i).next(() => {});
            }));
        }));
    }
    /**
     ...
     */    ensureSequenceNumbers(t) {
        const e = t.store(Gs.store), s = t.store(Ws.store);
        return ys(t).next(t => {
            const i = [];
            return s.Ro((s, n) => {
 ...
 */ (r);
                i.push(e.get(h).next(s => s ? qe.resolve() : (s => e.put(new Gs(0, ns(s), t)))(r)));
            }).next(() => qe.Un(i));
        });
    }
    createCollectionParentIndex(t, e) {
        ...
        const s = e.store(Hs.store), i = new ks, n = t => {
            if (i.add(t)) {
                const e = t.O(), i = t.M();
                return s.put({
                    collectionId: e,
        ...
        return e.store(Ws.store).Ro({
            wo: !0
        }, (t, e) => {
            const s = new v(t);
            return n(s.M());
        }).next(() => e.store(qs.store).Ro({
            wo: !0
        }, ([t, e, s], i) => {
            const r = os(e);
            return n(r.M());
    ...
    rewriteCanonicalIds(t) {
        ...
        return e.Ro((t, s) => {
            const i = this.serializer.ha(s), n = this.serializer.oa(i);
            return e.put(n);
        });
    }
}
...
/** Name of the IndexedDb object store. */ function Ys(t) {
...
const Xs = [ ...[ ...[ ...[ Os.store, Bs.store, qs.store, Ws.store, Ks.store, xs.store, zs.store, Gs.store ], Js.store ], js.store ], Hs.store ];
...
/** Serializer for values stored in the LocalStore. */ class ei {
    ...
    /** Decodes a remote document from storage locally to a Document. */    Pa(t) {
        if (t.document) return this.Ma.Ai(t.document, !!t.hasCommittedMutations);
        if (t.noDocument) {
            const e = C.st(t.noDocument.path), s = this.La(t.noDocument.readTime);
            return new gt(e, s, {
                hasCommittedMutations: !!t.hasCommittedMutations
            });
        }
        if (t.unknownDocument) {
            const e = C.st(t.unknownDocument.path), s = this.La(t.unknownDocument.version);
            return new pt(e, s);
        }
        return be();
    }
    /** Encodes a document for storage locally. */    Na(t, e) {
        const s = this.Aa(e), i = t.key.path.M().W();
        if (t instanceof Vt) {
            const e = this.Ma.mi(t), n = t.hasCommittedMutations;
            return new Ws(
            /* unknownDocument= */ null, 
            /* noDocument= */ null, e, n, s, i);
        }
        if (t instanceof gt) {
            const e = t.key.path.W(), n = this.xa(t.version), r = t.hasCommittedMutations;
            return new Ws(
            /* unknownDocument= */ null, new Us(e, n), 
            /* document= */ null, r, s, i);
        }
        if (t instanceof pt) {
            const e = t.key.path.W(), n = this.xa(t.version);
            return new Ws(new Qs(e, n), 
            /* noDocument= */ null, 
            /* document= */ null, 
    ...
    /** Encodes a batch of mutations into a DbMutationBatch for local storage. */    Co(t, e) {
        const s = e.baseMutations.map(t => this.Ma.vi(t)), i = e.mutations.map(t => this.Ma.vi(t));
        return new Bs(t, e.batchId, e.Tn.toMillis(), s, i);
    }
    /** Decodes a DbMutationBatch into a MutationBatch */    ko(t) {
        const e = (t.baseMutations || []).map(t => this.Ma.Fi(t)), s = t.mutations.map(t => this.Ma.Fi(t)), i = p.fromMillis(t.localWriteTimeMs);
        return new Le(t.batchId, i, e, s);
    }
    /** Decodes a DbTarget into TargetData */    ha(t) {
        const e = this.La(t.readTime), s = void 0 !== t.lastLimboFreeSnapshotVersion ? this.La(t.lastLimboFreeSnapshotVersion) : y.min();
        let i;
        return i = void 0 !== t.query.documents ? this.Ma.Oi(t.query) : this.Ma.Wi(t.query), 
        new Mt(i, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, s, $.fromBase64String(t.resumeToken));
    }
    /** Encodes TargetData into a DbTarget for storage locally. */    oa(t) {
        const e = this.xa(t.Ee), s = this.xa(t.lastLimboFreeSnapshotVersion);
        let i;
        i = t.target.xt() ? this.Ma.xi(t.target) : this.Ma.Bi(t.target);
        // We can't store the resumeToken as a ByteString in IndexedDb, so we
        // convert it to a base64 string for storage.
                const n = t.resumeToken.toBase64();
        // lastListenSequenceNumber is always 0 until we do real GC.
                return new Ks(t.targetId, t.target.canonicalId(), e, n, t.sequenceNumber, s, i);
    }
}
 ...
 * limitations under the License.
 */
const si = "Another tab has exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs.";
 ...
 */ class ni {
    constructor(t, e, s, i, n, r, h, o) {
        ...
        this.Sr = r, this.Ba = o, this.qa = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        ...
        this.Ka = t => Promise.resolve(), !ni.so()) throw new R(w.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        if (this.Ao = new oi(this, n), this.Ga = e + ni.za, this.serializer = new ei(h), 
        this.document = i.document, this.Ha = new Vs(this.Ao, this.serializer), this.rr = new Zs, 
        this.ir = new vs(this.serializer, this.rr), !i.window || !i.window.localStorage) throw new R(w.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        this.window = i.window, this.Ya = this.window.localStorage;
    }
    static ho(t, e) {
        if (t instanceof ii) return as.ho(t.qo, e);
        throw be();
    }
    /**
     ...
     */    start() {
        return as.eo(this.Ga, $s, new Ms(this.serializer)).then(t => (this.Ja = t, this.Xa())).then(() => (this.Za(), 
        this.tu(), this.eu(), this.Ja.runTransaction("readonly", [ zs.store ], t => ys(t)))).then(t => {
            this.su = new Ge(t, this.Ba);
        }).then(() => {
            this.qa = !0;
     ...
     * primary lease.
     */    Xa() {
        return this.Ja.runTransaction("readwrite", Xs, t => hi(t).put(new Js(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next(() => {
            if (this.isPrimary) return this.hu(t).next(t => {
                t || (this.isPrimary = !1, this.Sr.Hr(() => this.Ka(!1)));
            });
        }).next(() => this.ou(t)).next(e => this.isPrimary && !e ? this.au(t).next(() => !1) : !!e && this.uu(t).next(() => !0))).catch(t => {
            if (!this.allowTabSynchronization) throw t;
            return ge("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", t), 
            /* isPrimary= */ !1;
        }).then(t => {
            this.isPrimary !== t && this.Sr.Hr(() => this.Ka(t)), this.isPrimary = t;
        });
    }
    hu(t) {
        return ri(t).get(xs.key).next(t => qe.resolve(this.cu(t)));
    }
    _u(t) {
     ...
     * time of all clients.
     */    async lu() {
        if (this.isPrimary && !this.du(this.ja, 18e5)) {
            this.ja = Date.now(), 
            ...
            (await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", t => {
                const e = ni.ho(t, Js.store);
                return e.To().next(t => {
                    const s = this.fu(t, 18e5), i = t.filter(t => -1 === s.indexOf(t));
                    // Delete metadata for clients that are no longer considered active.
                    return qe.forEach(i, t => e.delete(t.clientId)).next(() => i);
                });
            }).catch(() => [])).forEach(t => {
                this.window.localStorage.removeItem(this.Tu(t.clientId));
            });
        }
    }
    /**
     ...
     */    eu() {
        this.Wa = this.Sr.Br("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, () => this.Xa().then(() => this.lu()).then(() => this.eu()));
    }
    /** Checks whether `client` is the local client. */    cu(t) {
     ...
     */    ou(t) {
        return ri(t).get(xs.key).next(e => {
            ...
            //   the foreground.
            if (null !== e && this.du(e.leaseTimestampMs, 5e3) && !this.Eu(e.ownerId)) {
                if (this.cu(e) && this.networkEnabled) return !0;
                if (!this.cu(e)) {
                    ...
                    throw new R(w.FAILED_PRECONDITION, si);
                    return !1;
                }
            }
            return !(!this.networkEnabled || !this.inForeground) || hi(t).To().next(t => void 0 === this.fu(t, 5e3).find(t => {
    ...
    async Iu() {
        ...
        this.qa = !1, this.wu(), this.Wa && (this.Wa.cancel(), this.Wa = null), this.Ru(), 
        this.mu(), await this.Ja.runTransaction("readwrite", [ xs.store, Js.store ], t => this.au(t).next(() => this._u(t))), 
        this.Ja.close(), 
     ...
     * provided threshold.
     */    fu(t, e) {
        return t.filter(t => this.du(t.updateTimeMs, e) && !this.Eu(t.clientId));
    }
    /**
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Pu() {
        return this.Ja.runTransaction("readonly", [ Js.store ], t => hi(t).To().next(t => this.fu(t, 18e5).map(t => t.clientId)));
    }
    static async clearPersistence(t) {
        if (!ni.so()) return Promise.resolve();
        const e = t + ni.za;
        await as.delete(e);
    }
    get Uh() {
    ...
    Vu(t) {
        return Es.Vo(t, this.serializer, this.rr, this.Ao);
    }
    gu() {
        return this.Ha;
    }
    ...
    runTransaction(t, e, s) {
        ...
        // are the only reader/writer.
                return this.Ja.runTransaction(i, Xs, i => (n = new ii(i, this.su.next()), 
        "readwrite-primary" === e ? this.hu(i).next(t => !!t || this.ou(i)).next(e => {
            if (!e) throw pe(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, 
            this.Sr.Hr(() => this.Ka(!1)), new R(w.FAILED_PRECONDITION, Qe);
            return s(n);
        }).next(t => this.uu(i).next(() => t)) : this.bu(i).next(() => s(n)))).then(t => (n.sr(), 
        t));
    }
    /**
    ...
    // be turned off.
    bu(t) {
        return ri(t).get(xs.key).next(t => {
            if (null !== t && this.du(t.leaseTimestampMs, 5e3) && !this.Eu(t.ownerId) && !this.cu(t) && !t.allowTabSynchronization) throw new R(w.FAILED_PRECONDITION, si);
        });
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    au(t) {
        const e = ri(t);
        return e.get(xs.key).next(t => this.cu(t) ? (ge("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(xs.key)) : qe.resolve());
    }
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */    du(t, e) {
        const s = Date.now();
    ...
    Za() {
        null !== this.document && "function" == typeof this.document.addEventListener && (this.Qa = () => {
            this.Sr.Hr(() => (this.inForeground = "visible" === this.document.visibilityState, 
            this.Xa()));
     ...
     * handler.
     */    tu() {
        "function" == typeof this.window.addEventListener && (this.Ua = () => {
            // Note: In theory, this should be scheduled on the AsyncQueue since it
            // accesses internal state. We execute this code directly during shutdown
            // to make sure it gets a chance to run.
            this.wu(), this.Sr.Hr(() => this.Iu());
     ...
     */    Eu(t) {
        try {
            const e = null !== this.Ya.getItem(this.Tu(t));
    ...
    /** Removes the zombied client entry if it exists. */    Au() {
        try {
 ...
 */
function ri(t) {
    return t.store(xs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function hi(t) {
    return t.store(Js.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ ni.za = "main";

class oi {
    constructor(t, e) {
        this.db = t, this.Su = null, this.Lh = new is(this, e);
    }
    Kh(t) {
        const e = this.Du(t);
        return this.db.gu().aa(t).next(t => e.next(e => t + e));
    }
    Du(t) {
        let e = 0;
        return this.zh(t, t => {
     ...
     * the collection run.
     */    Nu(t, e) {
        return this.Su.Fn(e) ? qe.resolve(!0) : function(t, e) {
            let s = !1;
            return As(t).mo(i => Is(t, i, e).next(t => (t && (s = !0), qe.resolve(!t)))).next(() => s);
        }(t, e);
    }
    Yh(t, e) {
        const s = this.db.pu().ba(), i = [];
        let n = 0;
        return this.Cu(t, (r, h) => {
            if (h <= e) {
                const e = this.Nu(t, r).next(e => {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return n++, s.Yn(t, r).next(() => (s.Hn(r), bs(t).delete([ 0, ns(r.path) ])));
                });
                i.push(e);
            }
        }).next(() => qe.Un(i)).next(() => s.apply(t)).next(() => n);
    }
    removeTarget(t, e) {
        const s = e.Ie(t.Oa);
        return this.db.gu().ia(t, s);
    }
    ku(t, e) {
        return ai(t, e);
    }
...
class ui {
    ...
    t, e, s) {
        ...
        this.xu = new Me(t => t.canonicalId()), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.Ou = y.min(), this.persistence.Ao.Fu(this.Mu), this.nr = t.Vu(s), this.Bu = t.pu(), 
        this.Ha = t.gu(), this.qu = new je(this.Bu, this.nr, this.persistence.yu()), this.$u.Uu(this.qu);
    }
    ...
    // change.
    async Qu(t) {
        let e = this.nr, s = this.qu;
        const i = await this.persistence.runTransaction("Handle user change", "readonly", i => {
            // Swap out the mutation queue, grabbing the pending mutation batches
            // before and after.
            let n;
            return this.nr.xo(i).next(r => (n = r, e = this.persistence.Vu(t), 
            // Recreate our LocalDocumentsView using the new
            // MutationQueue.
            s = new je(this.Bu, e, this.persistence.yu()), e.xo(i))).next(t => {
                const e = [], r = [];
        ...
        return this.nr = e, this.qu = s, this.$u.Uu(this.qu), i;
    }
    /* Accept locally generated Mutations and commit them to storage. */    Gu(t) {
        const e = p.now(), s = t.reduce((t, e) => t.add(e.key), ee());
        let i;
        return this.persistence.runTransaction("Locally write mutations", "readwrite", n => this.qu.cr(n, s).next(s => {
            i = s;
     ...
     */    yo(t) {
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", e => {
            const s = t.batch.keys(), i = this.Bu.ba({
                Sa: !0
            });
            return this.nr.yo(e, t.batch, t.streamToken).next(() => this.zu(e, t, i)).next(() => i.apply(e)).next(() => this.nr.Wo(e)).next(() => this.qu.cr(e, s));
        });
    }
    /**
     ...
     */    Hu(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let s;
            return this.nr.No(e, t).next(t => (ve(null !== t), s = t.keys(), this.nr.Bo(e, t))).next(() => this.nr.Wo(e)).next(() => this.qu.cr(e, s));
        });
    }
    /**
     ...
     */    Lo() {
        return this.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", t => this.nr.Lo(t));
    }
    /** Returns the last recorded stream token for the current user. */    vo() {
        return this.persistence.runTransaction("Get last stream token", "readonly", t => this.nr.vo(t));
    }
    /**
     ...
     */    So(t) {
        return this.persistence.runTransaction("Set last stream token", "readwrite-primary", e => this.nr.So(e, t));
    }
    /**
     * Returns the last consistent snapshot processed (used by the RemoteStore to
     * determine whether to buffer incoming snapshots from the backend).
     */    Jo() {
        return this.persistence.runTransaction("Get last remote snapshot version", "readonly", t => this.Ha.Jo(t));
    }
    /**
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", i => {
            ...
            t.as.forEach((t, n) => {
                ...
                // the updated assignment.
                                r.push(this.Ha._a(i, t.Is, n).next(() => this.Ha.ca(i, t.Ts, n)));
                const o = t.resumeToken;
                // Update the resume token if the change includes one.
                                if (o.rt() > 0) {
                    const a = h.we(o, e).Ie(i.Oa);
                    s = s.me(n, a), 
                    // Update the target data if there are target changes (or if
                    // sufficient time has passed since the last update).
                    ui.Ju(h, a, t) && r.push(this.Ha.ia(i, a));
                }
            });
            let h = zt(), o = ee();
            ...
            r.push(n.getEntries(i, o).next(s => {
                t.cs.forEach((o, a) => {
                    ...
                    // access.
                    n.Hn(o, e), h = h.me(o, a)) : null == u || a.version.S(u.version) > 0 || 0 === a.version.S(u.version) && u.hasPendingWrites ? (n.Gn(a, e), 
                    h = h.me(o, a)) : ge("LocalStore", "Ignoring outdated watch update for ", o, ". Current version:", u.version, " Watch version:", a.version), 
                    t._s.has(o) && r.push(this.persistence.Ao.ku(i, o));
                });
            })), !e.isEqual(y.min())) {
                const t = this.Ha.Jo(i).next(t => this.Ha.Zo(i, i.Oa, e));
                r.push(t);
            }
            return qe.Un(r).next(() => n.apply(i)).next(() => this.qu._r(i, h));
        }).then(t => (this.Lu = s, t));
    }
    /**
     ...
     */    static Ju(t, e, s) {
        ...
        // closing.
                return e.Ee.D() - t.Ee.D() >= this.Xu || s.Ts.size + s.Es.size + s.Is.size > 0;
     ...
     */    Zu(t) {
        for (const e of t) {
            const t = e.targetId;
            if (this.Mu.pn(e.Ar, t), this.Mu.vn(e.Pr, t), !e.fromCache) {
                const e = this.Lu.get(t), s = e.Ee, i = e.Re(s);
                // Advance the last limbo free snapshot version
                                this.Lu = this.Lu.me(t, i);
            }
        }
        return this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => qe.forEach(t, t => qe.forEach(t.Pr, t => this.persistence.Ao.yn(e, t))));
    }
    /**
     ...
     */    ec(t) {
        return this.persistence.runTransaction("read document", "readonly", e => this.qu.hr(e, t));
    }
    /**
     ...
     */    sc(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            let s;
            return this.Ha.ua(e, t).next(i => i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            s = i, qe.resolve(s)) : this.Ha.zo(e).next(i => (s = new Mt(t, i, 0 /* Listen */ , e.Oa), 
            this.Ha.ta(e, s).next(() => s))));
        }).then(e => (null === this.Lu.get(e.targetId) && (this.Lu = this.Lu.me(e.targetId, e), 
        this.xu.set(t, e.targetId)), e));
    }
    /**
    ...
    // Visible for testing.
    ua(t, e) {
        const s = this.xu.get(e);
        return void 0 !== s ? qe.resolve(this.Lu.get(s)) : this.Ha.ua(t, e);
    }
    /**
    ...
    ic(t, e) {
        const s = this.Lu.get(t), i = e ? "readwrite" : "readwrite-primary";
        return this.persistence.runTransaction("Release target", i, i => {
            ...
            const n = this.Mu.Sn(t);
            return e ? qe.resolve() : qe.forEach(n, t => this.persistence.Ao.yn(i, t)).next(() => {
                this.persistence.Ao.removeTarget(i, s);
            });
        }).then(() => {
            this.Lu = this.Lu.remove(t), this.xu.delete(s.target);
        });
    }
    /**
     ...
     */    nc(t, e) {
        let s = y.min(), i = ee();
        return this.persistence.runTransaction("Execute query", "readonly", n => this.ua(n, t.ee()).next(t => {
            if (t) return s = t.lastLimboFreeSnapshotVersion, this.Ha.la(n, t.targetId).next(t => {
                i = t;
            });
        }).next(() => this.$u.dr(n, t, e ? s : y.min(), e ? i : ee())).next(t => ({
            documents: t,
            rc: i
        })));
    }
     ...
     */    hc(t) {
        return this.persistence.runTransaction("Remote document keys", "readonly", e => this.Ha.la(e, t));
    }
    zu(t, e, s) {
        const i = e.batch, n = i.keys();
        let r = qe.resolve();
        return n.forEach(n => {
            r = r.next(() => s.Yn(t, n)).next(t => {
                let r = t;
                const h = e.Rn.get(n);
        ...
        }), r.next(() => this.nr.Bo(t, i));
    }
    Qh(t) {
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", e => t.Jh(e, this.Lu));
    }
}
...
class ci extends ui {
    constructor(t, e, s) {
        super(t, e, s), this.persistence = t, this.nr = t.Vu(s), this.Bu = t.pu(), this.Ha = t.gu();
    }
    /** Starts the LocalStore. */    start() {
        return this.oc();
    }
    /** Returns the local view of the documents affected by a mutation batch. */    ac(t) {
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", e => this.nr.$o(e, t).next(t => t ? this.qu.cr(e, t) : qe.resolve(null)));
    }
    uc(t) {
        this.nr.Uo(t);
    }
    ...
    cc(t) {
        ...
        return e ? Promise.resolve(e.target) : this.persistence.runTransaction("Get target data", "readonly", e => this.Ha.si(e, t).next(t => t ? t.target : null));
    }
    /**
     ...
     */    Va() {
        return this.persistence.runTransaction("Get new document changes", "readonly", t => this.Bu.Va(t, this.Ou)).then(({ga: t, readTime: e}) => (this.Ou = e, 
        t));
    }
    /**
     ...
     */    async oc() {
        this.Ou = await this.persistence.runTransaction("Synchronize last document change read time", "readonly", t => this.Bu.ya(t));
    }
}
...
/** Helper function to assert Base64 functions are available at runtime. */ function Fi() {
    if (!me.nt()._c) throw new R(w.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ class Ni {
    ...
    toBase64() {
        return di("Blob.toBase64", arguments, 0), Fi(), this.lc.toBase64();
    }
    toUint8Array() {
        return di("Blob.toUint8Array", arguments, 0), Ci(), this.lc.toUint8Array();
    }
    toString() {
...
class Oi extends Mi {
    constructor(t) {
        super("FieldValue.arrayUnion"), this.wc = t;
    }
    Di(t) {
        ...
        const e = t.Rc({
            Ec: 3 /* Argument */ ,
            methodName: this.Tc
        }), s = this.wc.map((t, s) => Hi(t, e.mc(s))), i = new rt(s);
...
class Bi extends Mi {
    constructor(t) {
        super("FieldValue.arrayRemove"), this.wc = t;
    }
    Di(t) {
        // Although array transforms are used with writes, the actual elements
        ...
        const e = t.Rc({
            Ec: 3 /* Argument */ ,
            methodName: this.Tc
        }), s = this.wc.map((t, s) => Hi(t, e.mc(s))), i = new ht(s);
        return new ct(t.path, i);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class qi extends Mi {
    constructor(t) {
        super("FieldValue.increment"), this.Ac = t;
    }
    Di(t) {
        t.Rc({
            methodName: this.Tc
        });
        const e = Hi(this.Ac, t), s = new ot(t.serializer, e);
        return new ct(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
...
/** A "context" object passed around while parsing user data. */ class Gi {
    ...
    constructor(t, e, s, i, n) {
        ...
        void 0 === i && this.pc(), this.fieldTransforms = i || [], this.Vt = n || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    Rc(t) {
        return new Gi(Object.assign(Object.assign({}, this.settings), t), this.ii, this.serializer, this.fieldTransforms, this.Vt);
    }
    yc(t) {
        const e = null == this.path ? null : this.path.child(t), s = this.Rc({
            path: e,
            bc: !1
        });
        return s.vc(t), s;
    ...
    pc() {
        ...
        // within arrays.
        if (null !== this.path) for (let t = 0; t < this.path.length; t++) this.vc(this.path.get(t));
    }
    vc(t) {
        if (0 === t.length) throw this.Ic("Document fields must not be empty");
        if (Ki(this.Ec) && Qi.test(t)) throw this.Ic('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class zi {
    constructor(t, e) {
        this.ii = t, this.serializer = e || me.nt().Dc(t);
    }
    /** Parse document data from a non-merge set() call. */    Cc(t, e) {
        const s = this.Fc(0 /* Set */ , t);
        Xi("Data must be an object, but it was:", s, e);
        const i = Yi(e, s);
        return new Wi(new Rt(i), 
        /* fieldMask= */ null, s.fieldTransforms);
    }
    /** Parse document data from a set() call with '{merge:true}'. */    Nc(t, e, s) {
        const i = this.Fc(2 /* MergeSet */ , t);
        ...
        if (s) {
            ...
            for (const n of s) {
                let s;
                if (n instanceof ki) s = n.dc; else {
    ...
    /** Parse update data from an update() call. */    kc(t, e) {
        const s = this.Fc(1 /* Update */ , t);
        Xi("Data must be an object, but it was:", s, e);
        const i = [], n = new mt;
        N(e, (e, r) => {
            const h = tn(t, e), o = s.Sc(h);
            if (r instanceof Li) 
    ...
    /** Parse update data from a list of field/value arguments. */    $c(t, e, s, i) {
        const n = this.Fc(1 /* Update */ , t), r = [ Zi(t, e) ], h = [ s ];
    ...
    /** Creates a new top-level parse context. */    Fc(t, e) {
        return new Gi({
            Ec: t,
            methodName: e,
            path: D.G,
     ...
     */    Mc(t, e, s = !1) {
        return Hi(e, this.Fc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }
}
 ...
 */
    return function(t, e) {
        ...
        if (!Ki(e.Ec)) throw e.Ic(`${t.Tc}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof Hn) {
            const s = e.ii, i = t.firestore.Lc;
            if (!i.isEqual(s)) throw e.Ic("Document reference is for database " + `${i.projectId}/${i.database} but should be ` + `for database ${s.projectId}/${s.database}`);
            return {
                referenceValue: e.serializer._i(t.xc.path, t.firestore.Lc)
            };
        }
        throw e.Ic(`Unsupported field value: ${gi(t)}`);
    }
    /**
...
function Xi(t, e, s) {
    if (!Ji(s) || !Vi(s)) {
        const i = gi(s);
        throw "an object" === i ? e.Ic(t + " a custom object") : e.Ic(t + " " + i);
    }
}
 ...
 */ function Zi(t, e) {
    if (e instanceof ki) return e.dc;
...
class sn {
    constructor(t, e, s, i, n, r) {
        this.Sr = t, this.Oc = s, this.Bc = i, this.qc = n, this.listener = r, this.state = 0 /* Initial */ , 
        /**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */
        this.Uc = 0, this.Qc = null, this.stream = null, this.ih = new He(t, e);
    }
    /**
     ...
     */    async stop() {
        this.Wc() && await this.close(0 /* Initial */);
    }
    /**
     ...
     */    zc() {
        ...
        this.jc() && null === this.Qc && (this.Qc = this.Sr.Br(this.Oc, 6e4, () => this.Hc()));
    }
    /** Sends a message to the underlying stream. */    Yc(t) {
    ...
    /** Marks the stream as active again. */    Jc() {
    ...
    auth() {
        ...
        const t = this.t_(this.Uc), e = this.Uc;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.qc.getToken().then(t => {
    ...
    e_(t) {
        const e = this.t_(this.Uc);
        this.stream = this.i_(t), this.stream.n_(() => {
            e(() => (this.state = 2 /* Open */ , this.listener.n_()));
        }), this.stream.Zc(t => {
            e(() => this.s_(t));
    ...
    Kc() {
        this.state = 4 /* Backoff */ , this.ih.xr(async () => {
     ...
     */    t_(t) {
        return e => {
            this.Sr.Hr(() => this.Uc === t ? e() : (ge("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class rn extends sn {
    ...
    onMessage(t) {
        ...
        ve(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.u_) {
            ...
            return this.listener.l_(s, e);
        }
        // The first response is always the handshake response
        return ve(!t.writeResults || 0 === t.writeResults.length), this.u_ = !0, this.listener.d_();
    }
    /**
    ...
    /** Sends a group of mutations to the Firestore backend to apply. */    __(t) {
        const e = {
...
class hn extends class {
    ...
    constructor(t, e, s) {
        super(), this.Bc = t, this.credentials = e, this.serializer = s;
    }
    /** Gets an auth token and invokes the provided RPC. */    E_(t, e) {
        return this.credentials.getToken().then(s => this.Bc.E_(t, e, s)).catch(t => {
    ...
    /** Gets an auth token and invokes the provided RPC with streamed results. */    I_(t, e) {
        return this.credentials.getToken().then(s => this.Bc.I_(t, e, s)).catch(t => {
            throw t.code === w.UNAUTHENTICATED && this.credentials._(), t;
        });
    }
}
...
class on {
    constructor(t) {
        ...
        this.R_ = Zt(), this.mutations = [], this.m_ = !1, 
        /**
    ...
    async V_(t) {
        ...
        return e.forEach(t => {
            t instanceof gt || t instanceof Vt ? this.p_(t) : be();
        }), e;
    }
    set(t, e) {
    ...
    async commit() {
        ...
        t.forEach((t, e) => {
            ...
            }, n = await s.E_("Commit", i);
            return s.serializer.Li(n.writeResults, n.commitTime);
        }(this.w_, this.mutations), this.m_ = !0;
    }
    p_(t) {
        let e;
...
class an {
     ...
     */    C_() {
        0 === this.v_ && (this.F_("Unknown" /* Unknown */), this.S_ = this.qr.Br("online_state_timeout" /* OnlineStateTimeout */ , 1e4, () => (this.S_ = null, 
    ...
    N_(t) {
        ...
        this.D_ ? (pe(e), this.D_ = !1) : ge("OnlineStateTracker", e);
    }
    M_() {
...
class un {
    ...
    e, s, i, n) {
        ...
        this.q_ = !1, this.U_ = n, this.U_.Q_(t => {
            s.Hr(async () => {
                this.W_() && (ge("RemoteStore", "Restarting streams for network reachability change."), 
                await this.j_());
            });
        }), this.K_ = new an(s, i), 
        ...
        this.G_ = function(t, e, s) {
            const i = Se(t);
            return new nn(e, i.Bc, i.credentials, i.serializer, s);
        }(this.w_, s, {
            ...
            const i = Se(t);
            return new rn(e, i.Bc, i.credentials, i.serializer, s);
        }(this.w_, s, {
    ...
    async el() {
        this.W_() && (this.J_.lastStreamToken = await this.L_.vo(), this.sl() ? this.il() : this.K_.set("Unknown" /* Unknown */), 
    ...
    async rl() {
        await this.J_.stop(), await this.G_.stop(), this.x_.length > 0 && (ge("RemoteStore", `Stopping write stream with ${this.x_.length} pending writes`), 
        this.x_ = []), this.hl();
    }
    async Iu() {
        ge("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, await this.rl(), 
        this.U_.Iu(), 
    ...
    async Y_(t, e) {
        ...
        !e.isEqual(y.min())) try {
            const t = await this.L_.Jo();
            e.S(t) >= 0 && 
            // We have received a target change with a global snapshot if the snapshot
            // version is not equal to SnapshotVersion.min().
            await this.dl(e);
        } catch (t) {
            ge("RemoteStore", "Failed to raise snapshot:", t), await this.ll(t);
        }
    }
    /**
     ...
     */    async ll(t) {
        ...
        await this.rl(), this.K_.set("Offline" /* Offline */), 
        ...
        this.qr.dh(async () => {
            ...
            await this.L_.Jo(), this.q_ = !1, await this.el();
        });
    }
    /**
     ...
     */    dl(t) {
        ...
        return e.as.forEach((e, s) => {
            if (e.resumeToken.rt() > 0) {
                const i = this.O_.get(s);
                // A watched target might have been removed already.
                                i && this.O_.set(s, i.we(e.resumeToken, t));
            }
        }), 
    ...
    /** Handles an error on a target */    async _l(t) {
        ...
        // A watched target might have been removed already.
        this.O_.has(s) && (await this.cl.fl(s, e), this.O_.delete(s), this.B_.removeTarget(s));
    }
    /**
     ...
     */    async nl() {
        if (this.Tl()) {
            const t = this.x_.length > 0 ? this.x_[this.x_.length - 1].batchId : -1, e = await this.L_.tc(t);
            null === e ? 0 === this.x_.length && this.J_.zc() : (this.El(e), await this.nl());
        }
        this.Il() && this.wl();
    }
    /**
    ...
    tl() {
        ...
        return this.L_.So(this.J_.lastStreamToken).then(() => {
            // Send the write pipeline now that the stream is established.
            for (const t of this.x_) this.J_.__(t.mutations);
        }).catch(_i);
    }
    l_(t, e) {
        const s = this.x_.shift(), i = xe.from(s, t, e, this.J_.lastStreamToken);
        return this.cl.ml(i).then(() => this.nl());
    }
    async Z_(t) {
        // If the write stream closed due to an error, invoke the error callbacks if
        // there are pending writes.
        t && this.x_.length > 0 && (this.J_.c_ ? 
    ...
    async Pl(t) {
        ...
        if (Bt(t.code)) return ge("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.J_.lastStreamToken), 
        this.J_.lastStreamToken = $.ht, this.L_.So($.ht).catch(_i);
    }
    async Al(t) {
        ...
        if (Bt(e = t.code) && e !== w.ABORTED) {
            ...
            const e = this.x_.shift();
            // In this case it's also unlikely that the server itself is melting
            // down -- this was just a bad request so inhibit backoff on the next
            // restart.
                        return this.J_.Gc(), this.cl.Vl(e.batchId, t).then(() => this.nl());
        }
        var e;
        /**
 ...
 */    }
    ...
    async pl() {
        ...
        ge("RemoteStore", "RemoteStore restarting streams for new credential"), await this.j_());
    }
    /**
 ...
 */ class Tn {
     ...
     */    static bl(t, e) {
        ...
        for (let t = 0; i && t < s.activeTargetIds.length; ++t) i = x(s.activeTargetIds[t]), 
 ...
 */ class wn {
    constructor(t, e, s, i, n) {
        if (this.Sr = t, this.platform = e, this.persistenceKey = s, this.Cl = i, this.cl = null, 
        this.b_ = null, this.gr = null, this.Fl = this.Nl.bind(this), this.kl = new Ut(Ce), 
        this.Uh = !1, 
        /**
         * Captures WebStorage events that occur before `start()` is called. These
         * events are replayed once `WebStorageSharedClientState` is started.
         */
        this.$l = [], !wn.so(this.platform)) throw new R(w.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                const r = s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = n, this.Ml = cn(this.persistenceKey, this.Cl), 
        this.Ll = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.kl = this.kl.me(this.Cl, new In), this.xl = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
        this.Ol = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this.Bl = new RegExp(`^firestore_targets_${r}_(\\d+)$`), 
        this.ql = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    static so(t) {
        return !(!t.window || null == t.window.localStorage);
    }
    async start() {
        // Retrieve the list of existing clients to backfill the data in
        // SharedClientState.
        const t = await this.cl.Pu();
        for (const e of t) {
            if (e === this.Cl) continue;
            const t = this.getItem(cn(this.persistenceKey, e));
            if (t) {
                const s = Tn.bl(e, t);
                s && (this.kl = this.kl.me(s.clientId, s));
            }
        }
        this.Ul();
        ...
        for (const t of this.$l) this.Nl(t);
        this.$l = [], 
        // Register a window unload hook to remove the client metadata entry from
        // WebStorage even if `shutdown()` was not called.
        this.platform.window.addEventListener("unload", () => this.Iu()), this.Uh = !0;
    }
    br(t) {
    ...
    Nl(t) {
        if (t.storageArea === this.storage) {
            if (ge("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Ml) return void pe("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Sr.dh(async () => {
                if (this.Uh) {
 ...
 */ (t.newValue);
     ...
     * could not be parsed.
     */    ld(t, e) {
        const s = this.Ol.exec(t), i = Number(s[1]), n = void 0 !== s[2] ? s[2] : null;
        return dn.bl(new I(n), i, e);
    }
    /**
    ...
    ud(t, e) {
        const s = e ? this.kl.me(t, e) : this.kl.remove(t), i = this.Kl(this.kl), n = this.Kl(s), r = [], h = [];
        return n.forEach(t => {
            i.has(t) || r.push(t);
        }), i.forEach(t => {
            n.has(t) || h.push(t);
...
class Rn {
    constructor() {
        this.Rd = new In, this.md = {}, this.cl = null, this.b_ = null, this.gr = null;
    }
    zl(t) {
        // No op.
    }
    ...
    start() {
        return this.Rd = new In, Promise.resolve();
    }
    Qu(t, e, s) {
        // No op.
    }
 ...
 */ (t.type, e.type) || this.query.se(t.doc, e.doc)), this.Dd(s);
     ...
     */    Dd(t) {
        t && (t.Ts.forEach(t => this.Ad = this.Ad.add(t)), t.Es.forEach(t => {}), t.Is.forEach(t => this.Ad = this.Ad.delete(t)), 
        this.fs = t.fs);
    }
    Cd() {
        ...
        const e = [];
        return t.forEach(t => {
            this.Vd.has(t) || e.push(new An(t));
        }), this.Vd.forEach(s => {
            t.has(s) || e.push(new mn(s));
        }), e;
    }
    /**
...
class Vn {
    constructor(t, e, s, i) {
        this.qr = t, this.Ld = e, this.updateFunction = s, this.Wr = i, this.xd = 5, this.ih = new He(this.qr, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Bd() {
        this.ih.xr(async () => {
            const t = this.Ld.gl(), e = this.qd(t);
            e && e.then(e => {
                this.qr.Hr(() => t.commit().then(() => {
                    this.Wr.resolve(e);
                }).catch(t => {
                    this.Ud(t);
                }));
    ...
    qd(t) {
        try {
            ...
            return !M(e) && e.catch && e.then ? e : (this.Wr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
    ...
    Ud(t) {
        this.xd > 0 && this.Qd(t) ? (this.xd -= 1, this.qr.Hr(() => (this.Bd(), Promise.resolve()))) : this.Wr.reject(t);
    }
    Qd(t) {
 ...
 */ class yn {
    ...
    s, i, n) {
        this.L_ = t, this.Ld = e, this.jd = s, this.currentUser = i, this.Kd = n, this.Gd = null, 
        this.zd = new Me(t => t.canonicalId()), this.Hd = new Map, 
        /**
         ...
         */
        this.Xd = new Map, this.Zd = new Oe, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.tf = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ef = new Map, this.sf = Ps.Go(), this.onlineState = "Unknown" /* Unknown */;
    }
    get if() {
        return !0;
    }
     ...
     */    async listen(t) {
        ...
        e = i.targetId, this.jd.Xl(e), s = i.view.Md(); else {
            const i = await this.L_.sc(t.ee()), n = this.jd.Xl(i.targetId);
            e = i.targetId, s = await this.rf(t, e, "current" === n), this.if && this.Ld.listen(i);
        }
        return s;
    }
    /**
     ...
     * snapshot.
     */    async rf(t, e, s) {
        const i = await this.L_.nc(t, 
        /* usePreviousResults= */ !0), n = new Pn(t, i.rc), r = n.yd(i.documents), h = ae.ds(e, s && "Offline" /* Offline */ !== this.onlineState), o = n.Zn(r, 
    ...
    /** Stops listening to the query. */    async al(t) {
        ...
        // No other queries are mapped to the target, clean up the query and the target.
            ...
            this.jd.td(e.targetId), this.jd.Gl(e.targetId) || await this.L_.ic(e.targetId, /*keepPersistedTargetData=*/ !1).then(() => {
                this.jd.sd(e.targetId), this.Ld.al(e.targetId), this.af(e.targetId);
            }).catch(_i);
        } else this.af(e.targetId), await this.L_.ic(e.targetId, 
     ...
     */    async write(t, e) {
        ...
        this.jd.zl(s.batchId), this.uf(s.batchId, e), await this.cf(s.Wn), await this.Ld.nl();
    }
    /**
     ...
     */    runTransaction(t, e, s) {
        new Vn(t, this.Ld, e, s).Od();
    }
    async Yu(t) {
        this.nf("applyRemoteEvent()");
        try {
            const e = await this.L_.Yu(t);
            // Update `receivedDocument` as appropriate for any limbo targets.
                ...
                ve(t.Ts.size + t.Es.size + t.Is.size <= 1), t.Ts.size > 0 ? s.Wd = !0 : t.Es.size > 0 ? ve(s.Wd) : t.Is.size > 0 && (ve(s.Wd), 
                s.Wd = !1));
            }), await this.cf(e, t);
        } catch (t) {
            await _i(t);
     ...
     */    Nd(t, e) {
        ...
        }), this.Gd._f(t), this.Gd.h_(s), this.onlineState = t;
    }
    async fl(t, e) {
        ...
        await this.L_.ic(t, /* keepPersistedTargetData */ !1).then(() => this.af(t, e)).catch(_i);
    }
    async ml(t) {
        ...
        // before listen events.
                this.df(e, /*error=*/ null), this.ff(e);
        try {
            const s = await this.L_.yo(t);
            this.jd.Yl(e, "acknowledged"), await this.cf(s);
        } catch (t) {
            await _i(t);
        }
    }
    async Vl(t, e) {
        ...
        // listen events.
        this.df(t, e), this.ff(t);
        try {
            const s = await this.L_.Hu(t);
            this.jd.Yl(t, "rejected", e), await this.cf(s);
        } catch (e) {
            await _i(e);
        }
    }
     ...
     * are acknowledged .
     */    async Tf(t) {
        this.Ld.W_() || ge("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        const e = await this.L_.Lo();
        if (-1 === e) 
    ...
    uf(t, e) {
        ...
        s || (s = new Ut(Ce)), s = s.me(t, e), this.tf[this.currentUser.s()] = s;
    }
    /**
    ...
    af(t, e = null) {
        ...
        if (this.Hd.delete(t), this.if) {
            const e = this.Zd.Cn(t);
            this.Zd.Sn(t), e.forEach(t => {
                this.Zd.Fn(t) || 
    ...
    hf(t, e) {
        for (const s of e) if (s instanceof mn) this.Zd.gn(s.key, t), this.Rf(s); else if (s instanceof An) {
            ge("SyncEngine", "Document no longer in limbo: " + s.key), this.Zd.yn(s.key, t), 
            this.Zd.Fn(s.key) || 
            // We removed the last reference for this key
            this.wf(s.key);
        } else be();
    ...
    Rf(t) {
        const e = t.key;
        this.Jd.get(e) || (ge("SyncEngine", "New document in limbo: " + e), this.Yd.push(e), 
        this.lf());
    }
    /**
     ...
     */    lf() {
        for (;this.Yd.length > 0 && this.Jd.size < this.Kd; ) {
            ...
            this.Xd.set(e, new pn(t)), this.Jd = this.Jd.me(t, e), this.Ld.listen(new Mt(bt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Ge.vr));
        }
    }
    // Visible for testing
    mf() {
    ...
    async cf(t, e) {
        ...
        this.zd.forEach((r, h) => {
            n.push(Promise.resolve().then(() => {
                const e = h.view.yd(t);
                return e.Sd ? this.L_.nc(h.query, /* usePreviousResults= */ !1).then(({documents: t}) => h.view.yd(t, e)) : e;
                // The query has a limit and some docs were removed, so we need
                // to re-run the query against the local store to make sure we
                // didn't lose any good docs that had been past the limit.
                        }).then(t => {
                const n = e && e.as.get(h.targetId), r = h.view.Zn(t, 
                ...
                if (this.hf(h.targetId, r.Fd), r.snapshot) {
                    ...
                    s.push(r.snapshot);
                    const t = Ke.Vr(h.targetId, r.snapshot);
                    i.push(t);
                }
            }));
        }), await Promise.all(n), this.Gd.h_(s), await this.L_.Zu(i);
    }
    nf(t) {}
    async pl(t) {
        ...
        if (this.currentUser = t, e) {
            ...
            const e = await this.L_.Qu(t);
            // TODO(b/114226417): Consider calling this only in the primary tab.
                        this.jd.Qu(t, e.ju, e.Ku), await this.cf(e.Wu);
        }
        await this.Ld.pl();
    }
    enableNetwork() {
...
class bn extends yn {
    ...
    enableNetwork() {
        return this.L_.ru(!0), super.enableNetwork();
    }
    disableNetwork() {
        return this.L_.ru(!1), super.disableNetwork();
    }
    /**
     * Reconcile the list of synced documents in an existing view with those
     * from persistence.
     */    async Pf(t) {
        const e = await this.L_.nc(t.query, 
        /* usePreviousResults= */ !0), s = t.view.$d(e);
        return this.isPrimary && this.hf(t.targetId, s.Fd), s;
    }
    Nd(t, e) {
    ...
    async Ed(t, e, s) {
        ...
        const i = await this.L_.ac(t);
        null !== i ? ("pending" === e ? 
        // If we are the primary client, we need to send this write to the
        // backend. Secondary clients will ignore these writes since their remote
        // connection is disabled.
        await this.Ld.nl() : "acknowledged" === e || "rejected" === e ? (
        // NOTE: Both these methods are no-ops for batches that originated from
        // other clients.
        this.df(t, s || null), this.L_.uc(t)) : be(), await this.cf(i)) : 
    ...
    async yl(t) {
        if (!0 === t && !0 !== this.isPrimary) {
            this.isPrimary = !0, await this.Ld.yl(!0);
            ...
            const t = this.jd.jl(), e = await this.Vf(t.W());
            for (const t of e) this.Ld.listen(t);
        } else if (!1 === t && !1 !== this.isPrimary) {
            this.isPrimary = !1;
            const t = [];
            let e = Promise.resolve();
            this.Hd.forEach((s, i) => {
                this.jd.ed(i) ? t.push(i) : e = e.then(() => (this.af(i), this.L_.ic(i, 
                /*keepPersistedTargetData=*/ !0))), this.Ld.al(i);
            }), await e, await this.Vf(t), this.gf(), await this.Ld.yl(!1);
        }
    }
    gf() {
        this.Xd.forEach((t, e) => {
            this.Ld.al(e);
        }), this.Zd.Dn(), this.Xd = new Map, this.Jd = new Ut(C.N);
    }
    /**
     ...
     */    async Vf(t) {
        ...
        for (const i of t) {
            ...
            if (n && 0 !== n.length) {
                ...
                await this.L_.ic(i, 
                /*keepPersistedTargetData=*/ !0), t = await this.L_.sc(n[0].ee());
                for (const t of n) {
                    const e = this.zd.get(t), i = await this.Pf(e);
                    i.snapshot && s.push(i.snapshot);
                }
            } else {
                // For queries that never executed on this client, we need to
                // allocate the target in LocalStore and initialize a new View.
                const e = await this.L_.cc(i);
                t = await this.L_.sc(e), await this.rf(this.pf(e), i, 
                /*current=*/ !1);
            }
            e.push(t);
        }
        return this.Gd.h_(s), e;
    }
    /**
    ...
    async Id(t, e, s) {
        ...
        ge("SyncEngine", "Ignoring unexpected query state notification."); else if (this.Hd.has(t)) switch (e) {
          case "current":
          case "not-current":
            {
                const s = await this.L_.Va(), i = oe.ls(t, "current" === e);
                await this.cf(s, i);
                break;
            }
    ...
    async wd(t, e) {
        if (this.isPrimary) {
            for (const e of t) {
                ...
                const t = await this.L_.cc(e), s = await this.L_.sc(t);
                await this.rf(this.pf(t), s.targetId, 
                /*current=*/ !1), this.Ld.listen(s);
            }
            for (const t of e) 
            ...
            await this.L_.ic(t, /* keepPersistedTargetData */ !1).then(() => {
                this.Ld.al(t), this.af(t);
            }).catch(_i);
        }
    }
}
 ...
 */ class Sn {
    constructor(t) {
        this.cl = t, this.vf = new Me(t => t.canonicalId()), this.onlineState = "Unknown" /* Unknown */ , 
        this.Sf = new Set, this.cl.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let s = !1, i = this.vf.get(e);
        if (i || (s = !0, i = new vn), s) try {
            i.yf = await this.cl.listen(e);
        } catch (s) {
    ...
    async al(t) {
        const e = t.query;
        let s = !1;
        const i = this.vf.get(e);
        if (i) {
            const e = i.bf.indexOf(t);
            e >= 0 && (i.bf.splice(e, 1), s = 0 === i.bf.length);
        }
        if (s) return this.vf.delete(e), this.cl.al(e);
    }
    h_(t) {
        let e = !1;
        for (const s of t) {
            const t = s.query, i = this.vf.get(t);
            if (i) {
                for (const t of i.bf) t.Df(s) && (e = !0);
                i.yf = s;
            }
        }
        e && this.Cf();
    ...
    If(t, e) {
        const s = this.vf.get(t);
        if (s) for (const t of s.bf) t.onError(e);
 ...
 */ class Dn {
    constructor(t, e, s) {
         ...
         */
        this.$f = !1, this.Mf = null, this.onlineState = "Unknown" /* Unknown */ , this.options = s || {};
    }
    /**
     ...
     */    Df(t) {
        ...
        let e = !1;
        return this.$f ? this.Lf(t) && (this.kf.next(t), e = !0) : this.xf(t, this.onlineState) && (this.Of(t), 
        e = !0), this.Mf = t, e;
    }
    onError(t) {
        this.kf.error(t);
    ...
    xf(t, e) {
        ...
        // above) and are waiting for a sync.
                return (!this.options.Bf || !s) && (!t.docs.B() || "Offline" /* Offline */ === e);
    ...
    Lf(t) {
        ...
        const e = this.Mf && this.Mf.hasPendingWrites !== t.hasPendingWrites;
    ...
    Of(t) {
        t = he.os(t.query, t.docs, t.ns, t.fromCache), this.$f = !0, this.kf.next(t);
    }
}
 ...
 */ class Cn {
    ...
    dr(t, e, i, n) {
        ...
        return e.te() || i.isEqual(y.min()) ? this.Uf(t, e) : this.qf.cr(t, n).next(r => {
            const h = this.Qf(e, r);
            return (e.oe() || e.ae()) && this.Sd(e.Bt, h, n, i) ? this.Uf(t, e) : (Pe() <= s.DEBUG && ge("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", i.toString(), e.toString()), 
            this.qf.dr(t, e, i).next(t => (
    ...
    /** Applies the query filter and sorting to the provided documents.  */    Qf(t, e) {
 ...
 */ class Fn {
    constructor(t, e) {
        ...
        this.jf = new jt(Be.An);
    }
    po(t) {
        return qe.resolve(0 === this.nr.length);
    }
    yo(t, e, s) {
        const i = e.batchId, n = this.Kf(i, "acknowledged");
        ve(0 === n);
    ...
    Do(t, e, s, i) {
        const n = this.Wf;
        if (this.Wf++, this.nr.length > 0) {
            this.nr[this.nr.length - 1];
        }
        const r = new Le(n, e, s, i);
        this.nr.push(r);
        // Track references by document key and index collection parents.
        for (const e of i) this.jf = this.jf.add(new Be(e.key, n)), this.rr.Fo(t, e.key.path.M());
        return qe.resolve(r);
    }
    No(t, e) {
        return qe.resolve(this.Gf(e));
    }
    Mo(t, e) {
        const s = e + 1, i = this.zf(s), n = i < 0 ? 0 : i;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return qe.resolve(this.nr.length > n ? this.nr[n] : null);
    }
    Lo() {
        return qe.resolve(0 === this.nr.length ? -1 : this.Wf - 1);
    }
    xo(t) {
        return qe.resolve(this.nr.slice());
    }
    or(t, e) {
        const s = new Be(e, 0), i = new Be(e, Number.POSITIVE_INFINITY), n = [];
        return this.jf.Ke([ s, i ], t => {
            const e = this.Gf(t.Nn);
            n.push(e);
        }), qe.resolve(n);
    }
    lr(t, e) {
        let s = new jt(Ce);
        return e.forEach(t => {
            const e = new Be(t, 0), i = new Be(t, Number.POSITIVE_INFINITY);
            this.jf.Ke([ e, i ], t => {
                s = s.add(t.Nn);
            });
        }), qe.resolve(this.Hf(s));
    }
    Rr(t, e) {
        ...
        return this.jf.Ge(t => {
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === i && (h = h.add(t.Nn)), !0);
        }, r), qe.resolve(this.Hf(h));
    }
    Hf(t) {
    ...
    Bo(t, e) {
        ve(0 === this.Kf(e.batchId, "removed")), this.nr.shift();
        let s = this.jf;
        return qe.forEach(e.mutations, i => {
            const n = new Be(i.key, e.batchId);
            return s = s.delete(n), this.Ao.Qo(t, i.key);
        }).next(() => {
            this.jf = s;
        });
    }
    ...
    Fn(t, e) {
        const s = new Be(e, 0), i = this.jf.ze(s);
        return qe.resolve(e.isEqual(i && i.key));
    }
    Wo(t) {
        return this.nr.length, qe.resolve();
    }
    /**
 ...
 */ class Nn {
     ...
     */    Gn(t, e, s) {
        const i = e.key, n = this.docs.get(i), r = n ? n.size : 0, h = this.Yf(e);
        return this.docs = this.docs.me(i, {
            Ea: e,
            size: h,
            readTime: s
        }), this.size += h - r, this.rr.Fo(t, i.path.M());
    }
    /**
    ...
    Yn(t, e) {
        ...
        return qe.resolve(s ? s.Ea : null);
    }
    getEntries(t, e) {
        let s = Ht();
        return e.forEach(t => {
            const e = this.docs.get(t);
            s = s.me(t, e ? e.Ea : null);
        }), qe.resolve(s);
    }
    dr(t, e, s) {
        let i = Jt();
        ...
        for (;r.ke(); ) {
            const {key: t, value: {Ea: n, readTime: h}} = r.Ne();
 ...
 */ Nn.va = class extends Ue {
    constructor(t) {
        super(), this.Ca = t;
    }
    Zn(t) {
        const e = [];
        return this.Wn.forEach((s, i) => {
            i ? e.push(this.Ca.Gn(t, i, this.readTime)) : this.Ca.Hn(s);
        }), qe.Un(e);
    }
    Jn(t, e) {
...
class kn {
    constructor(t) {
         ...
         */
        this.Xf = new Me(t => t.canonicalId()), 
         ...
         * IDs.
         */
        this.tT = new Oe, this.targetCount = 0, this.eT = Ps.Ko();
    }
    js(t, e) {
        return this.Xf.forEach((t, s) => e(s)), qe.resolve();
    }
    Jo(t) {
        return qe.resolve(this.lastRemoteSnapshotVersion);
    }
    Xo(t) {
        return qe.resolve(this.Zf);
    }
    zo(t) {
        return this.highestTargetId = this.eT.next(), qe.resolve(this.highestTargetId);
    }
    Zo(t, e, s) {
        return s && (this.lastRemoteSnapshotVersion = s), e > this.Zf && (this.Zf = e), 
        qe.resolve();
    }
    ea(t) {
        this.Xf.set(t.target, t);
        const e = t.targetId;
        e > this.highestTargetId && (this.eT = new Ps(e), this.highestTargetId = e), t.sequenceNumber > this.Zf && (this.Zf = t.sequenceNumber);
    }
    ta(t, e) {
        return this.ea(e), this.targetCount += 1, qe.resolve();
    }
    ia(t, e) {
        return this.ea(e), qe.resolve();
    }
    na(t, e) {
    ...
    Hh(t, e, s) {
        let i = 0;
        const n = [];
        return this.Xf.forEach((r, h) => {
            h.sequenceNumber <= e && null === s.get(h.targetId) && (this.Xf.delete(r), n.push(this.ra(t, h.targetId)), 
            i++);
        }), qe.Un(n).next(() => i);
    }
    aa(t) {
    ...
    ua(t, e) {
        const s = this.Xf.get(e) || null;
        return qe.resolve(s);
    }
    ca(t, e, s) {
        this.tT.pn(e, s);
        const i = this.persistence.Ao, n = [];
    ...
    ra(t, e) {
        return this.tT.Sn(e), qe.resolve();
    }
    la(t, e) {
        const s = this.tT.Cn(e);
        return qe.resolve(s);
    }
    Fn(t, e) {
        return qe.resolve(this.tT.Fn(e));
    }
}
...
class $n {
     ...
     */
    constructor(t) {
        this.sT = {}, this.su = new Ge(0), this.qa = !1, this.qa = !0, this.Ao = t(this), 
        this.Ha = new kn(this);
        this.rr = new Ns, this.ir = new Nn(this.rr, t => this.Ao.iT(t));
    }
    start() {
        return Promise.resolve();
    }
    ...
    Vu(t) {
        let e = this.sT[t.s()];
        return e || (e = new Fn(this.rr, this.Ao), this.sT[t.s()] = e), e;
    }
    gu() {
        return this.Ha;
    }
    ...
    runTransaction(t, e, s) {
        ...
        const i = new Mn(this.su.next());
        return this.Ao.nT(), s(i).next(t => this.Ao.rT(i).next(() => t)).Bn().then(t => (i.sr(), 
        t));
    }
    hT(t, e) {
        return qe.Qn(Object.values(this.sT).map(s => () => s.Fn(t, e)));
    }
}
...
class Ln {
    ...
    gn(t, e) {
        return this.uT.delete(e), qe.resolve();
    }
    yn(t, e) {
        return this.uT.add(e), qe.resolve();
    }
    Qo(t, e) {
        return this.uT.add(e), qe.resolve();
    }
    removeTarget(t, e) {
        const s = this.persistence.gu();
        return s.la(t, e.targetId).next(t => {
            t.forEach(t => this.uT.add(t));
        }).next(() => s.na(t, e));
    }
    nT() {
        this.oT = new Set;
    ...
    rT(t) {
        ...
        const e = this.persistence.pu().ba();
        return qe.forEach(this.uT, s => this.cT(t, s).next(t => {
            t || e.Hn(s);
        })).next(() => (this.oT = null, e.apply(t)));
    }
    ku(t, e) {
        return this.cT(t, e).next(t => {
            t ? this.uT.delete(e) : this.uT.add(e);
        });
    }
    iT(t) {
    ...
    cT(t, e) {
        return qe.Qn([ () => this.persistence.gu().Fn(t, e), () => this.persistence.hT(t, e), () => qe.resolve(this.Su.Fn(e)) ]);
    }
}
...
class xn {
    async initialize(t) {
        this.jd = this._T(t), this.persistence = this.lT(t), await this.persistence.start(), 
        this.dT = this.fT(t), this.L_ = this.TT(t), this.Ld = this.ET(t), this.cl = this.IT(t), 
        this.wT = this.RT(t), this.jd.b_ = t => this.cl.Nd(t, 1 /* SharedClientState */), 
        this.Ld.cl = this.cl, await this.L_.start(), await this.jd.start(), await this.Ld.start(), 
        await this.Ld.yl(this.cl.if);
    }
    RT(t) {
        return new Sn(this.cl);
    }
    fT(t) {
        return null;
    }
    TT(t) {
        return new ui(this.persistence, new Cn, t.mT);
    }
    lT(t) {
        return new $n(Ln.aT);
    }
    ET(t) {
        return new un(this.L_, t.w_, t.qr, t => this.cl.Nd(t, 0 /* RemoteStore */), t.platform.AT());
    }
    _T(t) {
        return new Rn;
    }
    IT(t) {
        return new yn(this.L_, this.Ld, this.jd, t.mT, t.Kd);
    }
    clearPersistence(t) {
 ...
 */ class On extends xn {
    async initialize(t) {
        ...
        await this.persistence.iu(async t => {
            await this.cl.yl(t), this.dT && (t && !this.dT.Uh ? this.dT.start(this.L_) : t || this.dT.stop());
        });
    }
    TT(t) {
        return new ci(this.persistence, new Cn, t.mT);
    }
    IT(t) {
        const e = new bn(this.L_, this.Ld, this.jd, t.mT, t.Kd);
        return this.jd instanceof wn && (this.jd.cl = e), e;
    }
    fT(t) {
        const e = this.persistence.Ao.Lh;
        return new ss(e, t.qr);
    }
    lT(t) {
        const e = ni.vu(t.PT), s = t.platform.Dc(t.PT.ii);
        return new ni(t.VT.synchronizeTabs, e, t.clientId, t.platform, es.Dh(t.VT.cacheSizeBytes), t.qr, s, this.jd);
    }
    _T(t) {
        if (t.VT.gT && t.VT.synchronizeTabs) {
            if (!wn.so(t.platform)) throw new R(w.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            const e = ni.vu(t.PT);
            return new wn(t.qr, t.platform, e, t.clientId, t.mT);
        }
        return new Rn;
    }
    clearPersistence(t) {
        const e = ni.vu(t);
        return ni.clearPersistence(e);
    }
}
...
class Bn {
     ...
     */
    i) {
        this.platform = t, this.PT = e, this.credentials = s, this.qr = i, this.clientId = De.cn();
    }
    /**
     ...
     */    start(t, e) {
        ...
        return this.credentials.l(r => {
            if (!n) return n = !0, ge("FirestoreClient", "Initializing. user=", r.uid), this.yT(t, e, r, i).then(s.resolve, s.reject);
            this.qr.Hr(() => this.pl(r));
        }), 
        // Block the async queue until initialization is done
        this.qr.Hr(() => s.promise), i.promise;
    }
    /** Enables the network connection and requeues all pending operations. */    enableNetwork() {
        return this.pT(), this.qr.enqueue(() => this.cl.enableNetwork());
    }
    /**
     ...
     */    async yT(t, e, s, i) {
        try {
            ...
            // provider).
            const n = await this.platform.bT(this.PT), r = this.platform.Dc(this.PT.ii), h = function(t, e, s) {
                return new hn(t, e, s);
            ...
            await t.initialize({
                ...
                Kd: 100,
                VT: e
            }), this.persistence = t.persistence, this.jd = t.jd, this.L_ = t.L_, this.Ld = t.Ld, 
            this.cl = t.cl, this.dT = t.dT, this.vT = t.wT, 
            // When a user calls clearPersistence() in one client, all other clients
            // need to be terminated to allow the delete to succeed.
            this.persistence.nu(async () => {
     ...
     */    pT() {
        if (this.qr.hh) throw new R(w.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    pl(t) {
        return this.qr.Th(), ge("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.cl.pl(t);
    }
    /** Disables the network connection. Pending operations will not complete. */    disableNetwork() {
        return this.pT(), this.qr.enqueue(() => this.cl.disableNetwork());
    }
    terminate() {
        return this.qr.lh(async () => {
            // PORTING NOTE: LocalStore does not need an explicit shutdown on web.
            this.dT && this.dT.stop(), await this.Ld.Iu(), await this.jd.Iu(), await this.persistence.Iu(), 
     ...
     */    waitForPendingWrites() {
        this.pT();
        const t = new ze;
        return this.qr.Hr(() => this.cl.Tf(t)), t.promise;
    }
    listen(t, e, s) {
        this.pT();
        const i = new Dn(t, e, s);
        return this.qr.Hr(() => this.vT.listen(i)), i;
    }
    al(t) {
        // Checks for termination but does not raise error, allowing unlisten after
        // termination to be a no-op.
        this.DT || this.qr.Hr(() => this.vT.al(t));
    }
    CT(t) {
        return this.pT(), this.qr.enqueue(() => this.L_.ec(t)).then(t => {
    ...
    FT(t) {
        return this.pT(), this.qr.enqueue(async () => {
            const e = await this.L_.nc(t, 
            /* usePreviousResults= */ !0), s = new Pn(t, e.rc), i = s.yd(e.documents);
            return s.Zn(i, 
    ...
    write(t) {
        this.pT();
        const e = new ze;
        return this.qr.Hr(() => this.cl.write(t, e)), e.promise;
    }
    ii() {
        return this.PT.ii;
    }
    Ff(t) {
        this.pT(), this.qr.Hr(() => (this.vT.Ff(t), Promise.resolve()));
    }
    Nf(t) {
    ...
    transaction(t) {
        this.pT();
        const e = new ze;
        return this.qr.Hr(() => (this.cl.runTransaction(this.qr, t, e), Promise.resolve())), 
        e.promise;
    }
}
...
class Qn {
    constructor(t, e, s, i) {
        this.firestore = t, this.timestampsInSnapshots = e, this.$T = s, this.converter = i;
    }
    MT(t) {
        switch (U(t)) {
          case 0 /* NullValue */ :
    ...
    qT(t) {
        return (t.values || []).map(t => this.MT(t));
    }
    xT(t) {
        switch (this.$T) {
          case "previous":
    ...
    OT(t) {
        ...
        return s.isEqual(this.firestore.Lc) || 
        // TODO(b/64130202): Somehow support foreign references.
        pe(`Document ${i} contains a document ` + "reference within a different database (" + `${s.projectId}/${s.database}) which is not ` + "supported. It will be treated as a reference in the current " + `database (${this.firestore.Lc.projectId}/${this.firestore.Lc.database}) ` + "instead."), 
...
class jn {
    constructor(t) {
        ...
        Ri("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = es.$h; else {
            if (t.cacheSizeBytes !== Wn && t.cacheSizeBytes < es.kh) throw new R(w.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${es.kh}`);
 ...
 */ class Kn {
    ...
    constructor(t, e, s = new xn) {
        if (this.QT = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.WT = new Je, this.INTERNAL = {
            delete: async () => {
                // The client must be initalized to ensure that all subsequent API usage
                // throws an exception.
                this.jT(), await this.KT.terminate();
            }
        }, "object" == typeof t.options) {
            // This is very likely a Firebase app object
            // TODO(b/34177605): Can we somehow use instanceof?
            const s = t;
            this.QT = s, this.Lc = Kn.GT(s), this.zT = s.name, this.HT = new P(e);
        } else {
            const e = t;
            if (!e.projectId) throw new R(w.INVALID_ARGUMENT, "Must provide projectId");
            this.Lc = new $e(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.zT = "[DEFAULT]", this.HT = new A;
        }
        this.YT = s, this.JT = new jn({}), this.XT = new zi(this.Lc);
    }
    settings(t) {
        di("Firestore.settings", arguments, 1), Ei("Firestore.settings", "object", 1, t);
        const e = new jn(t);
        if (this.KT && !this.JT.isEqual(e)) throw new R(w.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */
    ...
    enablePersistence(t) {
        var e, s;
        if (this.KT) throw new R(w.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.KT && !this.KT.DT) throw new R(w.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        const t = new ze;
        return this.WT.oh(async () => {
            try {
                const e = this.eE();
                await this.YT.clearPersistence(e), t.resolve();
            } catch (e) {
                t.reject(e);
            }
        }), t.promise;
    ...
    onSnapshotsInSync(t) {
        if (this.jT(), Un(t)) return this.iE(t);
        {
    ...
    eE() {
        return new ke(this.Lc, this.zT, this.JT.host, this.JT.ssl, this.JT.forceLongPolling);
    }
    tE(t, e) {
        const s = this.eE();
        return this.KT = new Bn(me.nt(), s, this.HT, this.WT), this.KT.start(t, e);
    }
    static GT(t) {
 ...
 */        const i = t.options.projectId;
    ...
    collectionGroup(t) {
        ...
        return this.jT(), new Zn(new bt(v.G, t), this);
    }
    runTransaction(t) {
        return di("Firestore.runTransaction", arguments, 1), Ei("Firestore.runTransaction", "function", 1, t), 
        this.jT().transaction(e => t(new Gn(this, e)));
    }
    batch() {
        return this.jT(), new zn(this);
    }
    static get logLevel() {
        switch (Pe()) {
          case s.DEBUG:
 ...
 */ class Gn {
    ...
    get(t) {
        ...
        const e = rr("Transaction.get", t, this.hE);
        return this.oE.V_([ e.xc ]).then(t => {
            if (!t || 1 !== t.length) return be();
            const s = t[0];
            if (s instanceof gt) return new Jn(this.hE, e.xc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.aE);
            if (s instanceof Vt) return new Jn(this.hE, e.xc, s, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.aE);
            throw be();
        });
    ...
    set(t, e, s) {
        ...
        const i = rr("Transaction.set", t, this.hE);
        s = sr("Transaction.set", s);
        const [n, r] = or(i.aE, e, "Transaction.set"), h = s.merge || s.mergeFields ? this.hE.XT.Nc(r, n, s.mergeFields) : this.hE.XT.Cc(r, n);
        return this.oE.set(i.xc, h), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return "string" == typeof e || e instanceof ki ? (fi("Transaction.update", arguments, 3), 
        n = rr("Transaction.update", t, this.hE), r = this.hE.XT.$c("Transaction.update", e, s, i)) : (di("Transaction.update", arguments, 2), 
        n = rr("Transaction.update", t, this.hE), r = this.hE.XT.kc("Transaction.update", e)), 
        this.oE.update(n.xc, r), this;
    }
    delete(t) {
        di("Transaction.delete", arguments, 1);
        const e = rr("Transaction.delete", t, this.hE);
...
class zn {
    ...
    set(t, e, s) {
        Ti("WriteBatch.set", arguments, 2, 3), this._E();
        const i = rr("WriteBatch.set", t, this.hE);
        s = sr("WriteBatch.set", s);
        const [n, r] = or(i.aE, e, "WriteBatch.set"), h = s.merge || s.mergeFields ? this.hE.XT.Nc(r, n, s.mergeFields) : this.hE.XT.Cc(r, n);
        return this.uE = this.uE.concat(h.gc(i.xc, lt.ft())), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return this._E(), "string" == typeof e || e instanceof ki ? (fi("WriteBatch.update", arguments, 3), 
        n = rr("WriteBatch.update", t, this.hE), r = this.hE.XT.$c("WriteBatch.update", e, s, i)) : (di("WriteBatch.update", arguments, 2), 
        n = rr("WriteBatch.update", t, this.hE), r = this.hE.XT.kc("WriteBatch.update", e)), 
        this.uE = this.uE.concat(r.gc(n.xc, lt.exists(!0))), this;
    }
    delete(t) {
        di("WriteBatch.delete", arguments, 1), this._E();
        const e = rr("WriteBatch.delete", t, this.hE);
        return this.uE = this.uE.concat(new It(e.xc, lt.ft())), this;
    }
    commit() {
        return this._E(), this.cE = !0, this.uE.length > 0 ? this.hE.jT().write(this.uE) : Promise.resolve();
    }
    _E() {
        if (this.cE) throw new R(w.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class Hn {
    constructor(t, e, s) {
        this.xc = t, this.firestore = e, this.aE = s, this.KT = this.firestore.jT();
    }
    static nE(t, e, s) {
    ...
    get parent() {
        return new er(this.xc.path.M(), this.firestore, this.aE);
    }
    get path() {
    ...
    collection(t) {
        ...
        const e = v.K(t);
        return new er(this.xc.path.child(e), this.firestore);
    }
    isEqual(t) {
        if (!(t instanceof Hn)) throw bi("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.xc.isEqual(t.xc) && this.aE === t.aE;
    }
    set(t, e) {
        Ti("DocumentReference.set", arguments, 1, 2), e = sr("DocumentReference.set", e);
        const [s, i] = or(this.aE, t, "DocumentReference.set"), n = e.merge || e.mergeFields ? this.firestore.XT.Nc(i, s, e.mergeFields) : this.firestore.XT.Cc(i, s);
        return this.KT.write(n.gc(this.xc, lt.ft()));
    }
    update(t, e, ...s) {
        let i;
        return "string" == typeof t || t instanceof ki ? (fi("DocumentReference.update", arguments, 2), 
        i = this.firestore.XT.$c("DocumentReference.update", t, e, s)) : (di("DocumentReference.update", arguments, 1), 
        i = this.firestore.XT.kc("DocumentReference.update", t)), this.KT.write(i.gc(this.xc, lt.exists(!0)));
    }
    delete() {
        return di("DocumentReference.delete", arguments, 0), this.KT.write([ new It(this.xc, lt.ft()) ]);
    }
    onSnapshot(...t) {
    ...
    lE(t, e) {
        ...
        const i = new qn({
            next: t => {
                if (e.next) {
                    const s = t.docs.get(this.xc);
                    e.next(new Jn(this.firestore, this.xc, s, t.fromCache, t.hasPendingWrites, this.aE));
                }
            },
            error: s
        }), n = this.KT.listen(bt.Wt(this.xc.path), i, t);
        return () => {
            i.kT(), this.KT.al(n);
        };
    }
    get(t) {
        ...
        new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.jT().CT(this.xc).then(t => {
                e(new Jn(this.firestore, this.xc, t, 
                /*fromCache=*/ !0, t instanceof Vt && t.At, this.aE));
            }, s) : this.dE(e, s, t);
        });
    }
    dE(t, e, s) {
    ...
    withConverter(t) {
        return new Hn(this.xc, this.firestore, t);
    }
}
...
class Jn {
    constructor(t, e, s, i, n, r) {
        this.hE = t, this.xc = e, this.fE = s, this.TE = i, this.EE = n, this.aE = r;
    }
    data(t) {
        ...
        this.fE) {
            ...
            if (this.aE) {
                const e = new Xn(this.hE, this.xc, this.fE, this.TE, this.EE);
                return this.aE.fromFirestore(e, t);
            }
            return new Qn(this.hE, this.hE.rE(), t.serverTimestamps, 
    ...
    get(t, e) {
        ...
        this.fE) {
            const s = this.fE.data().field(Zi("DocumentSnapshot.get", t));
            if (null !== s) {
                return new Qn(this.hE, this.hE.rE(), e.serverTimestamps, this.aE).MT(s);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new Hn(this.xc, this.hE, this.aE);
    }
    get exists() {
        return null !== this.fE;
    }
    get metadata() {
        return new Yn(this.EE, this.TE);
    }
    isEqual(t) {
        if (!(t instanceof Jn)) throw bi("isEqual", "DocumentSnapshot", 1, t);
        return this.hE === t.hE && this.TE === t.TE && this.xc.isEqual(t.xc) && (null === this.fE ? null === t.fE : this.fE.isEqual(t.fE)) && this.aE === t.aE;
    }
}
...
class Zn {
    constructor(t, e, s) {
        this.IE = t, this.firestore = e, this.aE = s;
    }
    where(t, e, s) {
        ...
        if (r.Y()) {
            ...
            if ("in" /* IN */ === i) {
                this.wE(s, i);
                const t = [];
                for (const e of s) t.push(this.RE(e));
                n = {
                    arrayValue: {
                        values: t
                    }
        ...
        } else "in" /* IN */ !== i && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== i || this.wE(s, i), 
        n = this.firestore.XT.Mc("Query.where", s, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === i);
        const h = vt.create(r, i, n);
        return this.mE(h), new Zn(this.IE.Gt(h), this.firestore, this.aE);
    }
    orderBy(t, e) {
        let s;
        ...
        if (null !== this.IE.startAt) throw new R(w.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.IE.endAt) throw new R(w.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        const i = Zi("Query.orderBy", t), n = new $t(i, s);
        return this.AE(n), new Zn(this.IE.zt(n), this.firestore, this.aE);
    }
    limit(t) {
        return di("Query.limit", arguments, 1), Ei("Query.limit", "number", 1, t), vi("Query.limit", 1, t), 
        new Zn(this.IE.Ht(t), this.firestore, this.aE);
    }
    limitToLast(t) {
        return di("Query.limitToLast", arguments, 1), Ei("Query.limitToLast", "number", 1, t), 
        vi("Query.limitToLast", 1, t), new Zn(this.IE.Yt(t), this.firestore, this.aE);
    }
    startAt(t, ...e) {
        fi("Query.startAt", arguments, 1);
        const s = this.PE("Query.startAt", t, e, 
        /*before=*/ !0);
        return new Zn(this.IE.Jt(s), this.firestore, this.aE);
    }
    startAfter(t, ...e) {
        fi("Query.startAfter", arguments, 1);
        const s = this.PE("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new Zn(this.IE.Jt(s), this.firestore, this.aE);
    }
    endBefore(t, ...e) {
        fi("Query.endBefore", arguments, 1);
        const s = this.PE("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new Zn(this.IE.Xt(s), this.firestore, this.aE);
    }
    endAt(t, ...e) {
        fi("Query.endAt", arguments, 1);
        const s = this.PE("Query.endAt", t, e, 
        /*before=*/ !1);
        return new Zn(this.IE.Xt(s), this.firestore, this.aE);
    }
    isEqual(t) {
        if (!(t instanceof Zn)) throw bi("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && this.IE.isEqual(t.IE);
    }
    withConverter(t) {
        return new Zn(this.IE, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    PE(t, e, s, i) {
        if (pi(t, 1, e), e instanceof Jn) {
            ...
            return this.VE(n.fE, i);
        }
        {
            const n = [ e ].concat(s);
            return this.gE(t, n, i);
        }
    }
    /**
     ...
     */    VE(t, e) {
        ...
        // results.
                for (const e of this.IE.orderBy) if (e.field.Y()) s.push(X(this.firestore.Lc, t.key)); else {
            const i = t.field(e.field);
            if (O(i)) throw new R(w.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + e.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === i) {
                const t = e.field.j();
     ...
     */    gE(t, e, s) {
        ...
        for (let s = 0; s < e.length; s++) {
            ...
            if (i[s].field.Y()) {
                ...
                if (!this.IE._e() && -1 !== r.indexOf("/")) throw new R(w.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), " + `the value passed to ${t}() must be a plain document ID, but ` + `'${r}' contains a slash.`);
                const e = this.IE.path.child(v.K(r));
                ...
                const s = new C(e);
                n.push(X(this.firestore.Lc, s));
            } else {
                const e = this.firestore.XT.Mc(t, r);
                n.push(e);
            }
        }
        return new kt(n, s);
    ...
    lE(t, e) {
        ...
        const i = new qn({
            next: t => {
                e.next && e.next(new tr(this.firestore, this.IE, t, this.aE));
            },
            error: s
        }), n = this.firestore.jT(), r = n.listen(this.IE, i, t);
        return () => {
            i.kT(), n.al(r);
        };
    }
    pE(t) {
        if (t.ae() && 0 === t.Ot.length) throw new R(w.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }
    get(t) {
        return Ti("Query.get", arguments, 0, 1), nr("Query.get", t), this.pE(this.IE), new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.jT().FT(this.IE).then(t => {
                e(new tr(this.firestore, this.IE, t, this.aE));
            }, s) : this.dE(e, s, t);
        });
    }
    dE(t, e, s) {
     ...
     */    RE(t) {
        if ("string" == typeof t) {
            ...
            if (!this.IE._e() && -1 !== t.indexOf("/")) throw new R(w.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but " + `'${t}' contains a '/' character.`);
            const e = this.IE.path.child(v.K(t));
            ...
            return X(this.firestore.Lc, new C(e));
        }
        if (t instanceof Hn) {
            const e = t;
            return X(this.firestore.Lc, e.xc);
        }
    ...
    mE(t) {
        if (t instanceof vt) {
            ...
            if (t.ue()) {
                ...
                let r = null;
                if (n && (r = this.IE.ce(s)), null === r && i && (r = this.IE.ce(e)), null != r) 
...
class tr {
    constructor(t, e, s, i) {
        this.hE = t, this.bE = e, this.vE = s, this.aE = i, this.SE = null, this.DE = null, 
    ...
    forEach(t, e) {
        ...
        this.vE.docs.forEach(s => {
            t.call(e, this.CE(s));
        });
    }
    get query() {
        return new Zn(this.bE, this.hE, this.aE);
    }
    docChanges(t) {
        ...
        if (e && this.vE.hs) throw new R(w.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        ...
        return this.hE === t.hE && this.bE.isEqual(t.bE) && this.vE.isEqual(t.vE) && this.aE === t.aE;
    }
    CE(t) {
        return new Xn(this.hE, t.key, t, this.metadata.fromCache, this.vE.ns.has(t.key), this.aE);
    }
}

class er extends Zn {
    constructor(t, e, s) {
        if (super(bt.Wt(t), e, s), this.FE = t, t.length % 2 != 1) throw new R(w.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + `${t.j()} has ${t.length}`);
    }
    get id() {
        return this.IE.path.O();
    }
    get parent() {
        const t = this.IE.path.M();
    ...
    doc(t) {
        ...
        const e = v.K(t);
        return Hn.nE(this.IE.path.child(e), this.firestore, this.aE);
    }
    add(t) {
        di("CollectionReference.add", arguments, 1), Ei("CollectionReference.add", "object", 1, this.aE ? this.aE.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new er(this.FE, this.firestore, t);
    }
}
...
function sr(t, e) {
    ...
    if (yi(t, e, [ "merge", "mergeFields" ]), Ri(t, "boolean", "merge", e.merge), mi(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof ki), 
...
function nr(t, e) {
    Ii(t, "object", 1, e), e && (yi(t, e, [ "source" ]), Ai(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
const ur = ar(Kn, "Use firebase.firestore() instead."), cr = ar(Gn, "Use firebase.firestore().runTransaction() instead."), _r = ar(zn, "Use firebase.firestore().batch() instead."), lr = ar(Hn, "Use firebase.firestore().doc() instead."), dr = ar(Jn), fr = ar(Xn), Tr = ar(Zn), Er = ar(tr), Ir = ar(er, "Use firebase.firestore().collection() instead."), wr = ar(class {
    ...
    static serverTimestamp() {
        return li("FieldValue.serverTimestamp", arguments), new xi;
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
        return fi("FieldValue.arrayUnion", arguments, 1), new Oi(t);
    }
...
}, "Use FieldValue.<field>() instead."), Rr = ar(Ni, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), mr = {
    Firestore: ur,
    GeoPoint: Ui,
    Timestamp: p,
    Blob: Rr,
...
class Pr {
    constructor() {
        this.NE = () => this.kE(), this.$E = () => this.ME(), this.LE = [], this.xE();
    }
    Q_(t) {
        this.LE.push(t);
    }
    ...
    kE() {
        ...
        for (const t of this.LE) t(0 /* AVAILABLE */);
    }
    ME() {
        ge("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (const t of this.LE) t(1 /* UNAVAILABLE */);
    }
...
class yr {
    ...
    E_(t, e, s) {
        ...
        return new Promise((n, r) => {
            ...
            this.zE(u, s), h.send(i, "POST", a, u, 15);
        });
    }
    I_(t, e, s) {
    ...
    r_(t, e) {
        const s = [ this.GE, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = f(), c = {
        ...
        this.zE(c.initMessageHeaders, e), 
        ...
        // enough the code is exception free.
            ...
            E || (E = !0, ge("Connection", "WebChannel transport closed"), I.jE());
        }), m(T.EventType.ERROR, t => {
            E || (E = !0, ge("Connection", "WebChannel transport errored:", t), I.jE(new R(w.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!E) {
                ...
                if (n) {
                    ...
                    E = !0, I.jE(new R(e, s)), l.close();
                } else ge("Connection", "WebChannel received:", s), I.KE(s);
            }
        }), setTimeout(() => {
 ...
 */
    ...
    }(t, (t, e) => new Kn(t, e, new On)), t.registerVersion("@firebase/firestore", "1.14.3");
}
