...
var I = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.m !== e) throw new T(I.ABORTED, "getToken aborted due to token change.");
    ...
    t.prototype.A = function() {
        ...
        return Le(null === t || "string" == typeof t), new b(t);
    }, t;
}(), x = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new x(this.P, this.V));
    }, t.prototype.l = function(t) {
...
/** Extracts the backend's type order for the provided value. */ function W(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? G(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : De();
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function H(t, e) {
    var n = W(t);
    if (n !== W(e)) return !1;
    switch (n) {
      case 0 /* NullValue */ :
      ...
      case 9 /* ArrayValue */ :
        return Ve(t.arrayValue.values || [], e.arrayValue.values || [], H);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (q(n) !== q(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !H(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function Y(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Pe($(t.latitude), $(e.latitude));
            return 0 !== n ? n : Pe($(t.longitude), $(e.longitude));
...
function J(t) {
    return function t(e) {
        ...
        V.Z(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
var at = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Ve(this.elements, e.elements, H);
    }, t;
}(), ct = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    t.prototype.ut = function(t) {
        ...
        return e instanceof t && H(this.ct, e.ct);
...
e) {
    ...
    n.prototype.gt = function(t) {
        var e;
        return e = t instanceof St ? t.data() : It.empty(), this.pt(e);
    }, n.prototype.pt = function(t) {
        var e = this, n = new Tt(t);
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        if (this.It(t), Le(null != e.transformResults), !this.Rt.Et(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
        ...
        for (var e = null, n = 0, r = this.fieldTransforms; n < r.length; n++) {
            ...
            null != s && (e = null == e ? (new Tt).set(i.field, s) : e.set(i.field, s));
        }
        return e ? e.yt() : null;
    }, n.prototype.isEqual = function(t) {
    ...
    n.prototype.Dt = function(t, e, n) {
        ...
        for (var n = new Tt(t), r = 0; r < this.fieldTransforms.length; r++) {
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        ...
        // document the server has accepted the mutation so the precondition must
        // have held.
        return this.It(t), new kt(this.key, e.version, {
            hasCommittedMutations: !0
        });
    }, n.prototype.ot = function(t, e, n) {
        return this.It(t), this.Rt.Et(t) ? new kt(this.key, D.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.yt = function() {
        ...
        return null != t ? new It(t) : this.Ct;
    }, 
    /**
...
var _t, At, xt = function(t, e) {
    ...
    return t.prototype.canonicalId = function() {
        ...
        return V.et(this.path) && null === this.collectionGroup && 0 === this.filters.length;
    }, t;
}(), Rt = /** @class */ function() {
    /**
    ...
    return t.Wt = function(e) {
        ...
        get: function() {
            if (null === this.qt) {
                ...
                t.Y() || this.qt.push(new jt(t)), this.qt.push(new jt(P.J(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.canonicalId = function() {
        ...
        return !j(this.limit) && "F" /* First */ === this.Bt;
    }, t.prototype.ae = function() {
        return !j(this.limit) && "L" /* Last */ === this.Bt;
    ...
    t.prototype.ee = function() {
        if (!this.Ut) if ("F" /* First */ === this.Bt) this.Ut = new Lt(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
            // Flip the orderBy directions since we want the last results
            var t = [], e = 0, n = this.orderBy; e < n.length; e++) {
                var r = n[e], i = "desc" /* DESCENDING */ === r.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
                t.push(new jt(r.field, i));
            }
            ...
            // Now return as a LimitType.First query.
                        this.Ut = new Lt(this.path, this.collectionGroup, t, this.filters, this.limit, o, s);
        }
        return this.Ut;
    }, t.prototype.ie = function(t) {
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.tt(this.collectionGroup) && this.path.q(e) : V.et(this.path) ? this.path.isEqual(e) : this.path.U(e);
    }, 
    /**
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        if (t.Y()) return "in" /* IN */ === e ? new Vt(t, r) : new Pt(t, e, r);
        if (it(r)) {
            if ("==" /* EQUAL */ !== e) throw new T(I.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (ot(r)) {
            if ("==" /* EQUAL */ !== e) throw new T(I.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new qt(t, r) : "in" /* IN */ === e ? new Ut(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Ct(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && W(this.value) === W(e) && this.de(Y(e, this.value));
        ...
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && H(this.value, t.value);
    }, n.prototype.toString = function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = V.Z(r.referenceValue), i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = V.N(t.key, this.key);
        return this.de(e);
    }, n;
}(Ot), Vt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = (n.arrayValue.values || []).map((function(t) {
            return V.Z(t.referenceValue);
        })), r;
    }
    return t(n, e), n.prototype.matches = function(t) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return rt(e) && Q(e.arrayValue, this.value);
    }, n;
    ...
    t.prototype.le = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? V.N(V.Z(o.referenceValue), e.key) : Y(o, e.field(i.field)), 
        ...
        for (var e = 0; e < this.position.length; e++) if (!H(this.position[e], t.position[e])) return !1;
        return !0;
    }, t;
}(), jt = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.fe ? V.N(t.key, e.key) : function(t, e, n) {
            var r = e.field(t), i = n.field(t);
            return null !== r && null !== i ? Y(r, i) : De();
        }(this.field, t, e);
        switch (this.dir) {
          case "asc" /* ASCENDING */ :
            return n;
     ...
     */ , s) {
        void 0 === i && (i = D.min()), void 0 === o && (o = D.min()), void 0 === s && (s = M.ht), 
 ...
 */ function zt(t) {
    ...
    return Se("GRPC error has no .code"), I.UNKNOWN;
    switch (t) {
      case _t.OK:
        return I.OK;
...
var Kt = /** @class */ function() {
    function t(t, e) {
        this.N = t, this.root = e || Ht.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.me = function(e, n) {
        return new t(this.N, this.root.me(e, n, this.N).Ae(null, null, Ht.Pe, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.N, this.root.remove(e, this.N).Ae(null, null, Ht.Pe, null, null));
    }, 
    ...
    t.prototype.je = function() {
        if (this.xe() && this.left.xe()) throw De();
        if (this.right.xe()) throw De();
        var t = this.left.je();
...
Ht.EMPTY = null, Ht.RED = !0, Ht.Pe = !1, 
// end LLRBEmptyNode
...
var Qt = /** @class */ function() {
    function t(t) {
        this.N = t, this.data = new Kt(this.N);
    }
 ...
 */ var ue = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.N = t ? function(e, n) {
            return t(e, n) || V.N(e.key, n.key);
        } : function(t, e) {
            return V.N(t.key, e.key);
        }, this.Je = te(), this.Xe = new Kt(this.N)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, fe.ds(e, n)), new t(D.min(), r, se(), Jt(), ie());
    }, t;
}(), fe = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = M.ht), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    return t.prototype.qs = function(t) {
        for (var e = 0, n = t.ws; e < n.length; e++) {
            var r = n[e];
            t.Rs instanceof St ? this.Us(r, t.Rs) : t.Rs instanceof kt && this.Qs(r, t.key, t.Rs);
        }
    ...
    t.prototype.Hs = function(t) {
        ...
        if (r) {
            ...
            if (i.xt()) if (0 === n) {
                ...
                // queries.
                var o = new V(i.path);
                this.Qs(e, o, new kt(o, D.min()));
            } else Le(1 === n); else this.Js(e) !== n && (
    ...
    t.prototype.Xs = function(t) {
        ...
        this.Ls.forEach((function(r, i) {
            ...
            if (o) {
                if (r.fs && o.target.xt()) {
                    ...
                    null !== e.xs.get(s) || e.Zs(i, s) || e.Qs(i, s, new kt(s, t));
                }
        ...
        var i = new he(t, n, this.Bs, this.xs, r);
        return this.xs = Jt(), this.Os = me(), this.Bs = new Qt(Pe), i;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.Os.get(t);
        return e || (e = new Qt(Pe), this.Os = this.Os.me(t, e)), e;
    }, 
    /**
 ...
 */ var we = {
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (Le(void 0 === t || "string" == typeof t), M.fromBase64String(t || "")) : (Le(void 0 === t || t instanceof Uint8Array), 
        ...
        var e = this.di(t);
        return Le(e.get(1) === this.ii.projectId), Le(!e.get(3) && !this.ii.database || e.get(3) === this.ii.database), 
        new V(this.Ti(e));
        ...
        return Le(t.length > 4 && "documents" === t.get(4)), t.$(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        var n = this.Z(t.name), r = this.fromVersion(t.updateTime), i = new It({
            mapValue: {
                fields: t.fields
            }
        });
        ...
        var e = this.Z(t.found.name), n = this.fromVersion(t.found.updateTime), r = new It({
            mapValue: {
        ...
        if ("targetChange" in t) {
            ...
            var a = this.Z(u.document.name), c = this.fromVersion(u.document.updateTime), h = new It({
                mapValue: {
            ...
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : D.min(), m = new kt(y, v), g = d.removedTargetIds || [];
            e = new le([], g, m.key, m);
            ...
            var I = t.filter;
            I.targetId;
            var T = I.count || 0, N = new Bt(T), _ = I.targetId;
            e = new pe(_, N);
        }
        return e;
        ...
        if (t.update) {
            t.update.name;
            var r = this.Z(t.update.name), i = new It({
                mapValue: {
        ...
        if (t.transform) {
            ...
            return Le(!0 === n.exists), new wt(u, a);
        }
        if (t.verify) {
        ...
        var e = null;
        if ("setToServerValue" in t) Le("REQUEST_TIME" === t.setToServerValue), e = ut.instance; else if ("appendMissingElements" in t) {
            var n = t.appendMissingElements.values || [];
            e = new at(n);
        } else if ("removeAllFromArray" in t) {
            var r = t.removeAllFromArray.values || [];
            e = new ct(r);
        } else "increment" in t ? e = new ht(this, t.increment) : De();
        ...
        var h = null;
        return n.endAt && (h = this.Gi(n.endAt)), new Rt(e, i, u, s, a, "F" /* First */ , c, h).ee();
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof Ot ? e.Yi(t) : De();
            }));
    ...
    t.prototype.Zi = function(t) {
        ...
        return new jt(this.on(t.field), this.sn(t.direction));
    }, t.prototype.Xi = function(t) {
...
function(t, e, n, r, i) {
    ...
    return t.from = function(e, n, r, i) {
        ...
        for (var o = ne(), s = e.mutations, u = 0; u < s.length; u++) o = o.me(s[u].key, r[u].version);
        return new t(e, n, r, i, o);
    }, t;
}(), Be = /** @class */ function() {
    function t() {
        // A set of outstanding references to a document sorted by key.
        this.mn = new Qt(Ge.An), 
        // A set of outstanding references to a document sorted by target id.
        this.Pn = new Qt(Ge.Vn)
     ...
     */
    t.prototype.Sn = function(t) {
        var e = this, n = V.EMPTY, r = new Ge(n, t), i = new Ge(n, t + 1), o = [];
        ...
        var e = V.EMPTY, n = new Ge(e, t), r = new Ge(e, t + 1), i = ie();
        return this.Pn.Ke([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Fn = function(t) {
        var e = new Ge(t, 0), n = this.mn.ze(e);
    ...
    return t.An = function(t, e) {
        return V.N(t.key, e.key) || Pe(t.Nn, e.Nn);
    }, 
    /** Compare by ID then by key */ t.Vn = function(t, e) {
        return Pe(t.Nn, e.Nn) || V.N(t.key, e.key);
    }, t;
}(), ze = /** @class */ function() {
    function t(t) {
        var e = this;
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Ln && De(), this.Ln = !0, this.Mn ? this.error ? this.xn(n, this.error) : this.On(e, this.result) : new t((function(t, i) {
            r.kn = function(n) {
                r.On(e, n).next(t, i);
            }, r.$n = function(e) {
                r.xn(n, e).next(t, i);
    ...
    t.prototype.Yn = function(t, e) {
        this.zn();
        var n = this.Wn.get(e);
        return void 0 !== n ? ze.resolve(n) : this.Jn(t, e);
    }, 
    /**
    ...
    t;
}(), We = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", He = /** @class */ function() {
    function t() {
        this.tr = [];
    }
    ...
    t.prototype._r = function(t, e) {
        ...
        return this.nr.lr(t, e).next((function(r) {
            var i = n.ur(t, e, r), o = Jt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new kt(t, D.min())), o = o.me(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.dr = function(t, e, n) {
        ...
        return this.hr(t, new V(e)).next((function(t) {
            var e = te();
            return t instanceof St && (e = e.me(t.key, t)), e;
        }));
    }, t.prototype.Er = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = te();
        return this.rr.wr(t, i).next((function(s) {
            return ze.forEach(s, (function(s) {
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.mr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof St ? r.me(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        return this.ir.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof St && (c = c.me(t, e));
            })), c;
        }));
    }, t;
}(), Ye = /** @class */ function() {
...
/** Represents the database ID a Firestore client is associated with. */ Xe.vr = -1;
...
var Je = function() {
    ...
    t.prototype.xr = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && xe("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.kr + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i) {
        this.qr = t, this.Dr = e, this.Ur = n, this.op = r, this.Qr = i, this.Wr = new Je, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.Kr && (this.clearTimeout(), this.Wr.reject(new T(I.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.ih = new Ze(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.lh = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ah(), this.Xr ? [ 3 /*break*/ , 2 ] : (this.Xr = !0, (e = Te.nt().window) && e.removeEventListener("visibilitychange", this.nh), 
                    [ 4 /*yield*/ , this._h(t) ]);
    ...
    t.prototype.dh = function(t) {
                ...
                return e(r, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            return n.sent(), i.resolve(), this.ih.reset(), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.Yr.then((function() {
            return e.eh = !0, t().catch((function(t) {
                ...
                throw e.th = t, e.eh = !1, Se("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.eh = !1, t;
            }));
    ...
    t.prototype.Br = function(t, e, n) {
        ...
        var i = $e.jr(this, t, e, n, (function(t) {
            return r.fh(t);
        }));
 ...
 */ var nn = /** @class */ function() {
    function t(t) {
        this.Rh = t, this.buffer = new Qt(en), this.mh = 0;
    }
    return t.prototype.Ah = function() {
        ...
        if (this.buffer.size < this.Rh) this.buffer = this.buffer.add(e); else {
            ...
            en(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
...
on.Nh = -1, on.kh = 1048576, on.$h = 41943040, on.Ch = 10, on.Fh = 1e3, on.Mh = new on(on.$h, on.Ch, on.Fh), 
on.DISABLED = new on(on.Nh, 0, 0);
...
var sn = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        var r = this, i = this.xh ? 3e5 : 6e4;
        xe("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.Oh = this.qr.Br("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return e(r, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        this.Oh = null, this.xh = !0, n.label = 1;

                      case 1:
                        return n.trys.push([ 1, 3, , 7 ]), [ 4 /*yield*/ , t.Qh(this.Lh) ];

                      case 2:
                        return n.sent(), [ 3 /*break*/ , 7 ];

                      case 3:
                        return "IndexedDbTransactionError" !== (e = n.sent()).name ? [ 3 /*break*/ , 4 ] : (xe("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]);
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.Gh = function(t, e) {
        var n = this;
        if (0 === e) return ze.resolve(Xe.vr);
        var r = new nn(e);
    ...
    t.prototype.Yh = function(t, e) {
        ...
        var n = this;
        return this.Bh.bh === on.Nh ? (xe("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        ze.resolve(rn)) : this.Xh(t).next((function(r) {
            return r < n.Bh.bh ? (xe("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.Bh.bh), 
            rn) : n.Zh(t, e);
        }));
        ...
        return this.jh(t, this.Bh.vh).next((function(e) {
            ...
            return e > h.Bh.Sh ? (xe("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + h.Bh.Sh + " from " + e), 
            r = h.Bh.Sh) : r = e, o = Date.now(), h.Gh(t, r);
        })).next((function(r) {
            return n = r, u = Date.now(), h.Hh(t, n, e);
        })).next((function(e) {
            return i = e, a = Date.now(), h.Yh(t, n);
        })).next((function(t) {
            return c = Date.now(), _e() <= s.DEBUG && xe("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (u - o) + "ms\n\tRemoved " + i + " targets in " + (a - u) + "ms\n\tRemoved " + t + " documents in " + (c - a) + "ms\nTotal Duration: " + (c - f) + "ms"), 
            ze.resolve({
                Vh: !0,
                gh: r,
                ph: i,
 ...
 */
function an(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = hn(e)), e = cn(t.get(n), e);
    return hn(e);
}
 ...
 */ function fn(t) {
    ...
    var e = t.length;
    if (Le(e >= 2), 2 === e) return Le("" === t.charAt(0) && "" === t.charAt(1)), 
    R.G;
    ...
    // source value.
        ...
        var s = t.indexOf("", o);
        switch ((s < 0 || s > n) && De(), t.charAt(s + 1)) {
          case "":
 ...
 */ var ln = /** @class */ function() {
    function t(e) {
        ...
        // log on 12.2.
        12.2 === t.to(u()) && Se("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")
        /**
    ...
    return t.eo = function(e, n, r) {
        return xe("SimpleDb", "Opening database:", e), new ze((function(i, o) {
            ...
            s.onsuccess = function(e) {
                ...
                r.createOrUpgrade(n, s.transaction, t.oldVersion, Mn).next((function() {
                    xe("SimpleDb", "Database upgrade to version " + Mn + " complete");
                }));
            };
        })).Bn();
    }, 
    /** Deletes the specified database. */ t.delete = function(t) {
        return xe("SimpleDb", "Removing database:", t), mn(window.indexedDB.deleteDatabase(t)).Bn();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.so = function() {
        ...
        // Check the UA string to find out the browser.
                var e = u(), n = t.to(e), r = 0 < n && n < 10, i = t.no(e), o = 0 < i && i < 4.5;
        // IE 10
                  ...
                  case 0:
                    e = "readonly" === t, o = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                ++o, t = yn.open(u.db, e ? "readonly" : "readwrite", r), n.label = 1;
                              ...
                              case 3:
                                return c = n.sent(), h = "FirebaseError" !== c.name && o < 3, xe("SimpleDb", "Transaction failed with error: %s. Retrying: %s.", c.message, h), 
    ...
    function t(t) {
        ...
        /**
             ...
             */
        this.fo = new Je, this.transaction.oncomplete = function() {
            e.fo.resolve();
        }, this.transaction.onabort = function() {
            t.error ? e.fo.reject(new dn(t.error)) : e.fo.resolve();
        }, this.transaction.onerror = function(t) {
            var n = wn(t.target.error);
            e.fo.reject(new dn(n));
        };
    }
    return t.open = function(e, n, r) {
        ...
        t && this.fo.reject(t), this.aborted || (xe("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    t.prototype.add = function(t) {
        return xe("SimpleDb", "ADD", this.store.name, t, t), mn(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return mn(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), xe("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return xe("SimpleDb", "DELETE", this.store.name, t), mn(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return xe("SimpleDb", "COUNT", this.store.name), mn(this.store.count());
    ...
    t.prototype.mo = function(t) {
        var e = this.cursor({});
        return new ze((function(n, r) {
            e.onerror = function(t) {
                var e = wn(t.target.error);
                r(e);
        ...
        var n = [];
        return new ze((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new pn(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof ze) {
                        var u = s.catch((function(t) {
                            return o.done(), ze.reject(t);
                        }));
                        n.push(u);
                    }
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ var En = /** @class */ function() {
    function t(
    /**
    ...
    return t.Vo = function(e, n, r, i) {
        ...
        return Le("" !== e.uid), new t(e.t() ? e.uid : "", n, r, i);
    }, t.prototype.po = function(t) {
        var e = !0, n = IDBKeyRange.bound([ this.userId, Number.NEGATIVE_INFINITY ], [ this.userId, Number.POSITIVE_INFINITY ]);
        return Tn(t).Ro({
            index: zn.userMutationsIndex,
            range: n
        }, (function(t, n, r) {
            e = !1, r.done();
        })).next((function() {
        ...
        return this.bo(t).next((function(e) {
            ...
            return e.lastStreamToken = n.toBase64(), _n(t).put(e);
        }));
    }, t.prototype.vo = function(t) {
        return this.bo(t).next((function(t) {
            return M.fromBase64String(t.lastStreamToken);
        }));
    }, t.prototype.So = function(t, e) {
        return this.bo(t).next((function(n) {
            // We can't store the resumeToken as a ByteString in IndexedDB, so we
            // convert it to a Base64 string for storage.
            return n.lastStreamToken = e.toBase64(), _n(t).put(n);
        }));
    }, t.prototype.Do = function(t, e, n, r) {
        var i = this, o = Nn(t), s = Tn(t);
        ...
        return s.add({}).next((function(u) {
            Le("number" == typeof u);
            for (var a = new je(u, e, n, r), c = i.serializer.Co(i.userId, a), h = [], f = new Qt((function(t, e) {
                return Pe(t.j(), e.j());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], y = Kn.key(i.userId, d.key.path, u);
                f = f.add(d.key.path.M()), h.push(s.put(c)), h.push(o.put(y, Kn.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.rr.Fo(t, e));
            })), t.er((function() {
                i.Po[u] = a.keys();
            })), ze.Un(h).next((function() {
                return a;
            }));
        }));
    }, t.prototype.No = function(t, e) {
        var n = this;
        return Tn(t).get(e).next((function(t) {
            return t ? (Le(t.userId === n.userId), n.serializer.ko(t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.$o = function(t, e) {
        var n = this;
        return this.Po[e] ? ze.resolve(this.Po[e]) : this.No(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Po[e] = r, r;
            }
        ...
        return Tn(t).Ro({
            ...
            e.userId === n.userId && (Le(e.batchId >= r), o = n.serializer.ko(e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Tn(t).To(zn.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return e.serializer.ko(t);
            }));
        }));
    }, t.prototype.or = function(t, e) {
        var n = this, r = Kn.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return Nn(t).Ro({
            range: i
        }, (function(r, i, s) {
            var u = r[0], a = r[1], c = r[2], h = fn(a);
            ...
            return Tn(t).get(c).next((function(t) {
                if (!t) throw De();
                Le(t.userId === n.userId), o.push(n.serializer.ko(t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Qt(Pe), i = [];
        return e.forEach((function(e) {
            var o = Kn.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = Nn(t).Ro({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = fn(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), ze.Un(i).next((function() {
            return n.Oo(t, r);
        }));
    }, t.prototype.Rr = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Kn.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Qt(Pe);
        return Nn(t).Ro({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = fn(a);
            s === n.userId && r.q(h) ? 
        ...
        return e.forEach((function(e) {
            i.push(Tn(t).get(e).next((function(t) {
                if (null === t) throw De();
                Le(t.userId === n.userId), r.push(n.serializer.ko(t));
            })));
        })), ze.Un(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return In(t.qo, this.userId, e).next((function(r) {
            return t.er((function() {
                n.Uo(e.batchId);
            })), ze.forEach(r, (function(e) {
                return n.Ao.Qo(t, e);
            }));
        }));
    }, 
    ...
    t.prototype.Uo = function(t) {
        ...
        return this.po(t).next((function(n) {
            if (!n) return ze.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(Kn.prefixForUser(e.userId)), i = [];
            return Nn(t).Ro({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
        ...
        return bn(t, this.userId, e);
    }, 
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    t.prototype.bo = function(t) {
        var e = this;
        return _n(t).get(this.userId).next((function(t) {
            return t || new Gn(e.userId, -1, 
            /*lastStreamToken=*/ "");
        }));
    }, t;
}();
 ...
 */ function bn(t, e, n) {
    var r = Kn.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return Nn(t).Ro({
        range: o,
        wo: !0
    }, (function(t, n, r) {
 ...
 */ function In(t, e, n) {
    var r = t.store(zn.store), i = t.store(Kn.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Ro({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], p = Kn.key(e, l.key.path, n.batchId);
        o.push(i.delete(p)), c.push(l.key);
    }
    return ze.Un(o).next((function() {
        return c;
    }));
}
 ...
 */ function Tn(t) {
    return ar.ho(t, zn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Nn(t) {
    return ar.ho(t, Kn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function _n(t) {
    return ar.ho(t, Gn.store);
}
 ...
 */ var An = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Ho(t).next((function(n) {
            var r = new An(n.highestTargetId);
        ...
        return this.Ho(t).next((function(t) {
            return D.v(new k(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
    }, t.prototype.Xo = function(t) {
        return Dn(t.qo);
        ...
        return this.ra(t, e.targetId).next((function() {
            return Sn(t).delete(e.targetId);
        })).next((function() {
            return n.Ho(t);
        })).next((function(e) {
            return Le(e.targetCount > 0), e.targetCount -= 1, n.Yo(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.js = function(t, e) {
        ...
        return (n = t, ar.ho(n, Zn.store)).put(Zn.key, e);
        /**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */        var n;
    }, t.prototype.ea = function(t, e) {
        return Sn(t).put(this.serializer.oa(e));
    }, 
    /**
    ...
    t.prototype.sa = function(t, e) {
        ...
        // depends on the queryTargets index to be efficient.
                return Sn(t).Ro({
            range: i,
            index: Xn.queryTargetsIndexName
        }, (function(t, r, i) {
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = an(e.path);
            i.push(o.put(new Jn(n, s))), i.push(r.Ao.gn(t, e));
        })), ze.Un(i);
        ...
        // IndexedDb.
            ...
            var o = an(e.path);
            return ze.Un([ i.delete([ n, o ]), r.Ao.yn(t, e) ]);
        }));
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Ln(t), i = ie();
        return r.Ro({
            range: n,
            wo: !0
        }, (function(t, e, n) {
            var r = fn(t[1]), o = new V(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.Fn = function(t, e) {
        var n = an(e.path), r = IDBKeyRange.bound([ n ], [ qe(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ln(t).Ro({
    ...
    t.prototype.si = function(t, e) {
        var n = this;
        return Sn(t).get(e).next((function(t) {
 ...
 */
function Sn(t) {
    return ar.ho(t, Xn.store);
}

function kn(t) {
    return ln.ho(t, Zn.store).get(Zn.key).next((function(t) {
        return Le(null !== t), t;
    }));
}
 ...
 */ var Rn = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Pn(t).get(Vn(e)).next((function(t) {
            return n.fa(t);
        }));
    }, 
    /**
    ...
    t.prototype.wa = function(t, e) {
        var n = this, r = Zt(), i = new Kt(V.N);
        return this.Ia(t, e, (function(t, e) {
            var o = n.fa(e);
            o ? (r = r.me(t, o), i = i.me(t, qn(e))) : (r = r.me(t, null), i = i.me(t, 0));
        })).next((function() {
            return {
                Ra: r,
                ma: i
        ...
        if (n.isEqual(D.min())) {
            ...
            /* open= */ !0), s.index = Qn.collectionReadTimeIndex;
        }
        return Pn(t).Ro(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.q(u.key.path) ? u instanceof St && e.matches(u) && (i = i.me(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    t.prototype.Va = function(t, e) {
        var n = this, r = Jt(), i = this.serializer.Aa(e), o = Pn(t), s = IDBKeyRange.lowerBound(i, !0);
        return o.Ro({
            index: Qn.readTimeIndex,
            range: s
        }, (function(t, e) {
    ...
    t.prototype.ya = function(t) {
        ...
        return On(t).get(Yn.key).next((function(t) {
            return Le(!!t), t;
        }));
    }, t.prototype.da = function(t, e) {
        return On(t).put(Yn.key, e);
    }, 
    /**
    ...
    t.prototype.fa = function(t) {
        if (t) {
            ...
            return e instanceof kt && e.version.isEqual(D.min()) ? null : e;
        }
        return null;
    }, t;
}();
 ...
 */ function On(t) {
    return ar.ho(t, Yn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Pn(t) {
    return ar.ho(t, Qn.store);
}
 ...
 */ Rn.va = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Ca = t, r.Sa = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.Fa = new Me((function(t) {
            return t.toString();
        })), r;
    }
    return t(n, e), n.prototype.Zn = function(t) {
        var e = this, n = [], r = 0, i = new Qt((function(t, e) {
            return Pe(t.j(), e.j());
        }));
        return this.Wn.forEach((function(o, s) {
            ...
            if (s) {
                ...
                var h = e.Ca.serializer.Na(new kt(o, D.min()), e.readTime);
                n.push(e.Ca.Gn(t, o, h));
            } else n.push(e.Ca.Hn(t, o));
        })), i.forEach((function(r) {
            n.push(e.Ca.rr.Fo(t, r));
        })), n.push(this.Ca.updateMetadata(t, r)), ze.Un(n);
...
var Un = /** @class */ function() {
    ...
    return t.prototype.Fo = function(t, e) {
        return this.ka.add(e), ze.resolve();
    }, t.prototype.wr = function(t, e) {
        return ze.resolve(this.ka.getEntries(e));
    }, t;
}(), Cn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.O(), n = t.M(), r = this.index[e] || new Qt(R.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.O(), n = t.M(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Qt(R.N)).W();
    }, t;
}(), Mn = 10, jn = /** @class */ function() {
    function t(t) {
        this.serializer = t;
    }
    /**
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        ...
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore(Gn.store, {
                ...
                keyPath: zn.keyPath,
                autoIncrement: !0
            }).createIndex(zn.userMutationsIndex, zn.userMutationsKeyPath, {
                unique: !0
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Jn.store), t.deleteObjectStore(Xn.store), t.deleteObjectStore(Zn.store);
        }(t), tr(t)), s = s.next((function() {
            /**
     ...
     */
            return function(t) {
                var e = t.store(Zn.store), n = new Zn(
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, D.min().C(), 
                /*targetCount=*/ 0);
                return e.put(Zn.key, n);
            }(o);
        }))), n < 4 && r >= 4 && (0 !== n && (
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(zn.store).To().next((function(n) {
                    t.deleteObjectStore(zn.store), t.createObjectStore(zn.store, {
                        keyPath: zn.keyPath,
                        autoIncrement: !0
                    }).createIndex(zn.userMutationsIndex, zn.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store(zn.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return ze.Un(i);
                }));
            ...
            !function(t) {
                ...
                var e = t.objectStore(Qn.store);
                e.createIndex(Qn.readTimeIndex, Qn.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(Qn.collectionReadTimeIndex, Qn.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(Qn.store).Ro((function(t, n) {
            e += qn(n);
        })).next((function() {
            var n = new Yn(e);
            return t.store(Yn.store).put(Yn.key, n);
        }));
    }, t.prototype.removeAcknowledgedMutations = function(t) {
        var e = this, n = t.store(Gn.store), r = t.store(zn.store);
        return n.To().next((function(n) {
            return ze.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.To(zn.userMutationsIndex, i).next((function(r) {
                    return ze.forEach(r, (function(r) {
                        Le(r.userId === n.userId);
                        var i = e.serializer.ko(r);
                        return In(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store(Jn.store), n = t.store(Qn.store);
        return Dn(t).next((function(t) {
            ...
            return n.Ro((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? ze.resolve() : function(n) {
                        return e.put(new Jn(0, an(n), t));
                    }(o);
                })));
            })).next((function() {
                return ze.Un(r);
        ...
        var n = e.store($n.store), r = new Cn, i = function(t) {
            if (r.add(t)) {
                var e = t.O(), i = t.M();
                return n.put({
                    collectionId: e,
        ...
        // Index existing remote documents.
                return e.store(Qn.store).Ro({
            wo: !0
        }, (function(t, e) {
            var n = new R(t);
            return i(n.M());
        })).next((function() {
            return e.store(Kn.store).Ro({
                wo: !0
            }, (function(t, e) {
                t[0];
                var n = t[1], r = (t[2], fn(n));
                return i(r.M());
            }));
        }));
    }, t.prototype.rewriteCanonicalIds = function(t) {
        var e = this, n = t.store(Xn.store);
...
/** Name of the IndexedDb object store.  */ Gn.store = "mutationQueues", 
...
/** Name of the IndexedDb object store.  */ zn.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
zn.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
zn.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
zn.userMutationsKeyPath = [ "userId", "batchId" ];
...
/**
     ...
     */
Qn.readTimeIndex = "readTimeIndex", Qn.readTimeIndexPath = "readTime", 
/**
     ...
     */
Qn.collectionReadTimeIndex = "collectionReadTimeIndex", Qn.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
Yn.store = "remoteDocumentGlobal", Yn.key = "remoteDocumentGlobalKey";
...
Xn.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
Xn.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
 ...
 */ Zn.key = "targetGlobalKey", Zn.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ function tr(t) {
    ...
    t.createObjectStore(Xn.store, {
        keyPath: Xn.keyPath
    }).createIndex(Xn.queryTargetsIndexName, Xn.queryTargetsKeyPath, {
        unique: !0
    }), t.createObjectStore(Zn.store);
}
...
var nr = r(r(r([ Gn.store, zn.store, Kn.store, Qn.store, Xn.store, Bn.store, Zn.store, Jn.store ], [ er.store ]), [ Yn.store ]), [ $n.store ]), rr = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.Fo = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ qe(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return ir(t).To(r).next((function(t) {
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ var or = /** @class */ function() {
    function t(t) {
        this.Ma = t;
    }
    /** Decodes a remote document from storage locally to a Document. */    return t.prototype.Pa = function(t) {
        ...
        if (t.noDocument) {
            var e = V.st(t.noDocument.path), n = this.La(t.noDocument.readTime);
            return new kt(e, n, {
                hasCommittedMutations: !!t.hasCommittedMutations
            });
        }
        if (t.unknownDocument) {
            var r = V.st(t.unknownDocument.path), i = this.La(t.unknownDocument.version);
            return new Dt(r, i);
        }
        return De();
    }, 
    /** Encodes a document for storage locally. */ t.prototype.Na = function(t, e) {
        ...
        if (t instanceof kt) {
            ...
            return new Qn(
            /* unknownDocument= */ null, new Wn(s, u), 
            /* document= */ null, a, n, r);
        }
        if (t instanceof Dt) {
            var c = t.key.path.W(), h = this.xa(t.version);
            return new Qn(new Hn(c, h), 
            /* noDocument= */ null, 
            /* document= */ null, 
        ...
        var e = t.C();
        return new Fn(e.seconds, e.nanoseconds);
    ...
    /** Encodes a batch of mutations into a DbMutationBatch for local storage. */ t.prototype.Co = function(t, e) {
        ...
        return new zn(t, e.batchId, e.Tn.toMillis(), r, i);
    }, 
    /** Decodes a DbMutationBatch into a MutationBatch */ t.prototype.ko = function(t) {
        ...
        return new je(t.batchId, i, n, r);
    }, 
    /** Decodes a DbTarget into TargetData */ t.prototype.ha = function(t) {
        var e, n = this.La(t.readTime), r = void 0 !== t.lastLimboFreeSnapshotVersion ? this.La(t.lastLimboFreeSnapshotVersion) : D.min();
        return e = void 0 !== t.query.documents ? this.Ma.Oi(t.query) : this.Ma.Wi(t.query), 
        new Ft(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, n, r, M.fromBase64String(t.resumeToken));
    }, 
    /** Encodes TargetData into a DbTarget for storage locally. */ t.prototype.oa = function(t) {
        ...
        // lastListenSequenceNumber is always 0 until we do real GC.
                return new Xn(t.targetId, t.target.canonicalId(), n, i, t.sequenceNumber, r, e);
    }, t;
}(), sr = "Another tab has exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs.", ur = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).qo = t, r.Oa = n, r;
    }
    return t(n, e), n;
}(He), ar = /** @class */ function() {
    function t(e, n, r, i, o, s, u, a) {
        ...
        }, !t.so()) throw new T(I.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        if (this.Ao = new fr(this, o), this.Ga = n + t.za, this.serializer = new or(u), 
        this.document = i.document, this.Ha = new xn(this.Ao, this.serializer), this.rr = new rr, 
        this.ir = new Rn(this.serializer, this.rr), !i.window || !i.window.localStorage) throw new T(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        this.window = i.window, this.Ya = this.window.localStorage;
    }
    return t.ho = function(t, e) {
        if (t instanceof ur) return ln.ho(t.qo, e);
        throw De();
    }, 
    /**
    ...
    t.prototype.start = function() {
        var t = this;
        return ln.eo(this.Ga, Mn, new jn(this.serializer)).then((function(e) {
            return t.Ja = e, t.Xa();
        })).then((function() {
            return t.Za(), t.tu(), t.eu(), t.Ja.runTransaction("readonly", [ Zn.store ], (function(t) {
                return Dn(t);
            }));
        })).then((function(e) {
            t.su = new Xe(e, t.Ba);
    ...
    t.prototype.iu = function(t) {
        ...
        return this.Ka = function(i) {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(e) {
                    return this.Uh ? [ 2 /*return*/ , t(i) ] : [ 2 /*return*/ ];
                }));
            }));
        }, t(this.isPrimary);
    }, 
    ...
    t.prototype.Xa = function() {
        var t = this;
        return this.Ja.runTransaction("readwrite", nr, (function(e) {
            return hr(e).put(new er(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return cr(t).get(Bn.key).next((function(t) {
            return ze.resolve(e.cu(t));
        }));
                ...
                switch (n.label) {
                  case 0:
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(n) {
                        var r = t.ho(n, er.store);
                        return r.To().next((function(t) {
                            var n = e.fu(t, 18e5), i = t.filter((function(t) {
                                return -1 === n.indexOf(t);
                            }));
                            // Delete metadata for clients that are no longer considered active.
                                                        return ze.forEach(i, (function(t) {
                  ...
                  case 1:
                    ...
                    n.sent().forEach((function(t) {
                        e.window.localStorage.removeItem(e.Tu(t.clientId));
                    })), n.label = 2;
    ...
    t.prototype.ou = function(t) {
        var e = this;
        return cr(t).get(Bn.key).next((function(n) {
            ...
            if (null !== n && e.du(n.leaseTimestampMs, 5e3) && !e.Eu(n.ownerId)) {
                ...
                if (!e.cu(n)) {
                    ...
                    throw new T(I.FAILED_PRECONDITION, sr);
                    return !1;
                }
            }
            return !(!e.networkEnabled || !e.inForeground) || hr(t).To().next((function(t) {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.mu(), [ 4 /*yield*/ , this.Ja.runTransaction("readwrite", [ Bn.store, er.store ], (function(e) {
    ...
    t.prototype.Pu = function() {
        var t = this;
        return this.Ja.runTransaction("readonly", [ er.store ], (function(e) {
            return hr(e).To().next((function(e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return t.so() ? (e = r + t.za, [ 4 /*yield*/ , ln.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
        ...
        return En.Vo(t, this.serializer, this.rr, this.Ao);
        ...
        return this.Ja.runTransaction(o, nr, (function(o) {
            return i = new ur(o, r.su.next()), "readwrite-primary" === e ? r.hu(o).next((function(t) {
                return !!t || r.ou(o);
            })).next((function(e) {
                if (!e) throw Se("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Sr.Hr((function() {
                    return r.Ka(!1);
                })), new T(I.FAILED_PRECONDITION, We);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.bu = function(t) {
        var e = this;
        return cr(t).get(Bn.key).next((function(t) {
            if (null !== t && e.du(t.leaseTimestampMs, 5e3) && !e.Eu(t.ownerId) && !e.cu(t) && !t.allowTabSynchronization) throw new T(I.FAILED_PRECONDITION, sr);
        }));
    }, 
    /**
    ...
    t.prototype.uu = function(t) {
        var e = new Bn(this.clientId, this.allowTabSynchronization, Date.now());
        return cr(t).put(Bn.key, e);
    }, t.so = function() {
        return ln.so();
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.au = function(t) {
        var e = this, n = cr(t);
        return n.get(Bn.key).next((function(t) {
            return e.cu(t) ? (xe("IndexedDbPersistence", "Releasing primary lease."), n.delete(Bn.key)) : ze.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.du = function(t, e) {
        var n = Date.now();
        return !(t < n - e || t > n && (Se("Detected an update time that is in the future: " + t + " > " + n), 
        1));
    ...
    t.prototype.Eu = function(t) {
        try {
            ...
            return Se("IndexedDbPersistence", "Failed to get zombied client id.", t), !1;
        }
    }, 
    /**
    ...
    t.prototype.wu = function() {
        try {
            ...
            Se("Failed to set zombie client id.", t);
        }
    }, 
 ...
 */ function hr(t) {
    return t.store(er.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ ar.za = "main";

var fr = /** @class */ function() {
    function t(t, e) {
        this.db = t, this.Su = null, this.Lh = new un(this, e);
    }
    ...
    t.prototype.Nu = function(t, e) {
        return this.Su.Fn(e) ? ze.resolve(!0) : function(t, e) {
            var n = !1;
            return _n(t).mo((function(r) {
                return bn(t, r, e).next((function(t) {
                    return t && (n = !0), ze.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n.Nu(t, s).next((function(e) {
                    ...
                    return o++, r.Yn(t, s).next((function() {
                        return r.Hn(s), Ln(t).delete([ 0, an(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var pr = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.Ou = D.min(), this.persistence.Ao.Fu(this.Mu), this.nr = t.Vu(n), this.Bu = t.pu(), 
        this.Ha = t.gu(), this.qu = new Qe(this.Bu, this.nr, this.persistence.yu()), this.$u.Uu(this.qu)
    ...
    t.prototype.Qu = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.nr, r = this.qu, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.nr.xo(n).next((function(s) {
                            return i = s, e = o.persistence.Vu(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new Qe(o.Bu, e, o.persistence.yu()), e.xo(n);
                        })).next((function(t) {
                            ...
                            // of mutation batch IDs that were affected by change.
                                                        return r.cr(n, s).next((function(t) {
                                return {
                                    Wu: t,
                                    ju: e,
                                    Ku: o
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.nr = e, this.qu = r, this.$u.Uu(this.qu), 
                    i) ];
                }
            }));
        }));
    ...
    t.prototype.Hu = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.nr.No(n, t).next((function(t) {
                return Le(null !== t), r = t.keys(), e.nr.Bo(n, t);
            })).next((function() {
                return e.nr.Wo(n);
            })).next((function() {
                return e.qu.cr(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, c).next((function(t) {
                e.cs.forEach((function(i, c) {
                    ...
                    // cache.
                                        c instanceof kt && c.version.isEqual(D.min()) ? (
                    ...
                    a = a.me(i, c)) : xe("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", h.version, " Watch version:", c.version), 
    ...
    t.Ju = function(t, e, n) {
        ...
        return Le(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.Ee.D() - t.Ee.D() >= this.Xu || n.Ts.size + n.Es.size + n.Is.size > 0);
    ...
    t.prototype.Zu = function(t) {
        ...
        return this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(n) {
            return ze.forEach(t, (function(t) {
                return ze.forEach(t.Pr, (function(t) {
    ...
    t.prototype.sc = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Ha.ua(n, t).next((function(i) {
                ...
                r = i, ze.resolve(r)) : e.Ha.zo(n).next((function(i) {
                    return r = new Ft(t, i, 0 /* Listen */ , n.Oa), e.Ha.ta(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.ua = function(t, e) {
        var n = this.xu.get(e);
        return void 0 !== n ? ze.resolve(this.Lu.get(n)) : this.Ha.ua(t, e);
    }, 
    /**
    ...
    t.prototype.ic = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(i) {
            ...
            var o = n.Mu.Sn(t);
            return e ? ze.resolve() : ze.forEach(o, (function(t) {
    ...
    t.prototype.nc = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.ua(o, t.ee()).next((function(t) {
                ...
                return n.$u.dr(o, t, e ? r : D.min(), e ? i : ie());
            })).next((function(t) {
                return {
                    documents: t,
                    rc: i
    ...
    t.prototype.hc = function(t) {
        ...
        var r = this, i = e.batch, o = i.keys(), s = ze.resolve();
        return o.forEach((function(r) {
            s = s.next((function() {
                return n.Yn(t, r);
            })).next((function(t) {
                var o = t, s = e.Rn.get(r);
                Le(null !== s), (!o || o.version.S(s) < 0) && ((o = i.at(r, o, e)) && 
 ...
 */ function yr(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== I.FAILED_PRECONDITION || t.message !== We) throw t;
 ...
 */ function vr(t, e) {
    if (0 !== e.length) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + Or(e.length, "argument") + ".");
}
 ...
 */ function mr(t, e, n) {
    if (e.length !== n) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires " + Or(n, "argument") + ", but was called with " + Or(e.length, "argument") + ".");
}
 ...
 */ function gr(t, e, n) {
    if (e.length < n) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires at least " + Or(n, "argument") + ", but was called with " + Or(e.length, "argument") + ".");
}
 ...
 */ function wr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + Or(e.length, "argument") + ".");
}
...
function Nr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = xr(r);
        throw new T(I.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
...
function Sr(t, e, n) {
    if (void 0 === n) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + Rr(e) + " argument, but it was undefined.");
}
 ...
 */ function Dr(t, e, n, r) {
    var i = xr(r);
    return new T(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + Rr(n) + " argument to be a " + e + ", but it was: " + i);
}

function Lr(t, e, n) {
    if (n <= 0) throw new T(I.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + Rr(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Base64 functions are available at runtime. */ function Vr() {
    if (!Te.nt()._c) throw new T(I.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var qr = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        Vr();
        try {
            return new t(M.fromBase64String(e));
        } catch (e) {
            throw new T(I.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
        if (mr("Blob.fromUint8Array", arguments, 1), Pr(), !(e instanceof Uint8Array)) throw Dr("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(M.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return mr("Blob.toBase64", arguments, 0), Vr(), this.lc.toBase64();
    }, t.prototype.toUint8Array = function() {
        return mr("Blob.toUint8Array", arguments, 0), Pr(), this.lc.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new T(I.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + Or(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (Er("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new T(I.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.dc = new P(t);
    }
    return t.documentId = function() {
        return t.fc;
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Dr("isEqual", "FieldPath", 1, e);
 ...
 */
var Cr = new RegExp("[~\\*/\\[\\]]"), Mr = function(t) {
    this.Tc = t;
}, jr = /** @class */ function(e) {
    function n() {
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayUnion") || this).wc = t, n;
    }
    return t(n, e), n.prototype.Di = function(t) {
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayRemove") || this).wc = t, n;
    }
    return t(n, e), n.prototype.Di = function(t) {
        // Although array transforms are used with writes, the actual elements
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.increment") || this).Ac = t, n;
    }
    return t(n, e), n.prototype.Di = function(t) {
        t.Rc({
            methodName: this.Tc
        });
        var e = Zr(this.Ac, t), n = new ht(t.serializer, e);
        return new pt(t.path, n);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(Mr), Kr = /** @class */ function() {
    function t(t, e) {
     ...
     */
    t.prototype.p = function(t) {
        return Pe(this.Pc, t.Pc) || Pe(this.Vc, t.Vc);
    }, t;
}(), Wr = /^__.*__$/, Hr = /** @class */ function() {
    function t(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var Xr = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Rc = function(e) {
        ...
        return new T(I.INVALID_ARGUMENT, "Function " + this.settings.methodName + "() called with invalid data. " + t + e);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Yr(this.Ec) && Wr.test(t)) throw this.Ic('Document fields cannot begin and end with "__"');
    }, t;
}(), Jr = /** @class */ function() {
    function t(t, e) {
        this.ii = t, this.serializer = e || Te.nt().Dc(t)
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Nc = function(t, e, n) {
        ...
        var i, o, s = $r(e, r);
        if (n) {
            for (var u = [], a = 0, c = n; a < c.length; a++) {
                var h = c[a], f = void 0;
                if (h instanceof Ur) f = h.dc; else {
                    if ("string" != typeof h) throw De();
                    f = ri(t, h);
                }
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.$c = function(t, e, n, r) {
        ...
        for (var a = [], c = new Tt, h = o.length - 1; h >= 0; --h) if (!ii(a, o[h])) {
        ...
        var y = new lt(a);
        return new Qr(c.yt(), y, i.fieldTransforms);
    }, 
    ...
    t.prototype.Mc = function(t, e, n) {
        return void 0 === n && (n = !1), Zr(e, this.Fc(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Zr(t, e) {
    if (ti(t)) return ei("Unsupported field value:", e, t), $r(t, e);
    if (t instanceof Mr) 
    ...
    return function(t, e) {
        ...
        if (!Yr(e.Ec)) throw e.Ic(t.Tc + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Ic("Unsupported field value: " + xr(t));
    }(t, e);
}
...
function $r(t, e) {
    ...
    e.path && e.path.length > 0 && e.Vt.push(e.path) : U(t, (function(t, r) {
        var i = Zr(r, e.yc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function ti(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof k || t instanceof Kr || t instanceof qr || t instanceof Ji || t instanceof Mr);
}
 ...
 */ function ni(t, e) {
    if (e instanceof Ur) return e.dc;
 ...
 */ function ri(t, e) {
    try {
        return function(t) {
            if (t.search(Cr) >= 0) throw new T(I.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (Ur.bind.apply(Ur, r([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var oi = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.Uc = 0, this.Qc = null, this.stream = null, this.ih = new Ze(t, e)
        /**
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.ih.reset() : r && r.code === I.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    Se(r.toString()), Se("Using maximum backoff delay to prevent overloading the backend."), 
                    this.ih.Lr()) : r && r.code === I.UNAUTHENTICATED && 
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Zc(r) ];
    ...
    t.prototype.t_ = function(t) {
        ...
        return function(n) {
            e.Sr.Hr((function() {
                return e.Uc === t ? n() : (xe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    function n(t, n, r, i, o) {
        ...
        /**
             ...
             * next request.
             */
        s.lastStreamToken = M.ht, s;
    }
    return t(n, e), Object.defineProperty(n.prototype, "c_", {
        /**
    ...
    n.prototype.start = function() {
        this.u_ = !1, e.prototype.start.call(this);
        ...
        Le(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.u_) {
        ...
        // The first response is always the handshake response
                return Le(!t.writeResults || 0 === t.writeResults.length), this.u_ = !0, 
        this.listener.d_();
    }, 
    /**
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Bc = t, i.credentials = n, i.serializer = r, i;
    }
    /** Gets an auth token and invokes the provided RPC. */    return t(n, e), n.prototype.E_ = function(t, e) {
        var n = this;
    ...
    function t(t) {
        ...
        this.R_ = ne(), this.mutations = [], this.m_ = !1, 
        /**
    ...
    return t.prototype.V_ = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.g_(), this.mutations.length > 0) throw new T(I.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof kt || t instanceof St ? i.p_(t) : De();
                    })), r) ];
                }
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return i.sent(), this.m_ = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.set = function(t) {
        ...
        this.D_ ? (Se(e), this.D_ = !1) : xe("OnlineStateTracker", e);
    ...
    r, i, o, s) {
            ...
            i.Hr((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.W_() ? (xe("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.G_ = function(t, e, n) {
            var r = Re(t);
            return new si(e, r.Bc, r.credentials, r.serializer, n);
        }(this.w_, i, {
            ...
            var r = Re(t);
            return new ui(e, r.Bc, r.credentials, r.serializer, n);
        }(this.w_, i, {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.x_.length > 0 && (xe("RemoteStore", "Stopping write stream with " + this.x_.length + " pending writes"), 
    ...
    t.prototype.ul = function(t) {
        ...
        this.B_ = new ve(this), this.G_.start(), this.K_.C_();
    }, 
    /**
    ...
    t.prototype.sl = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.K_.set("Online" /* Online */), !(t instanceof de && 2 /* Removed */ === t.state && t.cause)) 
                  ...
                  case 3:
                    return e = n.sent(), xe("RemoteStore", "Failed to remove targets %s: %s ", t.targetIds.join(","), e), 
                    [ 4 /*yield*/ , this.ll(e) ];
                  ...
                  case 6:
                    if (t instanceof le ? this.B_.qs(t) : t instanceof pe ? this.B_.Hs(t) : this.B_.Ws(t), 
                    r.isEqual(D.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;

                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.L_.Jo() ];
                  ...
                  case 11:
                    return xe("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.ll(o) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    // Disable network and raise offline snapshots
                    return i.sent(), this.K_.set("Offline" /* Offline */), 
                            ...
                            return n(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    ...
                                    return xe("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , this.L_.Jo() ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.O_.has(o) ? [ 4 /*yield*/ , this.cl.fl(o, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    n.sent(), this.O_.delete(o), this.B_.removeTarget(o), n.label = 3;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return null !== (e = n.sent()) ? [ 3 /*break*/ , 2 ] : (0 === this.x_.length && this.J_.zc(), 
                    [ 3 /*break*/ , 4 ]);

                  case 2:
                    return this.El(e), [ 4 /*yield*/ , this.nl() ];
    ...
    t.prototype.El = function(t) {
        ...
        var n = this, r = this.x_.shift(), i = Fe.from(r, t, e, this.J_.lastStreamToken);
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                ...
                return Gt(t.code) ? [ 2 /*return*/ , (xe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.J_.lastStreamToken), 
                this.J_.lastStreamToken = M.ht, this.L_.So(M.ht).catch(yr)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Al = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                // logic kick in.
                return Gt(r = t.code) && r !== I.ABORTED ? (e = this.x_.shift(), [ 2 /*return*/ , (this.J_.Gc(), 
                this.cl.Vl(e.batchId, t).then((function() {
                    return i.nl();
                }))) ]) : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.gl = function() {
        return new ci(this.w_);
            ...
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    xe("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.j_() ]) : [ 3 /*break*/ , 2 ];
...
var yi = /** @class */ function() {
    ...
    return t.bl = function(e, n, r) {
        ...
        o ? new t(e, n, i.state, s) : (Se("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.bl = function(e, n) {
        ...
        i ? new t(e, r.state, o) : (Se("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.vl = function() {
        var t = {
            state: this.state,
    ...
    return t.bl = function(e, n) {
        ...
        return i ? new t(e, o) : (Se("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), gi = /** @class */ function() {
    function t(t, e) {
    ...
    return t.bl = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (Se("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), wi = /** @class */ function() {
    function t() {
    ...
    function t(e, n, r, i, o) {
        ...
        this.b_ = null, this.gr = null, this.Fl = this.Nl.bind(this), this.kl = new Kt(Pe), 
        this.Uh = !1, 
        /**
             * Captures WebStorage events that occur before `start()` is called. These
             * events are replayed once `WebStorageSharedClientState` is started.
             */
        this.$l = [], !t.so(this.platform)) throw new T(I.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                var s = r.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = o, this.Ml = li(this.persistenceKey, this.Cl), 
        this.Ll = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.kl = this.kl.me(this.Cl, new wi), this.xl = new RegExp("^firestore_clients_" + s + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.so = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.Cl && (o = this.getItem(li(this.persistenceKey, i))) && (s = mi.bl(i, o)) && (this.kl = this.kl.me(s.clientId, s));
        ...
        if (t.storageArea === this.storage) {
            if (xe("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Ml) return void Se("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Sr.dh((function() {
                return e(r, void 0, void 0, (function() {
                    var e, r, i, o, s, u;
                    return n(this, (function(n) {
                        if (this.Uh) {
                            if (null !== t.key) if (this.xl.test(t.key)) {
                                ...
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                    Le("number" == typeof n), e = n;
                                } catch (t) {
                                    Se("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }(t.newValue)) !== Xe.vr && this.gr(u);
                        } else this.$l.push(t);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    t.prototype.Ql = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.cl.Ed(t.batchId, t.state, t.error) ] : (xe("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    }, t.prototype.Td = function(t) {
    ...
    function t() {
        this.Rd = new wi, this.md = {}, this.cl = null, this.b_ = null, this.gr = null;
    }
    return t.prototype.zl = function(t) {
        ...
        return this.Rd = new wi, Promise.resolve();
    }, t.prototype.Qu = function(t, e, n) {
        // No op.
    }, t.prototype.hd = function(t) {
        // No op.
    ...
    e) {
        ...
        this.ns = ie(), this.gd = new ue(t.se.bind(t));
    }
    ...
    t.prototype.yd = function(t, e) {
        var n = this, r = e ? e.bd : new ae, i = e ? e.gd : this.gd, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, c = this.query.ae() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.Pd = u, 0 !== o.length || a ? {
            snapshot: new ce(this.query, t.gd, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Fd: s
        } : {
            Fd: s
    ...
    t.prototype.Dd = function(t) {
        ...
        // updating many documents.
                var e = this.Vd;
        this.Vd = ie(), this.gd.forEach((function(e) {
            t.kd(e.key) && (t.Vd = t.Vd.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Vd.has(e) || n.push(new Ti(e));
        })), this.Vd.forEach((function(t) {
            e.has(t) || n.push(new Ii(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.Md = function() {
        return ce.os(this.query, this.gd, this.ns, 0 /* Local */ === this.Pd);
    }, t;
}(), _i = /** @class */ function() {
    function t(t, e, n, r) {
        this.qr = t, this.Ld = e, this.updateFunction = n, this.Wr = r, this.xd = 5, this.ih = new Ze(this.qr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.Od = function() {
        ...
        this.ih.xr((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = this.Ld.gl(), (e = this.qd(t)) && e.then((function(e) {
                        r.qr.Hr((function() {
        ...
        try {
            ...
            return !j(e) && e.catch && e.then ? e : (this.Wr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    n, r, i) {
        ...
        /**
             ...
             */
        this.Xd = new Map, this.Zd = new Be, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.tf = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ef = new Map, this.sf = An.Go(), this.onlineState = "Unknown" /* Unknown */;
    }
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    e = i.targetId, this.jd.Xl(e), r = i.view.Md(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];
                  ...
                  case 3:
                    r = n.sent(), this.if && this.Ld.listen(o), n.label = 4;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), o = new Ni(t, e.rc), s = o.yd(e.documents), u = fe.ds(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Zn(s, 
                    /* updateLimboDocuments= */ this.if, u), this.hf(r, a.Fd), c = new Ai(t, r, o), 
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.jd.td(e.targetId), this.jd.Gl(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.L_.ic(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.jd.sd(e.targetId), i.Ld.al(e.targetId), i.af(e.targetId);
                    })).catch(yr) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.af(e.targetId), [ 4 /*yield*/ , this.L_.ic(e.targetId, 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.L_.Gu(t) ];
                  ...
                  case 3:
                    ...
                    return [ 2 /*return*/ , (Se("SyncEngine", "Dropping write that cannot be persisted: " + i), 
                    void r.reject(new T(I.UNAVAILABLE, "Failed to persist write: " + i))) ];
                    throw i;

                  case 4:
                    return this.jd.zl(e.batchId), this.uf(e.batchId, r), [ 4 /*yield*/ , this.cf(e.Wn) ];

                  case 5:
                    return n.sent(), [ 4 /*yield*/ , this.Ld.nl() ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.L_.Yu(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        Le(t.Ts.size + t.Es.size + t.Is.size <= 1), t.Ts.size > 0 ? n.Wd = !0 : t.Es.size > 0 ? Le(n.Wd) : t.Is.size > 0 && (Le(n.Wd), 
                        n.Wd = !1));
                    })), [ 4 /*yield*/ , this.cf(e, t) ];
    ...
    t.prototype.Nd = function(t, e) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.jd.nd(t, "rejected", r), e = this.Xd.get(t), (i = e && e.key) ? (
                    // Since this query failed, we won't want to manually unlisten to it.
                    // So go ahead and remove it from bookkeeping.
                    this.Jd = this.Jd.remove(i), this.Xd.delete(t), this.lf(), o = (o = new Kt(V.N)).me(i, new kt(i, D.min())), 
                    s = ie().add(i), u = new he(D.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Qt(Pe), o, s), [ 2 /*return*/ , this.Yu(u) ]) : [ 4 /*yield*/ , this.L_.ic(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.af(t, r);
                    })).catch(yr) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.nf("applySuccessfulWrite()"), e = t.batch.batchId, 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught
                    // up), so we raise user callbacks first so that they consistently happen
                    // before listen events.
                    this.df(e, /*error=*/ null), this.ff(e), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.L_.yo(t) ];

                  case 2:
                    return r = n.sent(), this.jd.Yl(e, "acknowledged"), [ 4 /*yield*/ , this.cf(r) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // listen events.
                    this.df(t, r), this.ff(t), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.L_.Hu(t) ];

                  case 2:
                    return e = n.sent(), this.jd.Yl(t, "rejected", r), [ 4 /*yield*/ , this.cf(e) ];
    ...
    t.prototype.Tf = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Ld.W_() || xe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    [ 4 /*yield*/ , this.L_.Lo() ];

                  case 1:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.ef.get(e) || []).push(t), 
                    this.ef.set(e, r), [ 2 /*return*/ ]);
                }
            }));
        }));
    }, 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Ef = function(t) {
        ...
        n || (n = new Kt(Pe)), n = n.me(t, e), this.tf[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.df = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Ii ? (this.Zd.gn(i.key, t), this.Rf(i)) : i instanceof Ti ? (xe("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.Jd.get(e) || (xe("SyncEngine", "New document in limbo: " + e), this.Yd.push(e), 
        this.lf());
    }, 
    /**
    ...
    t.prototype.lf = function() {
        for (;this.Yd.length > 0 && this.Jd.size < this.Kd; ) {
            ...
            this.Xd.set(e, new xi(t)), this.Jd = this.Jd.me(t, e), this.Ld.listen(new Ft(Rt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Xe.vr));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.Af = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.zd.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var n = r && r.as.get(u.targetId), o = u.view.Zn(t, 
                            ...
                            if (s.hf(u.targetId, o.Fd), o.snapshot) {
                                ...
                                var a = Ye.Vr(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return n.sent(), this.Gd.h_(e), [ 4 /*yield*/ , this.L_.Zu(i) ];
        ...
        var e = this.Xd.get(t);
        if (e && e.Wd) return ie().add(e.key);
        var n = ie(), r = this.Hd.get(t);
        if (!r) return n;
    ...
    function i(t, e, n, i, o) {
        var s = this;
        return (s = r.call(this, t, e, n, i, o) || this).L_ = t, 
    ...
    return t(i, r), Object.defineProperty(i.prototype, "if", {
        ...
        return this.L_.ru(!0), r.prototype.enableNetwork.call(this);
    }, i.prototype.disableNetwork = function() {
        return this.L_.ru(!1), r.prototype.disableNetwork.call(this);
    }, 
    /**
    ...
    i.prototype.Pf = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), r = t.view.$d(e), [ 2 /*return*/ , (this.isPrimary && this.hf(t.targetId, r.Fd), 
                    r) ];
                }
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return null === (e = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== r ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.Ld.nl() ];
                  ...
                  case 3:
                    ...
                    // other clients.
                    this.df(t, i || null), this.L_.uc(t)) : De(), n.label = 4;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), e = this.jd.jl(), [ 4 /*yield*/ , this.Vf(e.W()) ];

                  case 2:
                    for (r = n.sent(), i = 0, o = r; i < o.length; i++) s = o[i], this.Ld.listen(s);
                    return [ 3 /*break*/ , 7 ];
                  ...
                  case 5:
                    return n.sent(), this.gf(), [ 4 /*yield*/ , this.Ld.yl(!1) ];
        ...
        this.Xd.forEach((function(e, n) {
            t.Ld.al(n);
        })), this.Zd.Dn(), this.Xd = new Map, this.Jd = new Kt(V.N);
    }, 
    /**
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    return n.sent(), [ 4 /*yield*/ , this.L_.sc(a[0].ee()) ];
                  ...
                  case 9:
                    return d = n.sent(), [ 4 /*yield*/ , this.L_.sc(d) ];

                  case 10:
                    return u = n.sent(), [ 4 /*yield*/ , this.rf(this.pf(d), s, 
                    /*current=*/ !1) ];
                  ...
                  case 14:
                    return [ 2 /*return*/ , (this.Gd.h_(r), e) ];
                }
            }));
        }));
    }, 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    return e = n.sent(), o = he.ls(t, "current" === r), [ 4 /*yield*/ , this.cf(e, o) ];
            ...
            return n(this, (function(d) {
                switch (d.label) {
                  ...
                  case 1:
                    ...
                    xe("SyncEngine", "Adding an already active target " + o), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , this.L_.cc(o) ]) : [ 3 /*break*/ , 6 ];
    ...
    function t(t) {
        this.cl = t, this.vf = new Me((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.vf.get(e)) || (r = !0, i = new Di), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;
                  ...
                  case 2:
                    return o.yf = n.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (s = n.sent(), Se("EventManager", u = "Initialization of query '" + e + "' failed: " + s), 
                    "IndexedDbTransactionError" !== s.name) throw s;
                    return [ 2 /*return*/ , void t.onError(new T(I.UNAVAILABLE, u)) ];

                  case 4:
                    return this.vf.set(e, i), i.bf.push(t), 
        ...
        return e(this, void 0, void 0, (function() {
            var e, r, i, o;
            return n(this, (function(n) {
                return e = t.query, r = !1, (i = this.vf.get(e)) && (o = i.bf.indexOf(t)) >= 0 && (i.bf.splice(o, 1), 
                r = 0 === i.bf.length), r ? [ 2 /*return*/ , (this.vf.delete(e), this.cl.al(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.h_ = function(t) {
    ...
    return t.prototype.Df = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new ce(t.query, t.docs, t.ss, e, t.ns, t.fromCache, t.rs, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Nd = function(t) {
        ...
        t = ce.os(t.query, t.docs, t.ns, t.fromCache), this.$f = !0, this.kf.next(t);
    }, t;
}(), Oi = /** @class */ function() {
    function t() {}
    return t.prototype.Uu = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(D.min()) ? this.Uf(t, e) : this.qf.cr(t, r).next((function(o) {
            var u = i.Qf(e, o);
            return (e.oe() || e.ae()) && i.Sd(e.Bt, u, r, n) ? i.Uf(t, e) : (_e() <= s.DEBUG && xe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            i.qf.dr(t, e, n).next((function(t) {
    ...
    t.prototype.Sd = function(t, e, n, r) {
        ...
        return _e() <= s.DEBUG && xe("IndexFreeQueryEngine", "Using full collection scan to execute query: %s", e.toString()), 
        this.qf.dr(t, e, D.min());
    }, t;
}(), Pi = /** @class */ function() {
    function t(t, e) {
        this.rr = t, this.Ao = e, 
        ...
        this.jf = new Qt(Ge.An);
    }
    return t.prototype.po = function(t) {
        return ze.resolve(0 === this.nr.length);
    }, t.prototype.yo = function(t, e, n) {
        var r = e.batchId, i = this.Kf(r, "acknowledged");
        return Le(0 === i), 
        // Verify that the batch in the queue is the one to be acknowledged.
        this.nr[i], this.lastStreamToken = n, ze.resolve();
    }, t.prototype.vo = function(t) {
        return ze.resolve(this.lastStreamToken);
    }, t.prototype.So = function(t, e) {
        return this.lastStreamToken = e, ze.resolve();
    }, t.prototype.Do = function(t, e, n, r) {
        var i = this.Wf;
        this.Wf++, this.nr.length > 0 && this.nr[this.nr.length - 1];
        var o = new je(i, e, n, r);
        this.nr.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.jf = this.jf.add(new Ge(a.key, i)), this.rr.Fo(t, a.key.path.M());
        }
        return ze.resolve(o);
    }, t.prototype.No = function(t, e) {
        return ze.resolve(this.Gf(e));
    }, t.prototype.Mo = function(t, e) {
        var n = e + 1, r = this.zf(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return ze.resolve(this.nr.length > i ? this.nr[i] : null);
    }, t.prototype.Lo = function() {
        return ze.resolve(0 === this.nr.length ? -1 : this.Wf - 1);
    }, t.prototype.xo = function(t) {
        return ze.resolve(this.nr.slice());
    }, t.prototype.or = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                V.et(i) || (i = i.child(""));
        var o = new Ge(new V(i), 0), s = new Qt(Pe);
        ...
        var n = this;
        Le(0 === this.Kf(e.batchId, "removed")), this.nr.shift();
        var r = this.jf;
        return ze.forEach(e.mutations, (function(i) {
        ...
        var n = new Ge(e, 0), r = this.jf.ze(n);
        return ze.resolve(e.isEqual(r && r.key));
    }, t.prototype.Wo = function(t) {
        return this.nr.length, ze.resolve();
    }, 
    /**
    ...
    t.prototype.Hn = function(t) {
        ...
        for (var r = te(), i = new V(e.path.child("")), o = this.docs.ve(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.ke(); ) {
            var s = o.Ne(), u = s.key, a = s.value, c = a.Ea, h = a.readTime;
            if (!e.path.q(u.path)) break;
            h.S(n) <= 0 || c instanceof St && e.matches(c) && (r = r.me(c.key, c));
        }
        return ze.resolve(r);
    }, t.prototype.Jf = function(t, e) {
        return ze.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.ba = function(e) {
...
var qi = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.tT = new Be, this.targetCount = 0, this.eT = An.Ko();
    }
    return t.prototype.js = function(t, e) {
        ...
        return ze.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.Xo = function(t) {
        return ze.resolve(this.Zf);
    }, t.prototype.zo = function(t) {
        return this.highestTargetId = this.eT.next(), ze.resolve(this.highestTargetId);
    }, t.prototype.Zo = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.eT = new An(e), this.highestTargetId = e), t.sequenceNumber > this.Zf && (this.Zf = t.sequenceNumber);
    }, t.prototype.ta = function(t, e) {
        return this.ea(e), this.targetCount += 1, ze.resolve();
    }, t.prototype.ia = function(t, e) {
        return this.ea(e), ze.resolve();
    }, t.prototype.na = function(t, e) {
        ...
        return this.Xf.forEach((function(s, u) {
            ...
            i++);
        })), ze.Un(o).next((function() {
            return i;
        }));
    }, t.prototype.aa = function(t) {
        return ze.resolve(this.targetCount);
    }, t.prototype.ua = function(t, e) {
        ...
        return this.tT.Sn(e), ze.resolve();
    }, t.prototype.la = function(t, e) {
        var n = this.tT.Cn(e);
        return ze.resolve(n);
    }, t.prototype.Fn = function(t, e) {
        return ze.resolve(this.tT.Fn(e));
    }, t;
}(), Ui = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.sT = {}, this.su = new Xe(0), this.qa = !1, this.qa = !0, this.Ao = t(this), 
        this.Ha = new qi(this), this.rr = new Un, this.ir = new Vi(this.rr, (function(t) {
            return e.Ao.iT(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.sT[t.s()];
        return e || (e = new Pi(this.rr, this.Ao), this.sT[t.s()] = e), e;
    }, t.prototype.gu = function() {
        return this.Ha;
    }, t.prototype.pu = function() {
        return this.ir;
        ...
        return ze.Qn(Object.values(this.sT).map((function(n) {
            return function() {
                return n.Fn(t, e);
            };
        })));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Oa = t, n;
    }
    return t(n, e), n;
}(He), Mi = /** @class */ function() {
    function t(t) {
    ...
    return t.aT = function(e) {
        ...
        return this.uT.delete(e), ze.resolve();
    }, t.prototype.yn = function(t, e) {
        return this.uT.add(e), ze.resolve();
    }, t.prototype.Qo = function(t, e) {
        return this.uT.add(e), ze.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        ...
        // Remove newly orphaned documents.
                return ze.forEach(this.uT, (function(r) {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), this.dT = this.fT(t), this.L_ = this.TT(t), this.Ld = this.ET(t), 
                  ...
                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.Ld.start() ];

                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.Ld.yl(this.cl.if) ];
        ...
        return new pr(this.persistence, new Oi, t.mT);
    }, t.prototype.lT = function(t) {
        return new Ui(Mi.aT);
    }, t.prototype.ET = function(t) {
        var e = this;
        return new fi(this.L_, t.w_, t.qr, (function(t) {
            return e.cl.Nd(t, 0 /* RemoteStore */);
        }), t.platform.AT());
    }, t.prototype._T = function(t) {
        return new bi;
    }, t.prototype.IT = function(t) {
        return new Si(this.L_, this.Ld, this.jd, t.mT, t.Kd);
    ...
    return t(i, r), i.prototype.initialize = function(t) {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    ...
                    return o.sent(), [ 4 /*yield*/ , this.persistence.iu((function(t) {
        ...
        return new dr(this.persistence, new Oi, t.mT);
    }, i.prototype.IT = function(t) {
        var e = new ki(this.L_, this.Ld, this.jd, t.mT, t.Kd);
        return this.jd instanceof Ei && (this.jd.cl = e), e;
    }, i.prototype.fT = function(t) {
        var e = this.persistence.Ao.Lh;
        return new sn(e, t.qr);
    }, i.prototype.lT = function(t) {
        var e = ar.vu(t.PT), n = t.platform.Dc(t.PT.ii);
        return new ar(t.VT.synchronizeTabs, e, t.clientId, t.platform, on.Dh(t.VT.cacheSizeBytes), t.qr, n, this.jd);
    }, i.prototype._T = function(t) {
        if (t.VT.gT && t.VT.synchronizeTabs) {
            if (!Ei.so(t.platform)) throw new T(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var e = ar.vu(t.PT);
            return new Ei(t.qr, t.platform, e, t.clientId, t.mT);
        }
        return new bi;
    }, i.prototype.clearPersistence = function(t) {
        var e = ar.vu(t);
        return ar.clearPersistence(e);
    }, i;
     ...
     */
    r) {
        this.platform = t, this.PT = e, this.credentials = n, this.qr = r, this.clientId = Oe.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials.l((function(s) {
            if (!o) return o = !0, xe("FirestoreClient", "Initializing. user=", s.uid), n.yT(t, e, s, i).then(r.resolve, r.reject);
            n.qr.Hr((function() {
                return n.pl(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.yT = function(t, r, i, o) {
        return e(this, void 0, void 0, (function() {
            var s, u, a, c, h = this;
            return n(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.bT(this.PT) ];

                  case 1:
                    return s = f.sent(), u = this.platform.Dc(this.PT.ii), a = function(t, e, n) {
                        return new ai(t, e, n);
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.jd = t.jd, this.L_ = t.L_, 
    ...
    t.prototype.pT = function() {
        if (this.qr.hh) throw new T(I.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.pl = function(t) {
        return this.qr.Th(), xe("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.cl.pl(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return this.pT(), this.qr.enqueue((function() {
            ...
            if (t instanceof kt) return null;
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), r = new Ni(t, e.rc), i = r.yd(e.documents), [ 2 /*return*/ , r.Zn(i, 
...
var Ki = /** @class */ function() {
    ...
    return t.prototype.MT = function(t) {
        ...
        return new Kr($(t.latitude), $(t.longitude));
        ...
        var e = Z(t), n = new k(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.OT = function(t) {
        var e = R.K(t);
        Le(Ie(e));
        var n = new Ce(e.get(1), e.get(3)), r = new V(e.$(5));
        return n.isEqual(this.firestore.Lc) || 
        // TODO(b/64130202): Somehow support foreign references.
        Se("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.firestore.Lc.projectId + "/" + this.firestore.Lc.database + ") instead."), 
        new Ji(r, this.firestore, this.converter);
    }, t;
}(), Wi = on.Nh, Hi = /** @class */ function() {
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new T(I.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Ir("settings", "non-empty string", "host", t.host), this.host = t.host, Tr("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (kr("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling" ]), 
        Tr("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        Tr("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), 
        // Nobody should set timestampsInSnapshots anymore, but the error depends on
        // whether they set it to true or false...
        !0 === t.timestampsInSnapshots ? Se("The setting 'timestampsInSnapshots: true' is no longer required and should be removed.") : !1 === t.timestampsInSnapshots && Se("Support for 'timestampsInSnapshots: false' will be removed soon. You must update your code to handle Timestamp objects."), 
        this.timestampsInSnapshots = null === (n = t.timestampsInSnapshots) || void 0 === n || n, 
        Tr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = on.$h; else {
            if (t.cacheSizeBytes !== Wi && t.cacheSizeBytes < on.kh) throw new T(I.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + on.kh);
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new ji), this.QT = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.WT = new tn, this.INTERNAL = {
            delete: function() {
            ...
            var u = r;
            this.QT = u, this.Lc = t.GT(u), this.zT = u.name, this.HT = new A(i);
        } else {
            var a = r;
            if (!a.projectId) throw new T(I.INVALID_ARGUMENT, "Must provide projectId");
            this.Lc = new Ce(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.zT = "[DEFAULT]", this.HT = new _;
        }
        this.YT = o, this.JT = new Hi({}), this.XT = new Jr(this.Lc);
    }
    return t.prototype.settings = function(t) {
        mr("Firestore.settings", arguments, 1), Er("Firestore.settings", "object", 1, t);
        var e = new Hi(t);
        if (this.KT && !this.JT.isEqual(e)) throw new T(I.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.KT) throw new T(I.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        return t && (void 0 !== t.experimentalTabSynchronization && Se("The 'experimentalTabSynchronization' setting will be removed. Use 'synchronizeTabs' instead."), 
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.KT && !this.KT.DT) throw new T(I.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new Je, [ 2 /*return*/ , (this.WT.oh((function() {
                    return e(r, void 0, void 0, (function() {
                        var e, r;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), e = this.eE(), [ 4 /*yield*/ , this.YT.clearPersistence(e) ];
        ...
        if (this.jT(), zi(t)) return this.iE(t);
        ...
        return new Ue(this.Lc, this.zT, this.JT.host, this.JT.ssl, this.JT.forceLongPolling);
    }, t.prototype.tE = function(t, e) {
        var n = this.eE();
        return this.KT = new Bi(Te.nt(), n, this.HT, this.WT), this.KT.start(t, e);
    }, t.GT = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new T(I.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.QT) throw new T(I.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.QT;
        },
        enumerable: !0,
        configurable: !0
        ...
        return this.jT(), new eo(new Rt(R.G, t), this);
    ...
    return t.prototype.get = function(t) {
        ...
        var n = uo("Transaction.get", t, this.hE);
        return this.oE.V_([ n.xc ]).then((function(t) {
            if (!t || 1 !== t.length) return De();
            var r = t[0];
            if (r instanceof kt) return new $i(e.hE, n.xc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.aE);
            if (r instanceof St) return new $i(e.hE, n.xc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.aE);
            throw De();
        }));
        ...
        var r = uo("Transaction.set", t, this.hE);
        n = io("Transaction.set", n);
        var i = co(r.aE, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.hE.XT.Nc(s, o, n.mergeFields) : this.hE.XT.Cc(s, o);
        return this.oE.set(r.xc, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof Ur ? (gr("Transaction.update", arguments, 3), 
        r = uo("Transaction.update", t, this.hE), i = this.hE.XT.$c("Transaction.update", e, n, o)) : (mr("Transaction.update", arguments, 2), 
        r = uo("Transaction.update", t, this.hE), i = this.hE.XT.kc("Transaction.update", e)), 
        this.oE.update(r.xc, i), this;
    }, t.prototype.delete = function(t) {
        mr("Transaction.delete", arguments, 1);
        var e = uo("Transaction.delete", t, this.hE);
    ...
    return t.prototype.set = function(t, e, n) {
        wr("WriteBatch.set", arguments, 2, 3), this._E();
        var r = uo("WriteBatch.set", t, this.hE);
        n = io("WriteBatch.set", n);
        var i = co(r.aE, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.hE.XT.Nc(s, o, n.mergeFields) : this.hE.XT.Cc(s, o);
        return this.uE = this.uE.concat(u.gc(r.xc, yt.ft())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this._E(), "string" == typeof e || e instanceof Ur ? (gr("WriteBatch.update", arguments, 3), 
        r = uo("WriteBatch.update", t, this.hE), i = this.hE.XT.$c("WriteBatch.update", e, n, o)) : (mr("WriteBatch.update", arguments, 2), 
        r = uo("WriteBatch.update", t, this.hE), i = this.hE.XT.kc("WriteBatch.update", e)), 
        this.uE = this.uE.concat(i.gc(r.xc, yt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        mr("WriteBatch.delete", arguments, 1), this._E();
        var e = uo("WriteBatch.delete", t, this.hE);
        return this.uE = this.uE.concat(new Et(e.xc, yt.ft())), this;
    }, t.prototype.commit = function() {
        return this._E(), this.cE = !0, this.uE.length > 0 ? this.hE.jT().write(this.uE) : Promise.resolve();
    }, t.prototype._E = function() {
        if (this.cE) throw new T(I.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Ji = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.nE = function(e, n, r) {
        if (e.length % 2 != 0) throw new T(I.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.j() + " has " + e.length);
        return new t(new V(e), n, r);
        ...
        get: function() {
            return new ro(this.xc.path.M(), this.firestore, this.aE);
        },
        enumerable: !0,
        configurable: !0
        ...
        var e = R.K(t);
        return new ro(this.xc.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Dr("isEqual", "DocumentReference", 1, e);
        ...
        var n = co(this.aE, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.XT.Nc(i, r, e.mergeFields) : this.firestore.XT.Cc(i, r);
        return this.KT.write(o.gc(this.xc, yt.ft()));
    }, t.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof Ur ? (gr("DocumentReference.update", arguments, 2), 
        n = this.firestore.XT.$c("DocumentReference.update", t, e, r)) : (mr("DocumentReference.update", arguments, 1), 
        n = this.firestore.XT.kc("DocumentReference.update", t)), this.KT.write(n.gc(this.xc, yt.exists(!0)));
    }, t.prototype.delete = function() {
        return mr("DocumentReference.delete", arguments, 0), this.KT.write([ new Et(this.xc, yt.ft()) ]);
        ...
        "object" != typeof t[i] || zi(t[i]) || (kr("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        ...
        var i = new Gi({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new $i(n.firestore, n.xc, r, t.fromCache, t.hasPendingWrites, n.aE));
                }
            },
            error: r
        }), o = this.KT.listen(Rt.Wt(this.xc.path), i, t);
        return function() {
            i.kT(), n.KT.al(o);
        };
    }, t.prototype.get = function(t) {
        ...
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.jT().CT(e.xc).then((function(t) {
                n(new $i(e.firestore, e.xc, t, 
                /*fromCache=*/ !0, t instanceof St && t.At, e.aE));
            }), r) : e.dE(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        ...
        this.fE) {
            ...
            if (this.aE) {
                var e = new to(this.hE, this.xc, this.fE, this.TE, this.EE);
                return this.aE.fromFirestore(e, t);
            }
            return new Ki(this.hE, this.hE.rE(), t.serverTimestamps, 
            /* converter= */ void 0).MT(this.fE.Mt());
        }
    }, t.prototype.get = function(t, e) {
        if (wr("DocumentSnapshot.get", arguments, 1, 2), e = oo("DocumentSnapshot.get", e), 
        this.fE) {
            var n = this.fE.data().field(ni("DocumentSnapshot.get", t));
            if (null !== n) return new Ki(this.hE, this.hE.rE(), e.serverTimestamps, this.aE).MT(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.xc.path.O();
        ...
        get: function() {
            return new Ji(this.xc, this.hE, this.aE);
        },
        enumerable: !0,
        configurable: !0
        ...
        get: function() {
            return new Zi(this.EE, this.TE);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Dr("isEqual", "DocumentSnapshot", 1, e);
    ...
    return t.prototype.where = function(e, n, r) {
        mr("Query.where", arguments, 3), Sr("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i, o = function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new T(I.INVALID_ARGUMENT, "Invalid value " + xr(r) + " provided to function Query.where() for its " + Rr(2) + " argument. Acceptable values: " + e.join(", "));
            return r;
        ...
        if (s.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new T(I.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === o) {
                this.wE(r, o);
                for (var u = [], a = 0, c = r; a < c.length; a++) {
                    var h = c[a];
                    u.push(this.RE(h));
                }
                i = {
        ...
        return this.mE(f), new t(this.IE.Gt(f), this.firestore, this.aE);
        ...
        if (null !== this.IE.startAt) throw new T(I.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.IE.endAt) throw new T(I.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = ni("Query.orderBy", e), o = new jt(i, r);
        return this.AE(o), new t(this.IE.zt(o), this.firestore, this.aE);
    }, t.prototype.limit = function(e) {
        return mr("Query.limit", arguments, 1), Er("Query.limit", "number", 1, e), Lr("Query.limit", 1, e), 
        new t(this.IE.Ht(e), this.firestore, this.aE);
    }, t.prototype.limitToLast = function(e) {
        return mr("Query.limitToLast", arguments, 1), Er("Query.limitToLast", "number", 1, e), 
        Lr("Query.limitToLast", 1, e), new t(this.IE.Yt(e), this.firestore, this.aE);
        ...
        if (!(e instanceof t)) throw Dr("isEqual", "Query", 1, e);
    ...
    t.prototype.VE = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.IE.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(et(this.firestore.Lc, t.key)); else {
                var s = t.field(o.field);
                if (G(s)) throw new T(I.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
    ...
    t.prototype.gE = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.IE._e() && -1 !== s.indexOf("/")) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.IE.path.child(R.K(s));
                if (!V.et(u)) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new V(u);
                i.push(et(this.firestore.Lc, a));
            } else {
                var c = this.firestore.XT.Mc(t, s);
                i.push(c);
            }
        }
        return new Mt(i, n);
        ...
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || zi(t[i]) || (kr("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        ...
        var i = new Gi({
            next: function(t) {
                e.next && e.next(new no(n.firestore, n.IE, t, n.aE));
            },
            error: r
        ...
        if (t.ae() && 0 === t.Ot.length) throw new T(I.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        return wr("Query.get", arguments, 0, 1), so("Query.get", t), this.pE(this.IE), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.jT().FT(e.IE).then((function(t) {
                n(new no(e.firestore, e.IE, t, e.aE));
            }), r) : e.dE(n, r, t);
        }));
    }, t.prototype.dE = function(t, e, n) {
        var r = this.lE({
    ...
    t.prototype.RE = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.IE._e() && -1 !== t.indexOf("/")) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.IE.path.child(R.K(t));
            if (!V.et(e)) throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return et(this.firestore.Lc, new V(e));
        }
        if (t instanceof Ji) {
            var n = t;
            return et(this.firestore.Lc, n.xc);
        }
        throw new T(I.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + xr(t) + ".");
    }, 
    /**
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return new eo(this.bE, this.hE, this.aE);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (kr("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Tr("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.vE.hs) throw new T(I.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Dr("isEqual", "QuerySnapshot", 1, e);
        return this.hE === e.hE && this.bE.isEqual(e.bE) && this.vE.isEqual(e.vE) && this.aE === e.aE;
    }, t.prototype.CE = function(t) {
        return new to(this.hE, t.key, t, this.metadata.fromCache, this.vE.ns.has(t.key), this.aE);
    }, t;
}(), ro = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Rt.Wt(t), n, r) || this).FE = t, t.length % 2 != 1) throw new T(I.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.B() ? null : new Ji(new V(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        var e = R.K(t);
        return Ji.nE(this.IE.path.child(e), this.firestore, this.aE);
    }, n.prototype.add = function(t) {
        mr("CollectionReference.add", arguments, 1), Er("CollectionReference.add", "object", 1, this.aE ? this.aE.toFirestore(t) : t);
        var e = this.doc();
...
function io(t, e) {
    ...
    if (kr(t, e, [ "merge", "mergeFields" ]), Tr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + xr(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new T(I.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + xr(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof Ur;
...
function oo(t, e) {
    return void 0 === e ? {} : (kr(t, e, [ "serverTimestamps" ]), Nr(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function so(t, e) {
    br(t, "object", 1, e), e && (kr(t, e, [ "source" ]), Nr(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function uo(t, e, n) {
    ...
    throw Dr(t, "DocumentReference", 1, e);
}
...
var fo = ho(Qi, "Use firebase.firestore() instead."), lo = ho(Yi, "Use firebase.firestore().runTransaction() instead."), po = ho(Xi, "Use firebase.firestore().batch() instead."), yo = ho(Ji, "Use firebase.firestore().doc() instead."), vo = ho($i), mo = ho(to), go = ho(eo), wo = ho(no), Eo = ho(ro, "Use firebase.firestore().collection() instead."), bo = ho(/** @class */ function() {
    function t() {}
    return t.delete = function() {
        return vr("FieldValue.delete", arguments), new jr;
    }, t.serverTimestamp = function() {
        return vr("FieldValue.serverTimestamp", arguments), new Fr;
...
}(), "Use FieldValue.<field>() instead."), Io = ho(qr, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), To = {
    Firestore: fo,
    GeoPoint: Kr,
    Timestamp: k,
    Blob: Io,
    ...
    Commit: "commit"
}, So = "gl-js/ fire/" + E, ko = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.zE = function(t, e) {
        ...
        var n = [ this.GE, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = g(), i = {
        ...
        this.zE(i.initMessageHeaders, e), 
        ...
        var s = r.createWebChannel(o, i), u = !1, d = !1, y = new Ao({
            OE: function(t) {
        ...
        return v(w.EventType.OPEN, (function() {
            ...
            d || (d = !0, xe("Connection", "WebChannel transport closed"), y.jE());
        })), v(w.EventType.ERROR, (function(t) {
            d || (d = !0, xe("Connection", "WebChannel transport errored:", t), y.jE(new T(I.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    d = !0, y.jE(new T(u, a)), s.close();
                } else xe("Connection", "WebChannel received:", n), y.KE(n);
            }
        })), setTimeout((function() {
